...
<head>
    <%= ../assets/includes/head.vbhtml %>
        ...
        <meta name="web_invoke_zscore" content="http://localhost:7452/analysis_apps/z_score">
        <meta name="web_invoke_Rplot" content="http://localhost:7452/analysis_apps/Rplots/zscore_plot">
</head>
                ...
                <div data-mdb-spy="scroll" data-mdb-target="#scrollspy1" data-mdb-offset="0" class="scrollspy-example">
                    ...
                    <section id="example-3">
                        ...
                        <section id="example-sub-B">
                            <h3>Data Table</h3>
                            <div class="row">
                                <div class="col-auto" id="zscore-table">
