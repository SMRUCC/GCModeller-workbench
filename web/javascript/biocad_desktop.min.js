...
(function(c){(function(c){var b=function(a){return Bootstrap.apply(this,arguments)||this};$jscomp.inherits(b,Bootstrap);b.prototype.init=function(){var a=this;apps.gcmodeller.getProteinIDs().then(function(b){return __awaiter(this,void 0,void 0,function f(){return $jscomp.generator.createGenerator(f,function(c){if(1==c.nextAddress)return c.yield(b,2);b=c.yieldResult;a.protein_ids=b;a.viewBlastp(a.protein_ids[0]);$ts("#number_proteins").display(a.protein_ids.length.toString());c.jumpToEnd()})})})};
b.prototype.viewBlastp=function(a){apps.gcmodeller.getBlastp(a).then(function(a){return __awaiter(this,void 0,void 0,function f(){return $jscomp.generator.createGenerator(f,function(b){if(1==b.nextAddress)return b.yield(a,2);a=b.yieldResult;for(var c=JSON.parse(a),d=0;d<c.length;d++)delete c[d].QueryName,delete c[d].HitName,delete c[d].hit_length,delete c[d].length_hit,delete c[d].length_hsp,delete c[d].length_query,delete c[d].query_length,c[d].evalue=c[d].evalue.toString();$ts("#blast_output").clear();
$ts.appendTable(c,"#blast_output",null,{class:["table","table-sm"]});b.jumpToEnd()})})})};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"blastp_viewer"}}});c.view_protein_blast=b})(c.viewers||(c.viewers={}))})(pages||(pages={}));
