...
b.prototype.viewBlastp=function(a){apps.gcmodeller.getBlastp(a).then(function(a){return __awaiter(this,void 0,void 0,function f(){return $jscomp.generator.createGenerator(f,function(b){if(1==b.nextAddress)return b.yield(a,2);a=b.yieldResult;console.log(JSON.parse(a));b.jumpToEnd()})})})};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"blastp_viewer"}}});c.view_protein_blast=b})(c.viewers||(c.viewers={}))})(pages||(pages={}));
