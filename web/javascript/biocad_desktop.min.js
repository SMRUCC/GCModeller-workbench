...
a).then(function(a){return __awaiter(this,void 0,void 0,function k(){return $jscomp.generator.createGenerator(k,function(b){desktop.parseMessage(a).then(function(b){desktop.parseResultFlag(a,b).then(function(a){console.log(b);a?(a=new bootstrap.Modal($ts("#view-background"),{keyboard:!1}),$ts("#busy-indicator").hide(),a.show()):desktop.showToastMessage(b.info,"Load Model Error",null,"danger")})});b.jumpToEnd()})})})};b.summaryLine=function(a,b){return'<li class="list-group-item d-flex justify-content-between align-items-center">\n                        <div class="d-flex align-items-center">\n                            <span class="badge rounded-pill badge-success">                \n                                <i class="fab fa-laravel"></i>&nbsp;'+
