...
$jscomp.polyfill=function(b,a,d,c){if(a){d=$jscomp.global;b=b.split(".");for(c=0;c<b.length-1;c++){var e=b[c];e in d||(d[e]={});d=d[e]}b=b[b.length-1];c=d[b];a=a(c);a!=c&&null!=a&&$jscomp.defineProperty(d,b,{configurable:!0,writable:!0,value:a})}};$jscomp.FORCE_POLYFILL_PROMISE=!1;
$jscomp.polyfill("Promise",function(b){function a(){this.batch_=null}function d(a){return a instanceof e?a:new e(function(c,b){c(a)})}if(b&&!$jscomp.FORCE_POLYFILL_PROMISE)return b;a.prototype.asyncExecute=function(a){null==this.batch_&&(this.batch_=[],this.asyncExecuteBatch_());this.batch_.push(a);return this};a.prototype.asyncExecuteBatch_=function(){var a=this;this.asyncExecuteFunction(function(){a.executeBatch_()})};var c=$jscomp.global.setTimeout;a.prototype.asyncExecuteFunction=function(a){c(a,
...
0;a<this.onSettledCallbacks_.length;++a)f.asyncExecute(this.onSettledCallbacks_[a]);this.onSettledCallbacks_=null}};var f=new a;e.prototype.settleSameAsPromise_=function(a){var c=this.createResolveAndReject_();a.callWhenSettled_(c.resolve,c.reject)};e.prototype.settleSameAsThenable_=function(a,c){var b=this.createResolveAndReject_();try{a.call(c,b.resolve,b.reject)}catch(h){b.reject(h)}};e.prototype.then=function(a,c){function b(a,c){return"function"==typeof a?function(c){try{d(a(c))}catch(q){f(q)}}:
...
$jscomp.iteratorFromArray=function(b,a){$jscomp.initSymbolIterator();b instanceof String&&(b+="");var d=0,c={next:function(){if(d<b.length){var e=d++;return{value:a(e,b[e]),done:!1}}c.next=function(){return{done:!0,value:void 0}};return c.next()}};c[Symbol.iterator]=function(){return c};return c};$jscomp.polyfill("Array.prototype.keys",function(b){return b?b:function(){return $jscomp.iteratorFromArray(this,function(a){return a})}},"es6","es3");
var __awaiter=this&&this.__awaiter||function(b,a,d,c){return new (d||(d=Promise))(function(e,f){function g(a){try{l(c.next(a))}catch(m){f(m)}}function k(a){try{l(c["throw"](a))}catch(m){f(m)}}function l(a){a.done?e(a.value):(new d(function(c){c(a.value)})).then(g,k)}l((c=c.apply(b,a||[])).next())})},apps;
(function(b){function a(){return __awaiter(this,void 0,void 0,function e(){return $jscomp.generator.createGenerator(e,function(a){desktop.showToastMessage("Please run from webview2 application!","Web app error","warning");a.jumpToEnd()})})}try{var d=window.chrome.webview.hostObjects.gcmodeller}catch(c){d={getUniprotXmlDatabase:a,scanDatabase:a,openEnrichmentPage:a,sendPost:a}}b.gcmodeller=d;b.run=function(){Router.AddAppHandler(new pages.applets);Router.AddAppHandler(new pages.enrichment_database);
...
(function(b){b.promiseAsyncCallback=function(a,d){return __awaiter(this,void 0,void 0,function e(){return $jscomp.generator.createGenerator(e,function(e){b.parseMessage(a).then(function(e){b.parseResultFlag(a,e).then(function(a){d(a,e)})});e.jumpToEnd()})})}})(desktop||(desktop={}));
(function(b){b.now=function(){return(new Date).toLocaleTimeString()};b.parseResultFlag=function(a,b){return __awaiter(this,void 0,void 0,function e(){var d,g;return $jscomp.generator.createGenerator(e,function(e){if(1==e.nextAddress)return e.yield(a.result,2);g=(d=e.yieldResult)&&0==b.code;return e.return(g)})})};b.parseMessage=function(a){return __awaiter(this,void 0,void 0,function c(){var b,f;return $jscomp.generator.createGenerator(c,function(c){if(1==c.nextAddress)return c.yield(a.data,2);b=
c.yieldResult;if($ts.csv.isTsvFile(b))f={code:0,info:b};else if(b.startsWith("data:"))f={code:0,info:b};else try{f=JSON.parse(b)}catch(k){f={code:500,info:b}}return c.return(f)})})};b.processHtmlMsg=function(a){"string"==typeof a?(a=a.replace(/[<]/ig,"&lt;"),a=Strings.lineTokens(a).join("<br />")):a=b.RSharp.isRSharpError(a)?b.RSharp.RSharpErrorMessage(a):"Unhandle error!";return a}})(desktop||(desktop={}));
(function(b){function a(a,e,f,g,k){e=void 0===e?"Task Error":e;f=void 0===f?"":f;g=void 0===g?"danger":g;return $ts("<div>",{class:["toast","show","fade","toast-"+g],role:"alert","aria-live":"assertive","aria-atomic":"true","data-mdb-color":g,"data-mdb-autohide":(void 0===k?!0:k).toString(),style:"width: 500px;"}).display('        \n            <div class="toast-header toast-'+g+'">\n                <i class="'+d[g]+'"></i>\n                <strong class="me-auto">'+e+"</strong>\n                <small>"+
(f&&"null"!=f.toLowerCase()?f:"")+'</small>\n                <button type="button" class="btn-close" data-mdb-dismiss="toast" aria-label="Close">\n                </button>\n            </div>\n            <div class="toast-body">'+b.processHtmlMsg(a)+"</div>\n        ")}b.showToastMessage=function(c,d,f,g){d=void 0===d?"Task Error":d;f=void 0===f?"info":f;g=void 0===g?!0:g;$ts("#busy-indicator").hide();$ts("#toast-message").appendElement(a(c,d,b.now(),f,g))};var d={success:"fas fa-check fa-lg me-2",
...
(function(b){var a=function(a){return Bootstrap.apply(this,arguments)||this};$jscomp.inherits(a,Bootstrap);a.prototype.init=function(){this.scanDatabaseList()};a.prototype.scanDatabaseList=function(){$ts("#busy-indicator").show();apps.gcmodeller.scanDatabase().then(function(b){return __awaiter(this,void 0,void 0,function e(){var d,g,k,l,h,m,n;return $jscomp.generator.createGenerator(e,function(e){if(1==e.nextAddress)return e.yield(b,2);d=e.yieldResult;g=JSON.parse(d||"[]");k=Object.keys(g).length;
l=$ts("#repository");h={};for(m in g)h.$jscomp$loop$prop$key$11=m,h.$jscomp$loop$prop$metadata$12=g[h.$jscomp$loop$prop$key$11],n=a.buildDbCard(h.$jscomp$loop$prop$key$11,h.$jscomp$loop$prop$metadata$12),l.appendElement(n),console.log(h.$jscomp$loop$prop$key$11),$ts("#"+h.$jscomp$loop$prop$key$11).onclick=function(a){return function(){apps.gcmodeller.openEnrichmentPage(a.$jscomp$loop$prop$key$11,a.$jscomp$loop$prop$metadata$12.name,a.$jscomp$loop$prop$metadata$12.note)}}(h),$ts("#"+h.$jscomp$loop$prop$key$11+
"-meta").onclick=function(b){return function(){$ts("#busy-indicator").show();a.showMetadata(b.$jscomp$loop$prop$key$11,b.$jscomp$loop$prop$metadata$12)}}(h),h={$jscomp$loop$prop$key$11:h.$jscomp$loop$prop$key$11,$jscomp$loop$prop$metadata$12:h.$jscomp$loop$prop$metadata$12};$ts("#busy-indicator").hide();desktop.showToastMessage("Found "+k+" database.","Enrichment Database Repository","info");e.jumpToEnd()})})})};a.showMetadata=function(b,c){var d="",f=JSON.stringify({guid:b});d+='<span class="badge badge-primary">Database Name</span>: '+
c.name+"("+b+")<br />";d+='<span class="badge badge-primary">Note</span>: <p class="note note-light">'+c.note+"</p><br />";apps.gcmodeller.sendPost($ts.url("@web_invoke_inspector"),f).then(function(c){return __awaiter(this,void 0,void 0,function l(){return $jscomp.generator.createGenerator(l,function(e){desktop.parseMessage(c).then(function(e){desktop.parseResultFlag(c,e).then(function(c){var f=c?"Load Database Success":"Load Database Error",g=e.info,h=null;console.log(g);if(c){var l=$from(Object.keys(g.summary)).Select(function(a){return{name:a,
info:g.summary[a]}}).Where(function(a){return 0<a.info.unique_size}).Where(function(a){return 1<a.info.unique_size/a.info.clusters});c=l.Select(function(b){return a.summaryLine(b.name,b.info)}).JoinBy("");desktop.showToastMessage("Success!",f,"success");h=function(){for(var c={},d=$jscomp.makeIterator(l.ToArray()),e=d.next();!e.done;c={$jscomp$loop$prop$name$14:c.$jscomp$loop$prop$name$14,$jscomp$loop$prop$model$15:c.$jscomp$loop$prop$model$15},e=d.next())c.$jscomp$loop$prop$model$15=e.value,c.$jscomp$loop$prop$name$14=
c.$jscomp$loop$prop$model$15.name,e="#model-"+c.$jscomp$loop$prop$name$14,console.log(e),$ts(e).onclick=function(c){return function(){$ts("#busy-indicator").show();console.log("view background model: "+c.$jscomp$loop$prop$name$14+"...");a.viewModel(b,c.$jscomp$loop$prop$name$14,c.$jscomp$loop$prop$model$15.info)}}(c)};d+='<span class="badge badge-primary">Protein Counts</span>: '+g.counts+"<br />";d+='<span class="badge badge-primary">Models</span>: '+l.Count+"<br />";d+='<span class="badge badge-primary">Backgrounds</span>: <br /><br />\n                                    <ul class="list-group list-group-light">\n                                        '+
c+"\n                                    </ul>\n                                "}else desktop.showToastMessage(e.info,f,"danger");$ts("#summary-info").display(d);isNullOrUndefined(h)||h()})});e.jumpToEnd()})})})};a.viewModel=function(a,c,b){a=JSON.stringify({guid:a,xref:c});apps.gcmodeller.sendPost($ts.url("@web_invoke_loadModel"),a).then(function(a){return __awaiter(this,void 0,void 0,function k(){return $jscomp.generator.createGenerator(k,function(c){desktop.parseMessage(a).then(function(c){desktop.parseResultFlag(a,
c).then(function(a){if(a){var b=new bootstrap.Modal($ts("#view-background"),{keyboard:!1}),d=c.info.clusters;a=Object.keys(d);a=$from(a).Select(function(a){return'\n                                    <li>                                   \n                                            <a \n                                            href="#" \n                                            onclick="pages.enrichment_database.showProteins(\''+d[a].join(",")+'\')">\n                                            <i class="far fa-file-code"></i>&nbsp;&nbsp;'+
a.replace(/[<]/ig,"&lt;")+"\n                                            ["+d[a].length+" proteins]\n                                        </a>                                     \n                                    </li>                              \n                                    "});$ts("#contentArea").clear();$ts("#contentArea").display(a.JoinBy(""));$ts("#busy-indicator").hide();$ts("#modal-close1").onclick=function(){return b.hide()};$ts("#modal-close2").onclick=function(){return b.hide()};
b.show()}else desktop.showToastMessage(c.info,"Load Model Error","danger")})});c.jumpToEnd()})})})};a.showProteins=function(a){$ts("#protein_ids").CType().value=a.replace(/,/ig,"\n")};a.summaryLine=function(a,c){return'<li class="list-group-item d-flex justify-content-between align-items-center">\n                        <div class="d-flex align-items-center">\n                            <span class="badge rounded-pill badge-success">                \n                                <i class="fab fa-laravel"></i>&nbsp;'+
...
$ts("#formFile").CType();apps.gcmodeller.getUniprotXmlDatabase().then(function(c){return __awaiter(this,void 0,void 0,function f(){var b;return $jscomp.generator.createGenerator(f,function(d){if(1==d.nextAddress)return b=a,d.yield(c,2);b.value=d.yieldResult;d.jumpToEnd()})})})};a.prototype.imports_onclick=function(){$ts("#busy-indicator").show();var a={file:$ts.value("#formFile"),name:$ts.value("#title"),note:$ts.value("#description")};a=JSON.stringify(a);apps.gcmodeller.sendPost($ts.url("@web_invoke_imports"),
...
b.hide();e.jumpToEnd()})})})};a.prototype.run_click=function(){$ts("#busy-indicator").show();var d=$ts.value("#matrix-file"),c=$ts.value("#dimensions"),e=$ts.select.getOption("#algorithm"),f=b.analysis_session.prototype.generateSsid.call(this,{file:d,dims:c,algo:e}),g=$ts("#z-score").CType().checked;c=JSON.stringify({file:d,ssid:f,dims:c,algorithm:e,z_score:g});var k=this;Strings.Empty(d)?desktop.showToastMessage("The matrix data input file can not be nothing!","Data Embedding Analysis","danger"):
...
desktop.showToastMessage(c.info,e+" Task Error","danger")});c.jumpToEnd()})})})};a.plot3DScatter=function(a){a=JSON.stringify({ssid:a,k:$ts.value("#kmeans")});apps.gcmodeller.sendPost($ts.url("@web_invoke_Rplot"),a).then(function(a){desktop.promiseAsyncCallback(a,function(a,b){a?(a=b.info+"?refresh="+md5(desktop.now()),$ts("#Rplot-box").CType().href=a,$ts("#Rplot_js").CType().src=a,$ts.goto("#example-3-collapsible"),$ts("#busy-indicator").hide()):desktop.showToastMessage(b.info,"Rplot Error","danger")})})};
...
a[""]+'/">'+a.name+"</a>"};case "EC":return function(a){return'<a target="__blank" href="https://www.genome.jp/dbget-bin/www_bfind_sub?mode=bfind&max_hit=1000&dbkey=enzyme&keywords='+a[""]+'">'+a.name+"</a>"};default:return function(a){return a.name}}};a.prototype.runInternal=function(d,c){var e=b.analysis_session.prototype.generateSsid.call(this,{type:d,symbols:c}),f=this;c=JSON.stringify({id:this.database,background:d,symbols:Strings.lineTokens(c),ssid:e});var g=a.term_url(d);apps.gcmodeller.sendPost($ts.url("@web_invoke_enrichment"),
...
function(){$ts("#busy-indicator").show();var a=JSON.stringify({session_id:this.session_id,type:"bar",background:$ts.select.getOption("#background"),top:5});apps.gcmodeller.sendPost($ts.url("@web_invoke_Rplot?base64=true"),a).then(function(a){return __awaiter(this,void 0,void 0,function f(){return $jscomp.generator.createGenerator(f,function(b){desktop.parseMessage(a).then(function(b){desktop.parseResultFlag(a,b).then(function(a){var c=a?"Run Enrichment Success":"Analysis Error",d=b.info;console.log(d);
...
0],["x4=beta4*(x3-x4)",10]]),b=a.next();!b.done;b=a.next()){b=b.value;var e=this.add_equation_click();e.eq.value=b[0].toString();e.y0.value=b[1].toString()}a=$jscomp.makeIterator([["beta1","30"],["beta3","30"],["beta4","1"],["lamda1","2"],["lamda3","2"],["alpha1","20"],["alpha2","20"],["alpha3","1"],["a","1"],["n1","4"],["n2","5"],["n3","1"]]);for(b=a.next();!b.done;b=a.next())b=b.value,e=this.add_constant_click(),e.name.value=b[0].toString(),e.val.value=b[1].toString();this.equationIndexing($ts(".eq-index"));
...
e=this,f=b.getElementsByTagName("input"),g=f.item(0);f=f.item(1);a.appendElement(b);$ts(".del-eq").onClick(function(b){b.removeAttribute("onclick");a.removeChild(b.parentElement);e.equationIndexing($ts(".eq-index"))});e.equationIndexing($ts(".eq-index"));return{eq:g,y0:f}};a.prototype.equationIndexing=function(a){a.ForEach(function(a,b){a.innerText=b+1+". "})};a.prototype.add_constant_click=function(){var a=$ts("#constant-list"),b=$ts("<div>",{class:["input-group","mb-3","const"]}).display('\n                <span class="input-group-text const-index">1. </span>\n                <input type="text" class="form-control" placeholder="put constant symbol name at here"\n                    aria-label="constant">\n                <span class="input-group-text">, constant value=</span>\n                <input type="text" class="form-control"\n                    placeholder="Constant value of current symbol" aria-label="const_val">\n                <button class="btn btn-danger del-const" type="button"> Remove\n                </button>\n            '),
e=this,f=b.getElementsByTagName("input"),g=f.item(0);f=f.item(1);a.appendElement(b);$ts(".del-const").onClick(function(b){b.removeAttribute("onclick");a.removeChild(b.parentElement);e.equationIndexing($ts(".const-index"))});e.equationIndexing($ts(".const-index"));return{name:g,val:f}};a.loadContents=function(a){a=$ts("."+a);var b=[];a.ForEach(function(a){var c=a.getElementsByTagName("input");a=c.item(0);c=c.item(1);a={target:a.value,value:c.value};Strings.Empty(a.target)||b.push(a)});b.length!=a.Count&&
desktop.showToastMessage("Some data is leaves empty, you can removes these empty data slots.","Check PLAS Parameters","warning");return b};a.prototype.run_click=function(){var d=this;$ts("#busy-indicator").show();var c=a.loadContents("equation"),e=a.loadContents("const"),f=$ts.value("#time_final"),g=$ts.value("#resolution");if(0==c.length)desktop.showToastMessage("No ODEs system equations!","Check PLAS Parameters","danger");else{var k=b.analysis_session.prototype.generateSsid.call(this,{sys:c,const:e,
t:f,resolution:g});c=JSON.stringify({odes:JSON.stringify(c),constants:JSON.stringify(e),final_time:f,resolution:g,session_id:k});apps.gcmodeller.sendPost($ts.url("@web_invoke_run_plas"),c).then(function(a){return __awaiter(this,void 0,void 0,function m(){return $jscomp.generator.createGenerator(m,function(b){desktop.promiseAsyncCallback(a,function(a,b){a?(a=$ts.csv(b.info,!0).Objects(),$ts("#plas-table").clear(),$ts.appendTable(a,"#plas-table",null,{class:["table","table-sm"]}),d.session_id=k,d.createPlot(),
...
window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth;this.uCanvas.height=window.innerHeight||document.documentElement.clientHeight||document.body.clientHeight;this.size=[this.uCanvas.width,this.uCanvas.height]};b.prototype.update=function(){var a=this,b=[a.f].concat(a.dots),d,g,k;a.uContext.clearRect(0,0,a.size[0],a.size[1]);var l=$jscomp.makeIterator(a.dots);for(d=l.next();!d.done;d=l.next()){var h=d.value;h.x+=h.xa;h.y+=h.ya;h.xa*=h.x>a.size[0]||0>h.x?-1:1;h.ya*=h.y>
a.size[1]||0>h.y?-1:1;a.uContext.fillRect(h.x-.5,h.y-.5,1,1);for(g=0;g<b.length;g++)if(d=b[g],h!==d&&null!==d.x&&null!==d.y){var m=h.x-d.x;var n=h.y-d.y;var p=m*m+n*n;p<d.max&&(d===a.f&&p>=d.max/2&&(h.x-=.03*m,h.y-=.03*n),k=(d.max-p)/d.max,a.uContext.beginPath(),a.uContext.lineWidth=k/2,a.uContext.strokeStyle="rgba("+a.setting.color+", "+(k+.2)+")",a.uContext.moveTo(h.x,h.y),a.uContext.lineTo(d.x,d.y),a.uContext.stroke())}b.splice(b.indexOf(h),1)}a.frameRender(function(){return a.update()})};b.defaultCallback=
function(a){window.setTimeout(a,1E3/45);return 0};b.prototype.registerDevice=function(){var a=this;a.frameRender=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||b.defaultCallback;window.onresize=a.canvasResize;window.onmousemove=function(b){b=b||window.event;a.f.x=b.clientX;a.f.y=b.clientY};window.onmouseout=function(){a.f.x=null;a.f.y=null}};a.network=b;a.run=function(a,d){a=void 0===
a?null:a;d=void 0===d?{canvasId:"canvas-network-display",zIndex:-1,opacity:1,color:"0,104,183",n:100}:d;var c=new b;c.setting=d;c.uCanvas.id="canvas_"+d.canvasId;c.uCanvas.style.cssText="position:fixed; top:0; left:0; z-index: "+d.zIndex+"; opacity: "+d.opacity;a?b.getById(a).appendChild(c.uCanvas):b.getTag("body").appendChild(c.uCanvas);c.canvasResize();c.registerDevice();for(a=0;d.n>a;a++)c.dots.push({x:Math.random()*c.size[0],y:Math.random()*c.size[1],xa:2*Math.random()-1,ya:2*Math.random()-1,
max:1E4});setTimeout(function(){return c.update()},100)}})(b.background||(b.background={}))})(pages||(pages={}));
