...
0;a<this.onSettledCallbacks_.length;++a)k.asyncExecute(this.onSettledCallbacks_[a]);this.onSettledCallbacks_=null}};var k=new d;e.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};e.prototype.settleSameAsThenable_=function(a,b){var e=this.createResolveAndReject_();try{a.call(b,e.resolve,e.reject)}catch(h){e.reject(h)}};e.prototype.then=function(a,b){function c(a,b){return"function"==typeof a?function(b){try{d(a(b))}catch(t){f(t)}}:
b}var d,f,k=new e(function(a,b){d=a;f=b});this.callWhenSettled_(c(a,d),c(b,f));return k};e.prototype.catch=function(a){return this.then(void 0,a)};e.prototype.callWhenSettled_=function(a,b){function e(){switch(c.state_){case 1:a(c.result_);break;case 2:b(c.result_);break;default:throw Error("Unexpected state: "+c.state_);}}var c=this;null==this.onSettledCallbacks_?k.asyncExecute(e):this.onSettledCallbacks_.push(e)};e.resolve=b;e.reject=function(a){return new e(function(b,e){e(a)})};e.race=function(a){return new e(function(e,
c){for(var d=$jscomp.makeIterator(a),k=d.next();!k.done;k=d.next())b(k.value).callWhenSettled_(e,c)})};e.all=function(a){var c=$jscomp.makeIterator(a),d=c.next();return d.done?b([]):new e(function(a,e){function k(b){return function(e){f[b]=e;g--;0==g&&a(f)}}var f=[],g=0;do f.push(void 0),g++,b(d.value).callWhenSettled_(k(f.length-1),e),d=c.next();while(!d.done)})};return e},"es6","es3");
...
var __awaiter=this&&this.__awaiter||function(c,d,b,a){return new (b||(b=Promise))(function(e,k){function f(b){try{m(a.next(b))}catch(l){k(l)}}function g(b){try{m(a["throw"](b))}catch(l){k(l)}}function m(a){a.done?e(a.value):(new b(function(b){b(a.value)})).then(f,g)}m((a=a.apply(c,d||[])).next())})},apps;
...
c.fasta_sequence="Fasta sequence file(*.fasta;*.fas;*.fa)|*.fasta;*.fas;*.fa";try{var b=window.chrome.webview.hostObjects.gcmodeller}catch(a){b={scanDatabase:d,openEnrichmentPage:d,sendPost:d}}c.gcmodeller=b;c.run=function(){Router.AddAppHandler(new pages.applets);Router.AddAppHandler(new pages.settings);Router.AddAppHandler(new pages.data_repository);Router.AddAppHandler(new pages.web_task);Router.AddAppHandler(new pages.analysis_project.create_project);Router.AddAppHandler(new pages.analysis_project.edit_sampleinfo);
...
a.yieldResult;if($ts.csv.isTsvFile(e))d={code:0,info:e};else if(e.startsWith("data:"))d={code:0,info:e};else try{d=JSON.parse(e)}catch(g){d={code:500,info:e}}return a.return(d)})})};c.processHtmlMsg=function(d){"string"==typeof d?(d=d.replace(/[<]/ig,"&lt;"),d=Strings.lineTokens(d).join("<br />")):d=c.RSharp.isRSharpError(d)?c.RSharp.RSharpErrorMessage(d):"Unhandle error!";return d}})(desktop||(desktop={}));
(function(c){function d(a,e,d,f,g){e=void 0===e?"Task Error":e;d=void 0===d?"":d;f=void 0===f?"danger":f;return $ts("<div>",{class:["toast","show","fade","toast-"+f],role:"alert","aria-live":"assertive","aria-atomic":"true","data-mdb-color":f,"data-mdb-autohide":(void 0===g?!0:g).toString(),style:"width: 500px;"}).display('        \n            <div class="toast-header toast-'+f+'">\n                <i class="'+b[f]+'"></i>\n                <strong class="me-auto">'+e+"</strong>\n                <small>"+
(d&&"null"!=d.toLowerCase()?d:"")+'</small>\n                <button type="button" class="btn-close" data-mdb-dismiss="toast" aria-label="Close">\n                </button>\n            </div>\n            <div class="toast-body">'+c.processHtmlMsg(a)+"</div>\n        ")}c.showToastMessage=function(a,b,k,f){b=void 0===b?"Task Error":b;k=void 0===k?"info":k;f=void 0===f?!0:f;$ts("#busy-indicator").hide();$ts("#toast-message").appendElement(d(a,b,c.now(),k,f))};var b={success:"fas fa-check fa-lg me-2",
...
$jscomp.makeIterator(d(this.appList[a],a)),k=e.next();!k.done;k=e.next())this.terms.push(k.value);this.suggestions=new c.suggestion_list.suggestion(this.terms);this.hookSearchBar()};b.prototype.hookSearchBar=function(){var a=$ts("#applets"),e=this,c=$ts("#form1");c.onchange=function(){if(c.value&&""!=c.value){var d=c.value;a.clear();d=$jscomp.makeIterator(e.suggestions.populateSuggestion(d,6,!1));for(var k=d.next();!k.done;k=d.next())k=b.buildElement(e.appList[k.value.id]),a.appendChild(k)}else b.showAppList(e.appList)}};
...
b.prototype.showTaskDatalist=function(a,b){b=void 0===b?null:b;a=$from(a).Select(function(a){return JSON.parse(a)}).ToArray();this.loadTaskList(a).then(function(a){isNullOrUndefined(b)||b()})};b.prototype.loadTaskList=function(a){return __awaiter(this,void 0,void 0,function k(){var c,d,m,h,l,n,p;return $jscomp.generator.createGenerator(k,function(f){switch(f.nextAddress){case 1:c=$ts("#task_manager").clear(),m=null,h={},l=$jscomp.makeIterator(a),n=l.next();case 2:if(n.done){f.jumpTo(4);break}h.$jscomp$loop$prop$task$20=
n.value;p=h;return f.yield(b.getHostObject(h.$jscomp$loop$prop$task$20),5);case 5:p.$jscomp$loop$prop$task$20=f.yieldResult;m=h.$jscomp$loop$prop$task$20.session_id.replace(/\./ig,"-");d=b.buildTaskHtml(h.$jscomp$loop$prop$task$20,m);c.appendElement(d);localStorage.setItem(h.$jscomp$loop$prop$task$20.session_id,JSON.stringify(h.$jscomp$loop$prop$task$20.arguments));$ts("#"+m).onclick=function(a){return function(){apps.gcmodeller.openPage(a.$jscomp$loop$prop$task$20.session_id,JSON.stringify(a.$jscomp$loop$prop$task$20))}}(h);
h={$jscomp$loop$prop$task$20:h.$jscomp$loop$prop$task$20};n=l.next();f.jumpTo(2);break;case 4:return f.return(0)}})})};b.getHostObject=function(a){return __awaiter(this,void 0,void 0,function k(){var b,c,d,h,l,n,p,q,r,t;return $jscomp.generator.createGenerator(k,function(f){switch(f.nextAddress){case 1:return c=b={},f.yield(a.appName,2);case 2:return c.appName=f.yieldResult,d=b,f.yield(a.arguments,3);case 3:return d.arguments=f.yieldResult,h=b,f.yield(a.error,4);case 4:return h.error=f.yieldResult,
l=b,f.yield(a.logtext,5);case 5:return l.logtext=f.yieldResult,n=b,f.yield(a.session_id,6);case 6:return n.session_id=f.yieldResult,p=b,f.yield(a.status,7);case 7:return p.status=f.yieldResult,q=b,f.yield(a.time,8);case 8:return q.time=f.yieldResult,r=b,f.yield(a.title,9);case 9:return r.title=f.yieldResult,t=b,f.yield(a.url,10);case 10:return t.url=f.yieldResult,console.log(b),f.return(b)}})})};b.buildTaskHtml=function(a,b){return $ts("<tr>").display('          \n            <td>\n                <div class="d-flex align-items-center">\n                    <img src="/assets/images/dna-image.jpg" alt=""\n                        style="width: 45px; height: 45px" class="rounded-circle" />\n                    <div class="ms-3">\n                        <p class="fw-bold mb-1">\n                            <a id="'+
...
file:g,ssid:""};m.ssid=c.analysis_session.prototype.generateSsid.call(this,m);apps.gcmodeller.sendPost($ts.url("@web_invoke_clustering"),JSON.stringify(m)).then(function(a){return __awaiter(this,void 0,void 0,function n(){return $jscomp.generator.createGenerator(n,function(c){desktop.promiseAsyncCallback(a,function(a,c){a?(b.session_id=m.ssid,b.refresh_Rplot_onclick(),a=$ts.csv(c.info,!0).Objects().Take(10),$ts("#patterns-table").clear(),$ts.appendTable(a,"#patterns-table",null,{class:["table","table-sm"]})):
desktop.showToastMessage(c.info,"Run CMeans","danger")});c.jumpToEnd()})})})};d.prototype.refresh_Rplot_onclick=function(){var b=$ts.select.getOption("#colorSet");b={ssid:this.session_id,colorSet:b};desktop.loading();apps.gcmodeller.sendPost($ts.url("@web_invoke_Rplot"),JSON.stringify(b)).then(function(a){return __awaiter(this,void 0,void 0,function k(){return $jscomp.generator.createGenerator(k,function(b){desktop.promiseAsyncCallback(a,function(a,b){a?(a=b.info+"?refresh="+md5(desktop.now()),$ts("#Rplot-box").CType().href=
...
a.hide();d.jumpToEnd()})})})};d.prototype.run_click=function(){desktop.loading();var b=$ts.value("#matrix-file"),a=$ts.value("#dimensions"),e=$ts.select.getOption("#algorithm"),k=c.analysis_session.prototype.generateSsid.call(this,{file:b,dims:a,algo:e}),f=$ts("#z-score").CType().checked;a=JSON.stringify({file:b,ssid:k,dims:a,algorithm:e,z_score:f});var g=this;Strings.Empty(b)?desktop.showToastMessage("The matrix data input file can not be nothing!","Data Embedding Analysis","danger"):apps.gcmodeller.sendPost($ts.url("@web_invoke_embedding"),
a).then(function(a){return __awaiter(this,void 0,void 0,function l(){return $jscomp.generator.createGenerator(l,function(b){desktop.promiseAsyncCallback(a,function(a,b){a?(a=$ts.csv(b.info,!0).Objects().Take(10),g.session_id=k,$ts("#embedding-table").clear(),$ts.appendTable(a,"#embedding-table",null,{class:["table","table-sm"]}),d.plot3DScatter(k),desktop.showToastMessage("Run Data Embedding Analysis Success!",e+" Task Success","success")):desktop.showToastMessage(b.info,e+" Task Error","danger")});
...
a[""]+'/">'+a.name+"</a>"};case "EC":return function(a){return'<a target="__blank" href="https://www.genome.jp/dbget-bin/www_bfind_sub?mode=bfind&max_hit=1000&dbkey=enzyme&keywords='+a[""]+'">'+a.name+"</a>"};default:return function(a){return a.name}}};d.prototype.runInternal=function(b,a){var e=c.analysis_session.prototype.generateSsid.call(this,{type:b,symbols:a}),k=this;a=JSON.stringify({id:this.database,background:b,symbols:Strings.lineTokens(a),ssid:e});var f=d.term_url(b);apps.gcmodeller.sendPost($ts.url("@web_invoke_enrichment"),
a).then(function(a){desktop.promiseAsyncCallback(a,function(a,b){var c=a?"Run Enrichment Success":"Analysis Error",d=b.info;console.log(d);a?(a=$ts.csv(d,!0).Objects().Where(function(a){return.05>a.pvalue}).Select(function(a){a.name=f(a);return a}),$ts("#enrichment-result-table").clear(),$ts.appendTable(a,"#enrichment-result-table",null,{class:["table","table-sm"]}),k.session_id=e,k.plot_onclick(),desktop.showToastMessage("Success!",c,"success")):desktop.showToastMessage(b.info,c,"danger")})})};d.prototype.plot_onclick=
function(){desktop.loading();var b=JSON.stringify({session_id:this.session_id,type:"bar",background:$ts.select.getOption("#background"),top:5});apps.gcmodeller.sendPost($ts.url("@web_invoke_Rplot?base64=true"),b).then(function(a){return __awaiter(this,void 0,void 0,function k(){return $jscomp.generator.createGenerator(k,function(b){desktop.parseMessage(a).then(function(b){desktop.parseResultFlag(a,b).then(function(a){var c=a?"Run Enrichment Success":"Analysis Error",d=b.info;console.log(d);a?($ts("#Rplot").CType().src=
...
desktop.showToastMessage("Some data is leaves empty, you can removes these empty data slots.","Check PLAS Parameters","warning");return a};d.prototype.run_click=function(){var b=this;desktop.loading();var a=d.loadContents("equation"),e=d.loadContents("const"),k=$ts.value("#time_final"),f=$ts.value("#resolution");if(0==a.length)desktop.showToastMessage("No ODEs system equations!","Check PLAS Parameters","danger");else{var g=c.analysis_session.prototype.generateSsid.call(this,{sys:a,const:e,t:k,resolution:f});
a=JSON.stringify({odes:JSON.stringify(a),constants:JSON.stringify(e),final_time:k,resolution:f,session_id:g});apps.gcmodeller.sendPost($ts.url("@web_invoke_run_plas"),a).then(function(a){return __awaiter(this,void 0,void 0,function l(){return $jscomp.generator.createGenerator(l,function(c){desktop.promiseAsyncCallback(a,function(a,c){a?(a=$ts.csv(c.info,!0).Objects(),$ts("#plas-table").clear(),$ts.appendTable(a,"#plas-table",null,{class:["table","table-sm"]}),b.session_id=g,b.createPlot(),desktop.showToastMessage("Run system simulation job done!",
"Run PLAS","success")):desktop.showToastMessage(c.info,"Run PLAS","danger");desktop.closeSpinner()});c.jumpToEnd()})})})}};d.prototype.createPlot=function(){var b=JSON.stringify({ssid:this.session_id});apps.gcmodeller.sendPost($ts.url("@web_invoke_Rplot"),b).then(function(a){return __awaiter(this,void 0,void 0,function k(){return $jscomp.generator.createGenerator(k,function(b){desktop.promiseAsyncCallback(a,function(a,b){a?(a=b.info+"?refresh="+md5(desktop.now()),$ts("#Rplot-box").CType().href=a,
...
void 0,void 0,function k(){return $jscomp.generator.createGenerator(k,function(b){desktop.promiseAsyncCallback(a,function(a,b){a?(a=b.info+"?refresh="+md5(desktop.now()),$ts("#Rplot-box").CType().href=a,$ts("#Rplot_js").CType().src=a,$ts.goto("#example-3-collapsible"),desktop.closeSpinner(),desktop.showToastMessage("Expression data patterns plot success!","Plot Z-score","success")):desktop.showToastMessage(b.info,"Plot Z-score","danger")});b.jumpToEnd()})})})};$jscomp.global.Object.defineProperties(d.prototype,
...
for(var b=0,c=this.editor.TableRows(),d=$jscomp.makeIterator(this.editor.TableData(!1)),g=d.next();!g.done;g=d.next())g=g.value,this.sampleInfo[g.ID].injectionOrder=g.injectionOrder,this.sampleInfo[g.ID].batch=g.batch,this.sampleInfo[g.ID].sample_info=g.sample_info,this.sampleInfo[g.ID].sample_info1=g.sample_info1,this.sampleInfo[g.ID].sample_info2=g.sample_info2,this.sampleInfo[g.ID].sample_name=g.sample_name,c[b++].dropFlag?this.sampleInfo[g.ID].delete="1":this.sampleInfo[g.ID].delete="0";b=[];
...
for(f=a.next();!f.done;f=a.next()){var g=f.value;this.sampleInfo[g.ID]=g;f=c[d++];"0"!=g.delete&&b.deleteSampleRow(f.tr,f)}return this.editor.table};b.deleteSampleRow=function(a,b){a.cells.item(0);b.dropFlag?(a.style.backgroundColor="white",b.getElementById("remove").innerHTML="\u5220\u9664\u6837\u672c"):(a.style.backgroundColor="gray",b.getElementById("remove").innerHTML="\u6062\u590d\u6837\u672c");b.dropFlag=!b.dropFlag};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,
enumerable:!0,get:function(){return"edit_sampleinfo"}}});c.edit_sampleinfo=b})(c.analysis_project||(c.analysis_project={}))})(pages||(pages={}));
(function(c){(function(c){var b=function(a,b,c,d,g,m,h){a=void 0===a?document.createElement("canvas"):a;b=void 0===b?a.getContext("2d"):b;c=void 0===c?{x:null,y:null,max:2E4}:c;d=void 0===d?[0,0]:d;g=void 0===g?[]:g;this.uCanvas=a;this.uContext=b;this.f=c;this.size=d;this.dots=g;this.setting=void 0===m?null:m;this.frameRender=void 0===h?null:h};b.getTag=function(a){return document.getElementsByTagName(a)[0]};b.getById=function(a){return document.getElementById(a)};b.prototype.canvasResize=function(){this.uCanvas.width=
window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth;this.uCanvas.height=window.innerHeight||document.documentElement.clientHeight||document.body.clientHeight;this.size=[this.uCanvas.width,this.uCanvas.height]};b.prototype.update=function(){var a=this,c=[a.f].concat(a.dots),d,f,g;a.uContext.clearRect(0,0,a.size[0],a.size[1]);var m=$jscomp.makeIterator(a.dots);for(d=m.next();!d.done;d=m.next()){var h=d.value;h.x+=h.xa;h.y+=h.ya;h.xa*=h.x>a.size[0]||0>h.x?-1:1;h.ya*=h.y>
a.size[1]||0>h.y?-1:1;a.uContext.fillRect(h.x-.5,h.y-.5,1,1);for(f=0;f<c.length;f++)if(d=c[f],h!==d&&null!==d.x&&null!==d.y){var l=h.x-d.x;var n=h.y-d.y;var p=l*l+n*n;p<d.max&&(d===a.f&&p>=d.max/2&&(h.x-=.03*l,h.y-=.03*n),g=(d.max-p)/d.max,a.uContext.beginPath(),a.uContext.lineWidth=g/2,a.uContext.strokeStyle="rgba("+a.setting.color+", "+(g+.2)+")",a.uContext.moveTo(h.x,h.y),a.uContext.lineTo(d.x,d.y),a.uContext.stroke())}c.splice(c.indexOf(h),1)}b.defaultCallback(function(){return a.update()})};
...
(function(c){(function(c){var b=function(a){return Bootstrap.apply(this,arguments)||this};$jscomp.inherits(b,Bootstrap);b.prototype.init=function(){this.path=decodeURIComponent($ts.location("proj"));this.loadSummary(this.path);$ts("#path").display(this.path)};b.prototype.loadSummary=function(a){a="@web_invoke_inspect_model?proj="+encodeURIComponent(a);$ts.get(a,function(a){if(0!=a.code)desktop.showToastMessage("Load project file error!","Project Reader","danger");else{a=a.info;var b=a.total,c=a.number_enzymes;
b=0>b-c?0:b-c;console.log(a);(new js_plot.piePlot("Protein Annotations","Metabolic Annotation","summary_pie")).plot("protein numbers",[{name:"enzymes",value:c},{name:"no annotation",value:b}]);var d=a.enzyme_class;a=$from(Object.keys(d)).Select(function(a){return{name:a,value:d[a]}}).ToArray();(new js_plot.piePlot("Metabolic Annotation","Enzyme Class Counts","summary_enzyme_pie")).plot("protein numbers",a)}})};b.prototype.enzyme_anno_onclick=function(){var a=this;desktop.loading("Extract protein set, wait for a while...");
apps.gcmodeller.getNextUniqueId().then(function(b){return __awaiter(this,void 0,void 0,function f(){return $jscomp.generator.createGenerator(f,function(c){if(1==c.nextAddress)return c.yield(b,2);b=c.yieldResult;$ts.post("@web_invoke_extract_proteins",{proj:a.path,ssid:b},function(c){console.log(c);0==c.code?a.create_localBlastTask(c,b,"ontology_annotation"):desktop.showToastMessage(c.info,"Extract Data Error","danger");desktop.closeSpinner()});c.jumpToEnd()})})})};b.prototype.subcellular_anno_onclick=
function(){var a=this;desktop.loading("Extract protein set, wait for a while...");apps.gcmodeller.getNextUniqueId().then(function(b){return __awaiter(this,void 0,void 0,function f(){return $jscomp.generator.createGenerator(f,function(c){if(1==c.nextAddress)return c.yield(b,2);b=c.yieldResult;$ts.post("@web_invoke_extract_proteins",{proj:a.path,ssid:b},function(c){console.log(c);0==c.code?a.create_localBlastTask(c,b,"subcellular_location"):desktop.showToastMessage(c.info,"Extract Data Error","danger");
desktop.closeSpinner()});c.jumpToEnd()})})})};b.prototype.create_localBlastTask=function(a,b,c){var d=a.info.dataset,e=this.path;a={ontology_annotation:function(a){return a.info.blast.ec_numbers},subcellular_location:function(a){return a.info.blast.subcellular_location}}[c](a);c={query:d,reference:a,n_threads:2,evalue:.001,project:e,protocol:c};console.log("view of the annotation parameters:");console.log(c);localStorage.setItem(b,JSON.stringify(c));apps.gcmodeller.openLocalBlast(b)};$jscomp.global.Object.defineProperties(b.prototype,
{appName:{configurable:!0,enumerable:!0,get:function(){return"bioproject"}}});c.bioproject=b})(c.modeller||(c.modeller={}))})(pages||(pages={}));
(function(c){(function(c){var b=function(a){return Bootstrap.apply(this,arguments)||this};$jscomp.inherits(b,Bootstrap);b.prototype.init=function(){};b.prototype.button_open_gbff_onclick=function(){var a=$ts("#gbff-file").CType(),b=this;apps.gcmodeller.getFileOpen(apps.ncbi_genbank_assembly).then(function(c){return __awaiter(this,void 0,void 0,function g(){var d;return $jscomp.generator.createGenerator(g,function(e){if(1==e.nextAddress)return d=a,e.yield(c,2);d.value=e.yieldResult;Strings.Empty(a.value,
...
k.counts+"<br />";c+='<span class="badge badge-primary">Models</span>: '+l.Count+"<br />";c+='<span class="badge badge-primary">Backgrounds</span>: <br /><br />\n                        <ul class="list-group list-group-light">\n                            '+d+"\n                        </ul>\n                    "}else desktop.showToastMessage(f.info,e,"danger");$ts("#summary-info").display(c);isNullOrUndefined(h)||h()};b.viewModel=function(a,b,c){$ts.post("@web_invoke_loadModel",{guid:a,xref:b},
...
$ts.url("@web_invoke_imports"),JSON.stringify(b)).then(function(a){return __awaiter(this,void 0,void 0,function g(){var b;return $jscomp.generator.createGenerator(g,function(c){if(1==c.nextAddress)return c.yield(a.data,2);b=c.yieldResult;desktop.showTaskAlert();desktop.showToastMessage("Pending a new task: "+b,"Build enzyme blast+ database","info");c.jumpToEnd()})})})};b.prototype.button_open_uniprot=function(){var a=$ts("#uniprot-file").CType();apps.gcmodeller.getFileOpen(apps.uniprot_assembly).then(function(b){return __awaiter(this,
void 0,void 0,function f(){var c;return $jscomp.generator.createGenerator(f,function(d){if(1==d.nextAddress)return c=a,d.yield(b,2);c.value=d.yieldResult;d.jumpToEnd()})})})};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"enzyme_database"}}});c.enzyme_database=b})(c.repository||(c.repository={}))})(pages||(pages={}));
...
"danger"):apps.gcmodeller.createTask("Imports Enzyme Database",$ts.url("@web_invoke_imports"),JSON.stringify(b)).then(function(a){return __awaiter(this,void 0,void 0,function g(){var b;return $jscomp.generator.createGenerator(g,function(c){if(1==c.nextAddress)return c.yield(a.data,2);b=c.yieldResult;desktop.showTaskAlert();desktop.showToastMessage("Pending a new task: "+b,"Build enzyme blast+ database","info");c.jumpToEnd()})})})};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,
