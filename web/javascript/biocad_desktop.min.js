...
(function(a){var b=function(){};b.prototype.getMaxOnExtent=function(){for(var a=-Infinity,b=-Infinity,d=this.data,f=0;f<d.length;f++){var g=d[f],k=g[this.fieldIndices[this.config.symbolSize]];a=Math.max(g[this.fieldIndices[this.config.color]],a);b=Math.max(k,b)}return{color:a,symbolSize:b}};b.prototype.load=function(a,b){b=void 0===b?[{name:"",index:0},{name:"dim1",index:1},{name:"dim2",index:2},{name:"dim3",index:3}]:b;a=document.getElementById(a);this.myChart=echarts.init(a);this.fieldIndices=b.reduce(function(a,
b){a[b.name]=b.index;return a},{});b=b.map(function(a){return a.name});var c=this;b=b.slice(1,b.length-1);this.config={xAxis3D:"dim1",yAxis3D:"dim2",zAxis3D:"dim3",color:"dim1",symbolSize:"dim2",onChange:function(){var a=c.getMaxOnExtent();c.data&&c.myChart.setOption({visualMap:[{max:a.color/2},{max:a.symbolSize/2}],xAxis3D:{name:c.config.xAxis3D},yAxis3D:{name:c.config.yAxis3D},zAxis3D:{name:c.config.zAxis3D},series:{dimensions:[c.config.xAxis3D,c.config.yAxis3D,c.config.yAxis3D,c.config.color,c.config.symbolSize],
data:c.data.map(function(a,b){return[a[c.fieldIndices[c.config.xAxis3D]],a[c.fieldIndices[c.config.yAxis3D]],a[c.fieldIndices[c.config.zAxis3D]],a[c.fieldIndices[c.config.color]],a[c.fieldIndices[c.config.symbolSize]],b]})}})}};["xAxis3D","yAxis3D","zAxis3D","color","symbolSize"].forEach(function(a){})};b.prototype.plot=function(a,b,d){d=void 0===d?[{name:"",index:0},{name:"dim1",index:1},{name:"dim2",index:2},{name:"dim3",index:3}]:d;this.data=a;this.load(void 0===b?"Rplot_js":b,d);a=this.getMaxOnExtent();
var c=this;c.myChart.setOption({tooltip:{},visualMap:[{top:10,calculable:!0,dimension:3,max:a.color/2,inRange:{color:"#1710c0 #0b9df0 #00fea8 #00ff0d #f5f811 #f09a09 #fe0300".split(" ")},textStyle:{color:"#fff"}},{bottom:10,calculable:!0,dimension:4,max:a.symbolSize/2,inRange:{symbolSize:[10,40]},textStyle:{color:"#fff"}}],xAxis3D:{name:c.config.xAxis3D,type:"value"},yAxis3D:{name:c.config.yAxis3D,type:"value"},zAxis3D:{name:c.config.zAxis3D,type:"value"},grid3D:{axisLine:{lineStyle:{color:"#fff"}},
axisPointer:{lineStyle:{color:"#ffbd67"}},viewControl:{}},series:[{type:"scatter3D",dimensions:[c.config.xAxis3D,c.config.yAxis3D,c.config.yAxis3D,c.config.color,c.config.symbolSize],data:c.data.map(function(a,b){return[a[c.fieldIndices[c.config.xAxis3D]],a[c.fieldIndices[c.config.yAxis3D]],a[c.fieldIndices[c.config.zAxis3D]],a[c.fieldIndices[c.config.color]],a[c.fieldIndices[c.config.symbolSize]],b]}),symbolSize:12,itemStyle:{borderWidth:1,borderColor:"rgba(255,255,255,0.8)"},emphasis:{itemStyle:{color:"#fff"}}}]})};
a.scatter3d=b})(js_plot||(js_plot={}));var pages;(function(a){var b=function(a){return Bootstrap.apply(this,arguments)||this};$jscomp.inherits(b,Bootstrap);b.prototype.generateSsid=function(a){a=JSON.stringify(a);a=desktop.now()+"-"+a+"-"+this.appName;return md5(a)};a.analysis_session=b})(pages||(pages={}));
...
info:g.summary[a]}}).Where(function(a){return 0<a.info.unique_size}).Where(function(a){return 1<a.info.unique_size/a.info.clusters});e=h.Select(function(a){return b.summaryLine(a.name,a.info)}).JoinBy("");desktop.showToastMessage("Success!",f,"success");l=function(){for(var c={},e=$jscomp.makeIterator(h.ToArray()),d=e.next();!d.done;c={$jscomp$loop$prop$name$10:c.$jscomp$loop$prop$name$10,$jscomp$loop$prop$model$11:c.$jscomp$loop$prop$model$11},d=e.next())c.$jscomp$loop$prop$model$11=d.value,c.$jscomp$loop$prop$name$10=
c.$jscomp$loop$prop$model$11.name,d="#model-"+c.$jscomp$loop$prop$name$10,console.log(d),$ts(d).onclick=function(c){return function(){$ts("#busy-indicator").show();console.log("view background model: "+c.$jscomp$loop$prop$name$10+"...");b.viewModel(a,c.$jscomp$loop$prop$name$10,c.$jscomp$loop$prop$model$11.info)}}(c)};c+='<span class="badge badge-primary">Protein Counts</span>: '+g.counts+"<br />";c+='<span class="badge badge-primary">Models</span>: '+h.Count+"<br />";c+='<span class="badge badge-primary">Backgrounds</span>: <br /><br />\n                                    <ul class="list-group list-group-light">\n                                        '+
