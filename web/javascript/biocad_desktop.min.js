...
function(a){a=JSON.stringify({ssid:a});apps.gcmodeller.sendPost($ts.url("@web_invoke_Rplot"),a).then(function(a){desktop.promiseAsyncCallback(a,function(a,b){a?($ts("#Rplot-box").CType().href=b.info,$ts("#Rplot_js").CType().src=b.info):desktop.showToastMessage(b.info,"Rplot Error","danger")})})};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"dataEmbedding"}}});a.dataEmbedding=b})(pages||(pages={}));
