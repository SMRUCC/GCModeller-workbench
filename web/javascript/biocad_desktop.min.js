...
0;a<this.onSettledCallbacks_.length;++a)g.asyncExecute(this.onSettledCallbacks_[a]);this.onSettledCallbacks_=null}};var g=new d;e.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};e.prototype.settleSameAsThenable_=function(a,b){var e=this.createResolveAndReject_();try{a.call(b,e.resolve,e.reject)}catch(h){e.reject(h)}};e.prototype.then=function(a,b){function c(a,b){return"function"==typeof a?function(b){try{d(a(b))}catch(t){g(t)}}:
...
$jscomp.polyfill("Math.log10",function(c){return c?c:function(c){return Math.log(c)/Math.LN10}},"es6","es3");var __awaiter=this&&this.__awaiter||function(c,d,b,a){return new (b||(b=Promise))(function(e,g){function f(b){try{m(a.next(b))}catch(l){g(l)}}function k(b){try{m(a["throw"](b))}catch(l){g(l)}}function m(a){a.done?e(a.value):(new b(function(b){b(a.value)})).then(f,k)}m((a=a.apply(c,d||[])).next())})},apps;
...
"&lt;"));a=$ts("<li>").display(a);m.appendElement(a)})};b.prototype.showGraph=function(a,b){var c={},d=[];c[a]={id:a,name:a,symbolSize:Math.log10(b.length)+1};b=$jscomp.makeIterator(b);for(var e=b.next();!e.done;e=b.next()){e=e.value;c[e.protein_id]={id:e.protein_id,name:e.protein_id,symbolSize:e.reactions.length+1};d.push({source:a,target:e.protein_id});for(var m=$jscomp.makeIterator(e.reactions),h=m.next();!h.done;h=m.next())h=h.value,h.entry in c||(c[h.entry]={id:h.entry,name:h.definition,symbolSize:3}),
d.push({source:e.protein_id,target:h.entry})}(new js_plot.graph_plot("container")).plot("Metabolic_graph@"+a,{nodes:$from(Object.keys(c)).Select(function(a){return c[a]}).ToArray(),links:d,categories:[]})};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"metabolic_viewer"}}});c.metabolic_viewer=b})(c.viewers||(c.viewers={}))})(pages||(pages={}));
