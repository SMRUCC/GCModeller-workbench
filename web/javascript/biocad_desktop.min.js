...
0;a<this.onSettledCallbacks_.length;++a)g.asyncExecute(this.onSettledCallbacks_[a]);this.onSettledCallbacks_=null}};var g=new d;e.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};e.prototype.settleSameAsThenable_=function(a,b){var e=this.createResolveAndReject_();try{a.call(b,e.resolve,e.reject)}catch(h){e.reject(h)}};e.prototype.then=function(a,b){function c(a,b){return"function"==typeof a?function(b){try{g(a(b))}catch(t){d(t)}}:
b}var g,d,f=new e(function(a,b){g=a;d=b});this.callWhenSettled_(c(a,g),c(b,d));return f};e.prototype.catch=function(a){return this.then(void 0,a)};e.prototype.callWhenSettled_=function(a,b){function e(){switch(c.state_){case 1:a(c.result_);break;case 2:b(c.result_);break;default:throw Error("Unexpected state: "+c.state_);}}var c=this;null==this.onSettledCallbacks_?g.asyncExecute(e):this.onSettledCallbacks_.push(e)};e.resolve=b;e.reject=function(a){return new e(function(b,e){e(a)})};e.race=function(a){return new e(function(e,
c){for(var g=$jscomp.makeIterator(a),d=g.next();!d.done;d=g.next())b(d.value).callWhenSettled_(e,c)})};e.all=function(a){var c=$jscomp.makeIterator(a),d=c.next();return d.done?b([]):new e(function(a,e){function g(b){return function(e){f[b]=e;k--;0==k&&a(f)}}var f=[],k=0;do f.push(void 0),k++,b(d.value).callWhenSettled_(g(f.length-1),e),d=c.next();while(!d.done)})};return e},"es6","es3");
...
var __awaiter=this&&this.__awaiter||function(c,d,b,a){return new (b||(b=Promise))(function(e,g){function f(b){try{m(a.next(b))}catch(l){g(l)}}function k(b){try{m(a["throw"](b))}catch(l){g(l)}}function m(a){a.done?e(a.value):(new b(function(b){b(a.value)})).then(f,k)}m((a=a.apply(c,d||[])).next())})},apps;
...
a.yieldResult;if($ts.csv.isTsvFile(e))d={code:0,info:e};else if(e.startsWith("data:"))d={code:0,info:e};else try{d=JSON.parse(e)}catch(k){d={code:500,info:e}}return a.return(d)})})};c.processHtmlMsg=function(d){"string"==typeof d?(d=d.replace(/[<]/ig,"&lt;"),d=Strings.lineTokens(d).join("<br />")):d=c.RSharp.isRSharpError(d)?c.RSharp.RSharpErrorMessage(d):"Unhandle error!";return d}})(desktop||(desktop={}));
(function(c){function d(a,e,d,f,k){e=void 0===e?"Task Error":e;d=void 0===d?"":d;f=void 0===f?"danger":f;return $ts("<div>",{class:["toast","show","fade","toast-"+f],role:"alert","aria-live":"assertive","aria-atomic":"true","data-mdb-color":f,"data-mdb-autohide":(void 0===k?!0:k).toString(),style:"width: 500px;"}).display('        \n            <div class="toast-header toast-'+f+'">\n                <i class="'+b[f]+'"></i>\n                <strong class="me-auto">'+e+"</strong>\n                <small>"+
...
this.show()};c.graph_plot=d})(js_plot||(js_plot={}));
...
b.prototype.showTaskDatalist=function(a,b){b=void 0===b?null:b;a=$from(a).Select(function(a){return JSON.parse(a)}).ToArray();this.loadTaskList(a).then(function(a){isNullOrUndefined(b)||b()})};b.prototype.loadTaskList=function(a){return __awaiter(this,void 0,void 0,function g(){var c,d,m,h,l,n,p;return $jscomp.generator.createGenerator(g,function(g){switch(g.nextAddress){case 1:c=$ts("#task_manager").clear(),m=null,h={},l=$jscomp.makeIterator(a),n=l.next();case 2:if(n.done){g.jumpTo(4);break}h.$jscomp$loop$prop$task$26=
n.value;p=h;return g.yield(b.getHostObject(h.$jscomp$loop$prop$task$26),5);case 5:p.$jscomp$loop$prop$task$26=g.yieldResult;m=h.$jscomp$loop$prop$task$26.session_id.replace(/\./ig,"-");d=b.buildTaskHtml(h.$jscomp$loop$prop$task$26,m);c.appendElement(d);localStorage.setItem(h.$jscomp$loop$prop$task$26.session_id,JSON.stringify(h.$jscomp$loop$prop$task$26.arguments));$ts("#"+m).onclick=function(a){return function(){apps.gcmodeller.openPage(a.$jscomp$loop$prop$task$26.session_id,JSON.stringify(a.$jscomp$loop$prop$task$26))}}(h);
h={$jscomp$loop$prop$task$26:h.$jscomp$loop$prop$task$26};n=l.next();g.jumpTo(2);break;case 4:return g.return(0)}})})};b.getHostObject=function(a){return __awaiter(this,void 0,void 0,function g(){var b,c,d,h,l,n,p,q,r,t;return $jscomp.generator.createGenerator(g,function(g){switch(g.nextAddress){case 1:return c=b={},g.yield(a.appName,2);case 2:return c.appName=g.yieldResult,d=b,g.yield(a.arguments,3);case 3:return d.arguments=g.yieldResult,h=b,g.yield(a.error,4);case 4:return h.error=g.yieldResult,
...
for(f=a.next();!f.done;f=a.next()){var k=f.value;this.sampleInfo[k.ID]=k;f=c[d++];"0"!=k.delete&&b.deleteSampleRow(f.tr,f)}return this.editor.table};b.deleteSampleRow=function(a,b){a.cells.item(0);b.dropFlag?(a.style.backgroundColor="white",b.getElementById("remove").innerHTML="\u5220\u9664\u6837\u672c"):(a.style.backgroundColor="gray",b.getElementById("remove").innerHTML="\u6062\u590d\u6837\u672c");b.dropFlag=!b.dropFlag};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,
enumerable:!0,get:function(){return"edit_sampleinfo"}}});c.edit_sampleinfo=b})(c.analysis_project||(c.analysis_project={}))})(pages||(pages={}));
(function(c){(function(c){var b=function(a,b,c,d,k,m,h){a=void 0===a?document.createElement("canvas"):a;b=void 0===b?a.getContext("2d"):b;c=void 0===c?{x:null,y:null,max:2E4}:c;d=void 0===d?[0,0]:d;k=void 0===k?[]:k;this.uCanvas=a;this.uContext=b;this.f=c;this.size=d;this.dots=k;this.setting=void 0===m?null:m;this.frameRender=void 0===h?null:h};b.getTag=function(a){return document.getElementsByTagName(a)[0]};b.getById=function(a){return document.getElementById(a)};b.prototype.canvasResize=function(){this.uCanvas.width=
window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth;this.uCanvas.height=window.innerHeight||document.documentElement.clientHeight||document.body.clientHeight;this.size=[this.uCanvas.width,this.uCanvas.height]};b.prototype.update=function(){var a=this,c=[a.f].concat(a.dots),d,f,k;a.uContext.clearRect(0,0,a.size[0],a.size[1]);var m=$jscomp.makeIterator(a.dots);for(d=m.next();!d.done;d=m.next()){var h=d.value;h.x+=h.xa;h.y+=h.ya;h.xa*=h.x>a.size[0]||0>h.x?-1:1;h.ya*=h.y>
a.size[1]||0>h.y?-1:1;a.uContext.fillRect(h.x-.5,h.y-.5,1,1);for(f=0;f<c.length;f++)if(d=c[f],h!==d&&null!==d.x&&null!==d.y){var l=h.x-d.x;var n=h.y-d.y;var p=l*l+n*n;p<d.max&&(d===a.f&&p>=d.max/2&&(h.x-=.03*l,h.y-=.03*n),k=(d.max-p)/d.max,a.uContext.beginPath(),a.uContext.lineWidth=k/2,a.uContext.strokeStyle="rgba("+a.setting.color+", "+(k+.2)+")",a.uContext.moveTo(h.x,h.y),a.uContext.lineTo(d.x,d.y),a.uContext.stroke())}c.splice(c.indexOf(h),1)}b.defaultCallback(function(){return a.update()})};
...
c[d],a.category_index["EC"+c[d]]=d;console.log(a.enzyme_class);e.jumpToEnd()})})});apps.gcmodeller.getMetabolicCompartments().then(function(c){return __awaiter(this,void 0,void 0,function k(){var d,e,g,n;return $jscomp.generator.createGenerator(k,function(k){if(1==k.nextAddress)return k.yield(c,2);d=k.yieldResult;e=$jscomp.makeIterator(d);for(g=e.next();!g.done;g=e.next())n=g.value,a.compartments[n]=[],b.appendElement($ts("<option>",{value:n}).display(n));k.jumpToEnd()})})})};b.prototype.compartment_list_onchange=
...
d.jumpToEnd()})})}):(this.showNetworkImpl(a,this.compartments[a]),this.showGraph(a,this.compartments[a]))};b.prototype.showNetworkImpl=function(a,b){var c=[],d=this,e=[],m=$ts("#reaction-graph-data").clear();b=$jscomp.makeIterator(b);for(var h=b.next();!h.done;h=b.next()){h=$jscomp.makeIterator(h.value.reactions);for(var l=h.next();!l.done;l=h.next()){l=l.value;for(var n=$jscomp.makeIterator(l.enzyme),p=n.next();!p.done;p=n.next())c.push(p.value);e.push(l)}}c=$from(c).Where(function(a){return!Strings.Empty(a,
...
"&lt;"));a=$ts("<li>").display(a);m.appendElement(a)})};b.prototype.showGraph=function(a,b){var c={},d=[];c[a]={id:a,name:a,symbolSize:b.length+1};b=$jscomp.makeIterator(b);for(var e=b.next();!e.done;e=b.next()){e=e.value;c[e.protein_id]={id:e.protein_id,name:e.protein_id,symbolSize:e.reactions.length+1};d.push({source:a,target:e.protein_id});for(var m=$jscomp.makeIterator(e.reactions),h=m.next();!h.done;h=m.next())h=h.value,h.entry in c||(c[h.entry]={id:h.entry,name:h.definition,symbolSize:3}),d.push({source:e.protein_id,
target:h.entry})}(new js_plot.graph_plot("container")).plot("Metabolic_graph@"+a,{nodes:$from(Object.keys(c)).Select(function(a){return c[a]}).ToArray(),links:d,categories:[]})};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"metabolic_viewer"}}});c.metabolic_viewer=b})(c.viewers||(c.viewers={}))})(pages||(pages={}));
