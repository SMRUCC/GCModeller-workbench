...
a).then(function(a){return __awaiter(this,void 0,void 0,function k(){return $jscomp.generator.createGenerator(k,function(b){desktop.parseMessage(a).then(function(b){desktop.parseResultFlag(a,b).then(function(a){if(a){var c=new bootstrap.Modal($ts("#view-background"),{keyboard:!1}),d=b.info.clusters;a=Object.keys(d);console.log(d);console.log(a);a=$from(a).Select(function(a){return"<div>"+a.replace(/[<]/ig,"&lt;")+" ["+d[a].length+" proteins]</div>"}).ToArray();new Clusterize({rows:a,scrollId:"scrollArea",
contentId:"contentArea"});$ts("#busy-indicator").hide();$ts("#modal-close1").onclick=function(){return c.hide()};$ts("#modal-close2").onclick=function(){return c.hide()};c.show()}else desktop.showToastMessage(b.info,"Load Model Error",null,"danger")})});b.jumpToEnd()})})})};b.summaryLine=function(a,b){return'<li class="list-group-item d-flex justify-content-between align-items-center">\n                        <div class="d-flex align-items-center">\n                            <span class="badge rounded-pill badge-success">                \n                                <i class="fab fa-laravel"></i>&nbsp;'+
