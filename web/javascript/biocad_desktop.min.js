...
0;a<this.onSettledCallbacks_.length;++a)k.asyncExecute(this.onSettledCallbacks_[a]);this.onSettledCallbacks_=null}};var k=new d;e.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};e.prototype.settleSameAsThenable_=function(a,b){var e=this.createResolveAndReject_();try{a.call(b,e.resolve,e.reject)}catch(h){e.reject(h)}};e.prototype.then=function(a,b){function c(a,b){return"function"==typeof a?function(b){try{d(a(b))}catch(t){k(t)}}:
b}var d,k,f=new e(function(a,b){d=a;k=b});this.callWhenSettled_(c(a,d),c(b,k));return f};e.prototype.catch=function(a){return this.then(void 0,a)};e.prototype.callWhenSettled_=function(a,b){function e(){switch(c.state_){case 1:a(c.result_);break;case 2:b(c.result_);break;default:throw Error("Unexpected state: "+c.state_);}}var c=this;null==this.onSettledCallbacks_?k.asyncExecute(e):this.onSettledCallbacks_.push(e)};e.resolve=b;e.reject=function(a){return new e(function(b,e){e(a)})};e.race=function(a){return new e(function(e,
...
$ts.url("@web_invoke_imports"),JSON.stringify(b)).then(function(a){return __awaiter(this,void 0,void 0,function g(){var b;return $jscomp.generator.createGenerator(g,function(c){if(1==c.nextAddress)return c.yield(a.data,2);b=c.yieldResult;desktop.showTaskAlert();desktop.showToastMessage("Pending a new task: "+b,"Build enzyme blast+ database","info");c.jumpToEnd()})})})};b.prototype.run_rhea_onclick=function(){};b.prototype.button_open_rhea_onclick=function(){desktop.winforms.openfileDialog("#rhea-file",
...
c.jumpToEnd()})})})};b.prototype.previous_onclick=function(){0!=this.intptr&&(this.intptr--,this.viewBlastp(this.current_id))};b.prototype.next_onclick=function(){this.intptr!=this.protein_ids.length-1&&(this.intptr++,this.viewBlastp(this.current_id))};b.prototype.viewBlastp=function(a){var b=function(b){for(var c=[],d=0;d<b.length;d++)delete b[d].QueryName,delete b[d].HitName,delete b[d].hit_length,delete b[d].length_hit,delete b[d].length_hsp,delete b[d].length_query,delete b[d].query_length,b[d].evalue=
b[d].evalue.toString(),c.push(b[d].description.split("|")[0]);$ts("#blast_output").clear();$ts("#protein_id").clear().display(a);$ts.appendTable(b,"#blast_output",null,{class:["table","table-sm"]});b=$from(c).GroupBy(function(a){return a}).Select(function(a){return{name:a.Key,value:a.Count}}).ToArray();console.log("get hits summary:");console.table(b);(new js_plot.piePlot("Annotation Hits Supports","Term Hits","preview_1")).plot("protein hits",b)};apps.gcmodeller.getBlastp(a).then(function(a){return __awaiter(this,
void 0,void 0,function g(){return $jscomp.generator.createGenerator(g,function(c){if(1==c.nextAddress)return c.yield(a,2);a=c.yieldResult;b(JSON.parse(a));c.jumpToEnd()})})})};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"blastp_viewer"}},current_id:{configurable:!0,enumerable:!0,get:function(){return isNullOrUndefined(this.protein_ids)||isNullOrUndefined(this.intptr)||0==this.protein_ids.length?"Missing":this.protein_ids[this.intptr]}}});
c.view_protein_blast=b})(c.viewers||(c.viewers={}))})(pages||(pages={}));
