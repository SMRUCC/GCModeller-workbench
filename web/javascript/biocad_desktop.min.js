...
function(){this.SaveSettings()};d.prototype.open_ncbi_blast_folder_onclick=function(){var b=$ts("#ncbi_blast_folder"),a=this;desktop.loading("Load configurations...");apps.gcmodeller.getFolderOpen().then(function(c){return __awaiter(this,void 0,void 0,function f(){var e;return $jscomp.generator.createGenerator(f,function(d){if(1==d.nextAddress)return e=b,d.yield(c,2);e.value=d.yieldResult;desktop.closeSpinner();Strings.Empty(b.value,!0)||a.SaveSettings();d.jumpToEnd()})})})};d.prototype.open_repository_folder_onclick=
...
n.value;p=k;return g.yield(b.getHostObject(k.$jscomp$loop$prop$task$24),5);case 5:p.$jscomp$loop$prop$task$24=g.yieldResult;m=k.$jscomp$loop$prop$task$24.session_id.replace(/\./ig,"-");d=b.buildTaskHtml(k.$jscomp$loop$prop$task$24,m);c.appendElement(d);localStorage.setItem(k.$jscomp$loop$prop$task$24.session_id,JSON.stringify(k.$jscomp$loop$prop$task$24.arguments));$ts("#"+m).onclick=function(a){return function(){apps.gcmodeller.openPage(a.$jscomp$loop$prop$task$24.session_id,JSON.stringify(a.$jscomp$loop$prop$task$24))}}(k);
k={$jscomp$loop$prop$task$24:k.$jscomp$loop$prop$task$24};n=l.next();g.jumpTo(2);break;case 4:return g.return(0)}})})};b.getHostObject=function(a){return __awaiter(this,void 0,void 0,function g(){var b,c,d,k,l,n,p,q,r,t;return $jscomp.generator.createGenerator(g,function(g){switch(g.nextAddress){case 1:return c=b={},g.yield(a.appName,2);case 2:return c.appName=g.yieldResult,d=b,g.yield(a.arguments,3);case 3:return d.arguments=g.yieldResult,k=b,g.yield(a.error,4);case 4:return k.error=g.yieldResult,
...
function(a){a=JSON.parse(a||"[]");var c=Object.keys(a).length,d=$ts("#repository"),f={},h;for(h in a){f.$jscomp$loop$prop$key$28=h;f.$jscomp$loop$prop$metadata$29=a[f.$jscomp$loop$prop$key$28];var m=b.buildDbCard(f.$jscomp$loop$prop$key$28,f.$jscomp$loop$prop$metadata$29);d.appendElement(m);console.log(f.$jscomp$loop$prop$key$28);$ts("#"+f.$jscomp$loop$prop$key$28).onclick=function(a){return function(){apps.gcmodeller.openEnrichmentPage(a.$jscomp$loop$prop$key$28,a.$jscomp$loop$prop$metadata$29.name,
a.$jscomp$loop$prop$metadata$29.note)}}(f);$ts("#"+f.$jscomp$loop$prop$key$28+"-meta").onclick=function(a){return function(){desktop.loading();b.showMetadata(a.$jscomp$loop$prop$key$28,a.$jscomp$loop$prop$metadata$29)}}(f);f={$jscomp$loop$prop$key$28:f.$jscomp$loop$prop$key$28,$jscomp$loop$prop$metadata$29:f.$jscomp$loop$prop$metadata$29}}desktop.closeSpinner();desktop.showToastMessage("Found "+c+" database.","Enrichment Database Repository","info")};b.showMetadata=function(a,c){var d="",e=JSON.stringify({guid:a});
...
{$jscomp$loop$prop$name$31:c.$jscomp$loop$prop$name$31,$jscomp$loop$prop$model$32:c.$jscomp$loop$prop$model$32},e=d.next())c.$jscomp$loop$prop$model$32=e.value,c.$jscomp$loop$prop$name$31=c.$jscomp$loop$prop$model$32.name,e="#model-"+c.$jscomp$loop$prop$name$31,console.log(e),$ts(e).onclick=function(c){return function(){desktop.loading();console.log("view background model: "+c.$jscomp$loop$prop$name$31+"...");b.viewModel(a,c.$jscomp$loop$prop$name$31,c.$jscomp$loop$prop$model$32.info)}}(c)};c+='<span class="badge badge-primary">Protein Counts</span>: '+
...
(function(c){(function(c){var b=function(){var a=Bootstrap.apply(this,arguments)||this;a.compartments={};a.enzyme_class={};a.category_index={};return a};$jscomp.inherits(b,Bootstrap);b.prototype.init=function(){var a=this,b=$ts("#compartment-list");apps.gcmodeller.getEnzymeClass().then(function(b){return __awaiter(this,void 0,void 0,function h(){var c,d;return $jscomp.generator.createGenerator(h,function(e){if(1==e.nextAddress)return e.yield(b,2);b=e.yieldResult;c=JSON.parse(b);for(d in c)a.enzyme_class[d]=
c[d],a.category_index["EC"+c[d]]=d;console.log(a.enzyme_class);e.jumpToEnd()})})});apps.gcmodeller.getMetabolicCompartments().then(function(c){return __awaiter(this,void 0,void 0,function h(){var d,e,g,n,p;return $jscomp.generator.createGenerator(h,function(h){if(1==h.nextAddress)return h.yield(c,2);d=h.yieldResult;e={};g=$jscomp.makeIterator(d);for(n=g.next();!n.done;e={$jscomp$loop$prop$id$34:e.$jscomp$loop$prop$id$34},n=g.next())e.$jscomp$loop$prop$id$34=n.value,p=e.$jscomp$loop$prop$id$34.replace(/\s+/ig,
"-"),a.compartments[e.$jscomp$loop$prop$id$34]=[],b.appendElement($ts("<li>").display('<a href="#" onclick="javascript:void(0);" id="'+p+'">'+e.$jscomp$loop$prop$id$34+"</a>")),$ts("#"+p).onclick=function(b){return function(){a.showMetabolicNetwork(b.$jscomp$loop$prop$id$34)}}(e);h.jumpToEnd()})})})};b.prototype.showMetabolicNetwork=function(a){var b=this;isNullOrEmpty(this.compartments[a])?apps.gcmodeller.getMetabolicEnzymes(a).then(function(c){return __awaiter(this,void 0,void 0,function h(){return $jscomp.generator.createGenerator(h,
function(d){if(1==d.nextAddress)return d.yield(c,2);c=d.yieldResult;b.compartments[a]=JSON.parse(c);b.showNetworkImpl(a,b.compartments[a]);d.jumpToEnd()})})}):this.showNetworkImpl(a,this.compartments[a])};b.prototype.showNetworkImpl=function(a,b){var c=[],d=this,e=[],m=$ts("#reaction-graph-data").clear();b=$jscomp.makeIterator(b);for(var k=b.next();!k.done;k=b.next()){k=$jscomp.makeIterator(k.value.reactions);for(var l=k.next();!l.done;l=k.next()){l=l.value;for(var n=$jscomp.makeIterator(l.enzyme),
p=n.next();!p.done;p=n.next())c.push(p.value);e.push(l)}}c=$from(c).Where(function(a){return!Strings.Empty(a,!0)}).GroupBy(function(a){return a.split(".")[0]}).Where(function(a){return"EC"+a.Key in d.category_index}).Select(function(a){return{name:d.category_index["EC"+a.Key],value:a.Count}}).ToArray();console.table(c);console.log(e);(new js_plot.piePlot("Metabolic Composition","Subcellular Location: "+a,"enzyme-class")).plot("Reaction Counts",c);$from(e).GroupBy(function(a){return a.entry}).ForEach(function(a){a=
a.First;var b=a.entry.replace(":","-");a=$ts("<a>",{id:b,href:"#"}).display(a.definition.replace(/[<]/ig,"&lt;"));a=$ts("<li>").display(a);m.appendElement(a)})};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"metabolic_viewer"}}});c.metabolic_viewer=b})(c.viewers||(c.viewers={}))})(pages||(pages={}));
