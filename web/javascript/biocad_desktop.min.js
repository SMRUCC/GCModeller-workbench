...
function(){this.SaveSettings()};d.prototype.open_ncbi_blast_folder_onclick=function(){var b=$ts("#ncbi_blast_folder"),a=this;desktop.loading("Load configurations...");apps.gcmodeller.getFolderOpen().then(function(c){return __awaiter(this,void 0,void 0,function g(){var e;return $jscomp.generator.createGenerator(g,function(d){if(1==d.nextAddress)return e=b,d.yield(c,2);e.value=d.yieldResult;desktop.closeSpinner();Strings.Empty(b.value,!0)||a.SaveSettings();d.jumpToEnd()})})})};d.prototype.open_repository_folder_onclick=
