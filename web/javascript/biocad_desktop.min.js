...
function(a){var b=JSON.stringify({ssid:a});apps.gcmodeller.sendPost($ts.url("@web_invoke_Rplot"),b).then(function(b){desktop.promiseAsyncCallback(b,function(b,c){b?(b=$ts("<img>",{src:"/@temp/"+a+"/dataEmbedding.png"}),$ts("#Rplot_js").display(b)):desktop.showToastMessage(c.info,"Rplot Error","danger")})})};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"dataEmbedding"}}});a.dataEmbedding=b})(pages||(pages={}));
