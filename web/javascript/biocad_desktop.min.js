...
info:f.summary[a]}}).Where(function(a){return 0<a.info.unique_size}).Where(function(a){return 1<a.info.unique_size/a.info.clusters});a=h.Select(function(a){return b.summaryLine(a.name,a.info)}).JoinBy("");desktop.showToastMessage("Success!",e,null,"success");g=function(){for(var a={},b=$jscomp.makeIterator(h.Select(function(a){return a.name}).ToArray()),c=b.next();!c.done;a={$jscomp$loop$prop$name$10:a.$jscomp$loop$prop$name$10},c=b.next())a.$jscomp$loop$prop$name$10=c.value,$ts("#model-"+a.$jscomp$loop$prop$name$10).onclick=
function(a){return function(){console.log("view background model: "+a.$jscomp$loop$prop$name$10+"...")}}(a)};c+='<span class="badge badge-primary">Protein Counts</span>: '+f.counts+"<br />";c+='<span class="badge badge-primary">Models</span>: '+h.Count+"<br />";c+='<span class="badge badge-primary">Backgrounds</span>: <br /><br />\n                                    <ul class="list-group list-group-light">\n                                        '+a+"\n                                    </ul>\n                                "}else desktop.showToastMessage(d.info,
e,null,"danger");$ts("#summary-info").display(c);g||g()})});d.jumpToEnd()})})})};b.summaryLine=function(a,b){return'<li class="list-group-item d-flex justify-content-between align-items-center">\n                        <div class="d-flex align-items-center">\n                            <span class="badge rounded-pill badge-success">                \n                                <i class="fab fa-laravel"></i>&nbsp;'+a+"              \n                            </span>\n                            "+
