...
b.hide();d.jumpToEnd()})})})};b.prototype.run_click=function(){$ts("#busy-indicator").show();var c=$ts.value("#matrix-file"),e=$ts.value("#dimensions"),d=$ts.select.getOption("#algorithm"),f=a.analysis_session.prototype.generateSsid.call(this,{file:c,dims:e,algo:d}),g=$ts.value("#z-score");e=JSON.stringify({file:c,ssid:f,dims:e,algorithm:d,z_score:g});var l=this;Strings.Empty(c)?desktop.showToastMessage("The matrix data input file can not be nothing!","Data Embedding Analysis","danger"):apps.gcmodeller.sendPost($ts.url("@web_invoke_embedding"),
e).then(function(a){return __awaiter(this,void 0,void 0,function m(){return $jscomp.generator.createGenerator(m,function(c){desktop.promiseAsyncCallback(a,function(a,c){a?(a=$ts.csv(c.info,!0).Objects().Take(10),l.session_id=f,$ts.appendTable(a,"#embedding-table",null,{class:["table","table-sm"]}),b.plot3DScatter(f),desktop.showToastMessage("Run Data Embedding Analysis Success!",d+" Task Success","success")):desktop.showToastMessage(c.info,d+" Task Error","danger")});c.jumpToEnd()})})})};b.plot3DScatter=
function(a){a=JSON.stringify({ssid:a});apps.gcmodeller.sendPost($ts.url("@web_invoke_Rplot"),a).then(function(a){desktop.promiseAsyncCallback(a,function(a,b){a?(a=b.info+"?refresh="+md5(desktop.now()),$ts("#Rplot-box").CType().href=a,$ts("#Rplot_js").CType().src=a,$ts("#busy-indicator").hide()):desktop.showToastMessage(b.info,"Rplot Error","danger")})})};b.prototype.refresh_Rplot_click=function(){$ts("#busy-indicator").show();Strings.Empty(this.session_id)?desktop.showToastMessage("Data session id can not be nothing!",
"Rplot Error","danger"):b.plot3DScatter(this.session_id)};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"dataEmbedding"}}});a.dataEmbedding=b})(pages||(pages={}));
