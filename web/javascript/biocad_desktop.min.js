...
$jscomp.polyfill("Promise",function(b){function a(){this.batch_=null}function d(c){return c instanceof f?c:new f(function(a,d){a(c)})}if(b&&!$jscomp.FORCE_POLYFILL_PROMISE)return b;a.prototype.asyncExecute=function(c){null==this.batch_&&(this.batch_=[],this.asyncExecuteBatch_());this.batch_.push(c);return this};a.prototype.asyncExecuteBatch_=function(){var c=this;this.asyncExecuteFunction(function(){c.executeBatch_()})};var c=$jscomp.global.setTimeout;a.prototype.asyncExecuteFunction=function(a){c(a,
0)};a.prototype.executeBatch_=function(){for(;this.batch_&&this.batch_.length;){var c=this.batch_;this.batch_=[];for(var a=0;a<c.length;++a){var d=c[a];c[a]=null;try{d()}catch(h){this.asyncThrow_(h)}}}this.batch_=null};a.prototype.asyncThrow_=function(c){this.asyncExecuteFunction(function(){throw c;})};var f=function(c){this.state_=0;this.result_=void 0;this.onSettledCallbacks_=[];var a=this.createResolveAndReject_();try{c(a.resolve,a.reject)}catch(l){a.reject(l)}};f.prototype.createResolveAndReject_=
function(){function c(c){return function(b){d||(d=!0,c.call(a,b))}}var a=this,d=!1;return{resolve:c(this.resolveTo_),reject:c(this.reject_)}};f.prototype.resolveTo_=function(c){if(c===this)this.reject_(new TypeError("A Promise cannot resolve to itself"));else if(c instanceof f)this.settleSameAsPromise_(c);else{a:switch(typeof c){case "object":var a=null!=c;break a;case "function":a=!0;break a;default:a=!1}a?this.resolveToNonPromiseObj_(c):this.fulfill_(c)}};f.prototype.resolveToNonPromiseObj_=function(c){var a=
void 0;try{a=c.then}catch(l){this.reject_(l);return}"function"==typeof a?this.settleSameAsThenable_(a,c):this.fulfill_(c)};f.prototype.reject_=function(c){this.settle_(2,c)};f.prototype.fulfill_=function(c){this.settle_(1,c)};f.prototype.settle_=function(c,a){if(0!=this.state_)throw Error("Cannot settle("+c+", "+a+"): Promise already settled in state"+this.state_);this.state_=c;this.result_=a;this.executeOnSettledCallbacks_()};f.prototype.executeOnSettledCallbacks_=function(){if(null!=this.onSettledCallbacks_){for(var c=
0;c<this.onSettledCallbacks_.length;++c)e.asyncExecute(this.onSettledCallbacks_[c]);this.onSettledCallbacks_=null}};var e=new a;f.prototype.settleSameAsPromise_=function(c){var a=this.createResolveAndReject_();c.callWhenSettled_(a.resolve,a.reject)};f.prototype.settleSameAsThenable_=function(c,a){var d=this.createResolveAndReject_();try{c.call(a,d.resolve,d.reject)}catch(h){d.reject(h)}};f.prototype.then=function(c,a){function d(c,a){return"function"==typeof c?function(a){try{b(c(a))}catch(q){e(q)}}:
a}var b,e,g=new f(function(c,a){b=c;e=a});this.callWhenSettled_(d(c,b),d(a,e));return g};f.prototype.catch=function(c){return this.then(void 0,c)};f.prototype.callWhenSettled_=function(c,a){function d(){switch(b.state_){case 1:c(b.result_);break;case 2:a(b.result_);break;default:throw Error("Unexpected state: "+b.state_);}}var b=this;null==this.onSettledCallbacks_?e.asyncExecute(d):this.onSettledCallbacks_.push(d)};f.resolve=d;f.reject=function(c){return new f(function(a,d){d(c)})};f.race=function(c){return new f(function(a,
b){for(var f=$jscomp.makeIterator(c),e=f.next();!e.done;e=f.next())d(e.value).callWhenSettled_(a,b)})};f.all=function(c){var a=$jscomp.makeIterator(c),b=a.next();return b.done?d([]):new f(function(c,f){function e(a){return function(d){g[a]=d;h--;0==h&&c(g)}}var g=[],h=0;do g.push(void 0),h++,d(b.value).callWhenSettled_(e(g.length-1),f),b=a.next();while(!b.done)})};return f},"es6","es3");
...
$jscomp.polyfill("String.prototype.repeat",function(b){return b?b:function(a){var d=$jscomp.checkStringArgs(this,null,"repeat");if(0>a||1342177279<a)throw new RangeError("Invalid count value");a|=0;for(var c="";a;)if(a&1&&(c+=d),a>>>=1)d+=d;return c}},"es6","es3");
$jscomp.polyfill("String.prototype.startsWith",function(b){return b?b:function(a,d){var c=$jscomp.checkStringArgs(this,a,"startsWith");a+="";var b=c.length,e=a.length;d=Math.max(0,Math.min(d|0,c.length));for(var g=0;g<e&&d<b;)if(c[d++]!=a[g++])return!1;return g>=e}},"es6","es3");
...
var __awaiter=this&&this.__awaiter||function(b,a,d,c){return new (d||(d=Promise))(function(f,e){function g(a){try{l(c.next(a))}catch(m){e(m)}}function k(a){try{l(c["throw"](a))}catch(m){e(m)}}function l(c){c.done?f(c.value):(new d(function(a){a(c.value)})).then(g,k)}l((c=c.apply(b,a||[])).next())})},apps;
(function(b){function a(){return __awaiter(this,void 0,void 0,function f(){return $jscomp.generator.createGenerator(f,function(a){desktop.showToastMessage("Please run from webview2 application!","Web app error","warning");a.jumpToEnd()})})}try{var d=window.chrome.webview.hostObjects.gcmodeller}catch(c){d={getUniprotXmlDatabase:a,scanDatabase:a,openEnrichmentPage:a,sendPost:a}}b.gcmodeller=d;b.run=function(){Router.AddAppHandler(new pages.applets);Router.AddAppHandler(new pages.analysis_project.create_project);
Router.AddAppHandler(new pages.enrichment_database);Router.AddAppHandler(new pages.enrichment_analysis);Router.AddAppHandler(new pages.dataEmbedding);Router.AddAppHandler(new pages.runPLAS);Router.RunApp()}})(apps||(apps={}));$ts.mode=Modes.debug;$ts(apps.run);var desktop;
...
a.$jscomp$loop$prop$metadata$13.note)}}(e);$ts("#"+e.$jscomp$loop$prop$key$7$12+"-meta").onclick=function(c){return function(){$ts("#busy-indicator").show();a.showMetadata(c.$jscomp$loop$prop$key$7$12,c.$jscomp$loop$prop$metadata$13)}}(e);e={$jscomp$loop$prop$key$7$12:e.$jscomp$loop$prop$key$7$12,$jscomp$loop$prop$metadata$13:e.$jscomp$loop$prop$metadata$13}}$ts("#busy-indicator").hide();desktop.showToastMessage("Found "+c+" database.","Enrichment Database Repository","info")};a.showMetadata=function(b,
c){var d="",e=JSON.stringify({guid:b});d+='<span class="badge badge-primary">Database Name</span>: '+c.name+"("+b+")<br />";d+='<span class="badge badge-primary">Note</span>: <p class="note note-light">'+c.note+"</p><br />";apps.gcmodeller.sendPost($ts.url("@web_invoke_inspector"),e).then(function(c){return __awaiter(this,void 0,void 0,function l(){return $jscomp.generator.createGenerator(l,function(b){desktop.promiseAsyncCallback(c,function(c,b){a.displayDatabaseContentSummary(d,c,b)});b.jumpToEnd()})})})};
a.displayDatabaseContentSummary=function(b,c,f){var d=c?"Load Database Success":"Load Database Error",g=f.info,k=null;console.log(g);if(c){var l=$from(Object.keys(g.summary)).Select(function(a){return{name:a,info:g.summary[a]}}).Where(function(a){return 0<a.info.unique_size}).Where(function(a){return 1<a.info.unique_size/a.info.clusters});c=l.Select(function(c){return a.summaryLine(c.name,c.info)}).JoinBy("");desktop.showToastMessage("Success!",d,"success");k=function(){for(var c={},b=$jscomp.makeIterator(l.ToArray()),
d=b.next();!d.done;c={$jscomp$loop$prop$name$15:c.$jscomp$loop$prop$name$15,$jscomp$loop$prop$model$16:c.$jscomp$loop$prop$model$16},d=b.next())c.$jscomp$loop$prop$model$16=d.value,c.$jscomp$loop$prop$name$15=c.$jscomp$loop$prop$model$16.name,d="#model-"+c.$jscomp$loop$prop$name$15,console.log(d),$ts(d).onclick=function(c){return function(){$ts("#busy-indicator").show();console.log("view background model: "+c.$jscomp$loop$prop$name$15+"...");a.viewModel(key,c.$jscomp$loop$prop$name$15,c.$jscomp$loop$prop$model$16.info)}}(c)};
...
c,b){a=JSON.stringify({guid:a,xref:c});apps.gcmodeller.sendPost($ts.url("@web_invoke_loadModel"),a).then(function(a){return __awaiter(this,void 0,void 0,function k(){return $jscomp.generator.createGenerator(k,function(c){desktop.parseMessage(a).then(function(c){desktop.parseResultFlag(a,c).then(function(a){if(a){var b=new bootstrap.Modal($ts("#view-background"),{keyboard:!1}),d=c.info.clusters;a=Object.keys(d);a=$from(a).Select(function(a){return'\n                                    <li>                                   \n                                            <a \n                                            href="#" \n                                            onclick="pages.enrichment_database.showProteins(\''+
d[a].join(",")+'\')">\n                                            <i class="far fa-file-code"></i>&nbsp;&nbsp;'+a.replace(/[<]/ig,"&lt;")+"\n                                            ["+d[a].length+" proteins]\n                                        </a>                                     \n                                    </li>                              \n                                    "});$ts("#contentArea").clear();$ts("#contentArea").display(a.JoinBy(""));$ts("#busy-indicator").hide();
$ts("#modal-close1").onclick=function(){return b.hide()};$ts("#modal-close2").onclick=function(){return b.hide()};b.show()}else desktop.showToastMessage(c.info,"Load Model Error","danger")})});c.jumpToEnd()})})})};a.showProteins=function(a){$ts("#protein_ids").CType().value=a.replace(/,/ig,"\n")};a.summaryLine=function(a,c){return'<li class="list-group-item d-flex justify-content-between align-items-center">\n                        <div class="d-flex align-items-center">\n                            <span class="badge rounded-pill badge-success">                \n                                <i class="fab fa-laravel"></i>&nbsp;'+
a+"              \n                            </span>\n                            "+c.clusters+" / "+c.unique_size+'\n                        </div>\n                        <a id="model-'+a+'" class="btn btn-link btn-rounded btn-sm" href="#" role="button">View</a>\n                    </li>'};a.buildDbCard=function(a,c){return $ts("<div>",{class:["card","shadow-5"],style:"width: 300px;"}).display(' \n                <div class="bg-image hover-overlay ripple hover-zoom" data-mdb-ripple-color="light">\n                    <img src="/assets/images/background.jpg" class="img-fluid hover-shadow"/>\n                    <a href="javascript:void(0);" id="'+
...
$ts("#formFile").CType();apps.gcmodeller.getUniprotXmlDatabase().then(function(c){return __awaiter(this,void 0,void 0,function e(){var b;return $jscomp.generator.createGenerator(e,function(d){if(1==d.nextAddress)return b=a,d.yield(c,2);b.value=d.yieldResult;d.jumpToEnd()})})})};a.prototype.imports_onclick=function(){$ts("#busy-indicator").show();var a={file:$ts.value("#formFile"),name:$ts.value("#title"),note:$ts.value("#description")};a=JSON.stringify(a);apps.gcmodeller.sendPost($ts.url("@web_invoke_imports"),
a).then(function(a){return __awaiter(this,void 0,void 0,function e(){return $jscomp.generator.createGenerator(e,function(c){desktop.promiseAsyncCallback(a,function(a,c){var b=a?"Imports Task Success":"Imports Task Error";a?desktop.showToastMessage(c.info,b,"success"):desktop.showToastMessage(c.info,b,"danger");$ts("#busy-indicator").hide()});c.jumpToEnd()})})})};$jscomp.global.Object.defineProperties(a.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"enrichment_database"}}});
b.enrichment_database=a})(pages||(pages={}));
(function(b){var a=function(a){return b.analysis_session.apply(this,arguments)||this};$jscomp.inherits(a,b.analysis_session);a.prototype.init=function(){};a.prototype.button_open_click=function(){var a=$ts("#matrix-file").CType(),c=$ts("#busy-indicator");c.show();apps.gcmodeller.getFileOpen("Excel Matrix(*.csv)|*.csv").then(function(b){return __awaiter(this,void 0,void 0,function g(){var d;return $jscomp.generator.createGenerator(g,function(f){if(1==f.nextAddress)return d=a,f.yield(b,2);d.value=f.yieldResult;
c.hide();f.jumpToEnd()})})})};a.prototype.run_click=function(){$ts("#busy-indicator").show();var d=$ts.value("#matrix-file"),c=$ts.value("#dimensions"),f=$ts.select.getOption("#algorithm"),e=b.analysis_session.prototype.generateSsid.call(this,{file:d,dims:c,algo:f}),g=$ts("#z-score").CType().checked;c=JSON.stringify({file:d,ssid:e,dims:c,algorithm:f,z_score:g});var k=this;Strings.Empty(d)?desktop.showToastMessage("The matrix data input file can not be nothing!","Data Embedding Analysis","danger"):
apps.gcmodeller.sendPost($ts.url("@web_invoke_embedding"),c).then(function(c){return __awaiter(this,void 0,void 0,function m(){return $jscomp.generator.createGenerator(m,function(b){desktop.promiseAsyncCallback(c,function(c,b){c?(c=$ts.csv(b.info,!0).Objects().Take(10),k.session_id=e,$ts("#embedding-table").clear(),$ts.appendTable(c,"#embedding-table",null,{class:["table","table-sm"]}),a.plot3DScatter(e),desktop.showToastMessage("Run Data Embedding Analysis Success!",f+" Task Success","success")):
desktop.showToastMessage(b.info,f+" Task Error","danger")});b.jumpToEnd()})})})};a.plot3DScatter=function(a){a=JSON.stringify({ssid:a,k:$ts.value("#kmeans")});apps.gcmodeller.sendPost($ts.url("@web_invoke_Rplot"),a).then(function(a){desktop.promiseAsyncCallback(a,function(a,c){a?(a=c.info+"?refresh="+md5(desktop.now()),$ts("#Rplot-box").CType().href=a,$ts("#Rplot_js").CType().src=a,$ts.goto("#example-3-collapsible"),$ts("#busy-indicator").hide()):desktop.showToastMessage(c.info,"Rplot Error","danger")})})};
a.prototype.refresh_Rplot_click=function(){$ts("#busy-indicator").show();Strings.Empty(this.session_id)?desktop.showToastMessage("Data session id can not be nothing!","Rplot Error","danger"):a.plot3DScatter(this.session_id)};a.prototype.save_project_click=function(){desktop.showToastMessage("You should run this analysis from a data analysis project","Report Error","danger")};a.prototype.download_zip_click=function(){var a=$ts.url("@web_invoke_zip"),c=JSON.stringify({ssid:this.session_id});$ts("#busy-indicator").show();
Strings.Empty(this.session_id)?desktop.showToastMessage("Data session id can not be nothing!","Report Error","danger"):apps.gcmodeller.sendPost(a,c).then(function(a){return __awaiter(this,void 0,void 0,function g(){return $jscomp.generator.createGenerator(g,function(c){desktop.promiseAsyncCallback(a,function(a,c){a?window.open(c.info,"newW","\n                                height=500, width=800, top=100, left=100, toolbar=no, \n                                menubar=no,\n                                scrollbars=no,resizable=no, location=no, \n                                status=no"):
desktop.showToastMessage(c.info,"Report Error","danger");$ts("#download-group").show();$ts("#busy-indicator").hide()});c.jumpToEnd()})})})};$jscomp.global.Object.defineProperties(a.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"dataEmbedding"}}});b.dataEmbedding=a})(pages||(pages={}));
...
c).then(function(a){desktop.promiseAsyncCallback(a,function(a,c){var b=a?"Run Enrichment Success":"Analysis Error",d=c.info;console.log(d);a?(a=$ts.csv(d,!0).Objects().Where(function(a){return.05>a.pvalue}).Select(function(a){a.name=g(a);return a}),$ts("#enrichment-result-table").clear(),$ts.appendTable(a,"#enrichment-result-table",null,{class:["table","table-sm"]}),e.session_id=f,e.plot_onclick(),desktop.showToastMessage("Success!",b,"success")):desktop.showToastMessage(c.info,b,"danger")})})};a.prototype.plot_onclick=
function(){$ts("#busy-indicator").show();var a=JSON.stringify({session_id:this.session_id,type:"bar",background:$ts.select.getOption("#background"),top:5});apps.gcmodeller.sendPost($ts.url("@web_invoke_Rplot?base64=true"),a).then(function(a){return __awaiter(this,void 0,void 0,function e(){return $jscomp.generator.createGenerator(e,function(c){desktop.parseMessage(a).then(function(c){desktop.parseResultFlag(a,c).then(function(a){var b=a?"Run Enrichment Success":"Analysis Error",d=c.info;console.log(d);
a?($ts("#Rplot").CType().src=d,$ts("#Rplot-box").CType().href=d,$ts("#busy-indicator").hide()):desktop.showToastMessage(c.info,b,"danger")})});c.jumpToEnd()})})})};$jscomp.global.Object.defineProperties(a.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"enrichment_analysis"}}});a.note_mapping={GO:"go_note",keyword:"uniprot_note",Pfam:"pfam_note",InterPro:"interpro_note",EC:"ec_note",eggNOG:"eggnog_note"};b.enrichment_analysis=a})(pages||(pages={}));
...
0],["x4=beta4*(x3-x4)",10]]),c=a.next();!c.done;c=a.next()){c=c.value;var b=this.add_equation_click();b.eq.value=c[0].toString();b.y0.value=c[1].toString()}a=$jscomp.makeIterator([["beta1","30"],["beta3","30"],["beta4","1"],["lamda1","2"],["lamda3","2"],["alpha1","20"],["alpha2","20"],["alpha3","1"],["a","1"],["n1","4"],["n2","5"],["n3","1"]]);for(c=a.next();!c.done;c=a.next())c=c.value,b=this.add_constant_click(),b.name.value=c[0].toString(),b.val.value=c[1].toString();this.equationIndexing($ts(".eq-index"));
this.equationIndexing($ts(".const-index"));desktop.showToastMessage("Load 'Atkinson.txt' demo example success!","PLAS Script","info")};a.prototype.add_equation_click=function(){var a=$ts("#equations"),c=$ts("<div>",{class:["input-group","mb-3","equation"]}).display('\n                <span class="input-group-text eq-index">1. </span>\n                <input type="text" class="form-control" placeholder="y=f(x) at here"\n                    aria-label="ode">\n                <span class="input-group-text">, y<sub>0</sub>=</span>\n                <input type="text" class="form-control"\n                    placeholder="Initial value of variable y" aria-label="y0">\n                <button class="btn btn-danger del-eq" type="button"> Remove\n                </button>\n            '),
b=this,e=c.getElementsByTagName("input"),g=e.item(0);e=e.item(1);a.appendElement(c);$ts(".del-eq").onClick(function(c){c.removeAttribute("onclick");a.removeChild(c.parentElement);b.equationIndexing($ts(".eq-index"))});b.equationIndexing($ts(".eq-index"));return{eq:g,y0:e}};a.prototype.equationIndexing=function(a){a.ForEach(function(a,b){a.innerText=b+1+". "})};a.prototype.add_constant_click=function(){var a=$ts("#constant-list"),c=$ts("<div>",{class:["input-group","mb-3","const"]}).display('\n                <span class="input-group-text const-index">1. </span>\n                <input type="text" class="form-control" placeholder="put constant symbol name at here"\n                    aria-label="constant">\n                <span class="input-group-text">, constant value=</span>\n                <input type="text" class="form-control"\n                    placeholder="Constant value of current symbol" aria-label="const_val">\n                <button class="btn btn-danger del-const" type="button"> Remove\n                </button>\n            '),
b=this,e=c.getElementsByTagName("input"),g=e.item(0);e=e.item(1);a.appendElement(c);$ts(".del-const").onClick(function(c){c.removeAttribute("onclick");a.removeChild(c.parentElement);b.equationIndexing($ts(".const-index"))});b.equationIndexing($ts(".const-index"));return{name:g,val:e}};a.loadContents=function(a){a=$ts("."+a);var c=[];a.ForEach(function(a){var b=a.getElementsByTagName("input");a=b.item(0);b=b.item(1);a={target:a.value,value:b.value};Strings.Empty(a.target)||c.push(a)});c.length!=a.Count&&
desktop.showToastMessage("Some data is leaves empty, you can removes these empty data slots.","Check PLAS Parameters","warning");return c};a.prototype.run_click=function(){var d=this;$ts("#busy-indicator").show();var c=a.loadContents("equation"),f=a.loadContents("const"),e=$ts.value("#time_final"),g=$ts.value("#resolution");if(0==c.length)desktop.showToastMessage("No ODEs system equations!","Check PLAS Parameters","danger");else{var k=b.analysis_session.prototype.generateSsid.call(this,{sys:c,const:f,
t:e,resolution:g});c=JSON.stringify({odes:JSON.stringify(c),constants:JSON.stringify(f),final_time:e,resolution:g,session_id:k});apps.gcmodeller.sendPost($ts.url("@web_invoke_run_plas"),c).then(function(a){return __awaiter(this,void 0,void 0,function m(){return $jscomp.generator.createGenerator(m,function(c){desktop.promiseAsyncCallback(a,function(a,c){a?(a=$ts.csv(c.info,!0).Objects(),$ts("#plas-table").clear(),$ts.appendTable(a,"#plas-table",null,{class:["table","table-sm"]}),d.session_id=k,d.createPlot(),
desktop.showToastMessage("Run system simulation job done!","Run PLAS","success")):desktop.showToastMessage(c.info,"Run PLAS","danger");$ts("#busy-indicator").hide()});c.jumpToEnd()})})})}};a.prototype.createPlot=function(){var a=JSON.stringify({ssid:this.session_id});apps.gcmodeller.sendPost($ts.url("@web_invoke_Rplot"),a).then(function(a){return __awaiter(this,void 0,void 0,function e(){return $jscomp.generator.createGenerator(e,function(c){desktop.promiseAsyncCallback(a,function(a,c){a?(a=c.info+
"?refresh="+md5(desktop.now()),$ts("#Rplot-box").CType().href=a,$ts("#Rplot_js").CType().src=a,$ts.goto("#example-3"),desktop.showToastMessage("Simulator data rendering job done!","Run PLAS","info")):desktop.showToastMessage(c.info,"Run PLAS","danger")});c.jumpToEnd()})})})};$jscomp.global.Object.defineProperties(a.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"plas"}}});b.runPLAS=a})(pages||(pages={}));
(function(b){(function(a){var b=function(a){return Bootstrap.apply(this,arguments)||this};$jscomp.inherits(b,Bootstrap);b.prototype.init=function(){this.expr1_onclick()};b.prototype.expr1_onclick=function(){$ts("#expr1").addClass("stepper-active");$ts("#sample2").removeClass("stepper-active");$ts("#create3").removeClass("stepper-active");$ts("#panel1").show();$ts("#panel2").hide();$ts("#panel3").hide()};b.prototype.sample2_onclick=function(){$ts("#expr1").removeClass("stepper-active");$ts("#sample2").addClass("stepper-active");
...
void 0,void 0,function k(){var d;return $jscomp.generator.createGenerator(k,function(e){if(1==e.nextAddress)return d=a,e.yield(c,2);d.value=e.yieldResult;b.check_matrix(a.value);e.jumpToEnd()})})})};b.prototype.check_matrix=function(a){};b.prototype.button_open_sampleinfo_click=function(){var a=$ts("#sample-file").CType();apps.gcmodeller.getFileOpen("Excel Table(*.csv)|*.csv").then(function(c){return __awaiter(this,void 0,void 0,function g(){var b;return $jscomp.generator.createGenerator(g,function(d){if(1==
d.nextAddress)return b=a,d.yield(c,2);b.value=d.yieldResult;d.jumpToEnd()})})})};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"create_project"}}});a.create_project=b})(b.analysis_project||(b.analysis_project={}))})(pages||(pages={}));
(function(b){(function(a){var b=function(a){return Bootstrap.apply(this,arguments)||this};$jscomp.inherits(b,Bootstrap);b.prototype.init=function(){app.initSampleEditor()};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"edit_sampleinfo"}}});a.edit_sampleinfo=b})(b.analysis_project||(b.analysis_project={}))})(pages||(pages={}));
