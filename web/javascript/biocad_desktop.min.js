...
(function(a){var b=function(a){this.option={};this.myChart=echarts.init(document.getElementById(void 0===a?"Rplot_js":a));this.option&&this.myChart.setOption(this.option)};b.prototype.plot=function(a,b){this.option={grid3D:{},xAxis3D:{},yAxis3D:{},zAxis3D:{},dataset:{dimensions:["","dim1","dim2","dim3"],source:a},series:[{type:"scatter3D",symbolSize:void 0===b?30:b,encode:{x:"dim1",y:"dim2",z:"dim3",tooltip:[0,1,2,3]}}]};this.myChart.setOption(this.option)};a.scatter3d=b})(js_plot||(js_plot={}));
var pages;(function(a){var b=function(a){return Bootstrap.apply(this,arguments)||this};$jscomp.inherits(b,Bootstrap);b.prototype.generateSsid=function(a){a=JSON.stringify(a);a=desktop.now()+"-"+a+"-"+this.appName;return md5(a)};a.analysis_session=b})(pages||(pages={}));
...
b.plot3DScatter=function(a){var b=Object.keys(a[0]),c=b[0],f=b[1],g=b[2],l=b[3];a=$from(a).Select(function(a){return[a[c],parseFloat(a[f]),parseFloat(a[g]),parseFloat(a[l])]}).ToArray();a=[["","dim1","dim2","dim3"]].concat(a);console.log("view of the data matrix for plot 3d scatter:");console.log(a);(new js_plot.scatter3d("Rplot_js")).plot(a)};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"dataEmbedding"}}});a.dataEmbedding=b})(pages||
(pages={}));
