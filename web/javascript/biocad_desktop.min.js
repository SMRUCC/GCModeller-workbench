...
$jscomp.polyfill("String.prototype.startsWith",function(c){return c?c:function(c,b){var a=$jscomp.checkStringArgs(this,c,"startsWith");c+="";var e=a.length,d=c.length;b=Math.max(0,Math.min(b|0,a.length));for(var f=0;f<d&&b<e;)if(a[b++]!=c[f++])return!1;return f>=d}},"es6","es3");
...
n.value;p=k;return g.yield(b.getHostObject(k.$jscomp$loop$prop$task$21),5);case 5:p.$jscomp$loop$prop$task$21=g.yieldResult;m=k.$jscomp$loop$prop$task$21.session_id.replace(/\./ig,"-");d=b.buildTaskHtml(k.$jscomp$loop$prop$task$21,m);c.appendElement(d);localStorage.setItem(k.$jscomp$loop$prop$task$21.session_id,JSON.stringify(k.$jscomp$loop$prop$task$21.arguments));$ts("#"+m).onclick=function(a){return function(){apps.gcmodeller.openPage(a.$jscomp$loop$prop$task$21.session_id,JSON.stringify(a.$jscomp$loop$prop$task$21))}}(k);
k={$jscomp$loop$prop$task$21:k.$jscomp$loop$prop$task$21};n=l.next();g.jumpTo(2);break;case 4:return g.return(0)}})})};b.getHostObject=function(a){return __awaiter(this,void 0,void 0,function g(){var b,c,d,k,l,n,p,q,r,t;return $jscomp.generator.createGenerator(g,function(g){switch(g.nextAddress){case 1:return c=b={},g.yield(a.appName,2);case 2:return c.appName=g.yieldResult,d=b,g.yield(a.arguments,3);case 3:return d.arguments=g.yieldResult,k=b,g.yield(a.error,4);case 4:return k.error=g.yieldResult,
...
function(a){a=JSON.parse(a||"[]");var c=Object.keys(a).length,d=$ts("#repository"),f={},h;for(h in a){f.$jscomp$loop$prop$key$25=h;f.$jscomp$loop$prop$metadata$26=a[f.$jscomp$loop$prop$key$25];var m=b.buildDbCard(f.$jscomp$loop$prop$key$25,f.$jscomp$loop$prop$metadata$26);d.appendElement(m);console.log(f.$jscomp$loop$prop$key$25);$ts("#"+f.$jscomp$loop$prop$key$25).onclick=function(a){return function(){apps.gcmodeller.openEnrichmentPage(a.$jscomp$loop$prop$key$25,a.$jscomp$loop$prop$metadata$26.name,
a.$jscomp$loop$prop$metadata$26.note)}}(f);$ts("#"+f.$jscomp$loop$prop$key$25+"-meta").onclick=function(a){return function(){desktop.loading();b.showMetadata(a.$jscomp$loop$prop$key$25,a.$jscomp$loop$prop$metadata$26)}}(f);f={$jscomp$loop$prop$key$25:f.$jscomp$loop$prop$key$25,$jscomp$loop$prop$metadata$26:f.$jscomp$loop$prop$metadata$26}}desktop.closeSpinner();desktop.showToastMessage("Found "+c+" database.","Enrichment Database Repository","info")};b.showMetadata=function(a,c){var d="",e=JSON.stringify({guid:a});
...
{$jscomp$loop$prop$name$28:c.$jscomp$loop$prop$name$28,$jscomp$loop$prop$model$29:c.$jscomp$loop$prop$model$29},e=d.next())c.$jscomp$loop$prop$model$29=e.value,c.$jscomp$loop$prop$name$28=c.$jscomp$loop$prop$model$29.name,e="#model-"+c.$jscomp$loop$prop$name$28,console.log(e),$ts(e).onclick=function(c){return function(){desktop.loading();console.log("view background model: "+c.$jscomp$loop$prop$name$28+"...");b.viewModel(a,c.$jscomp$loop$prop$name$28,c.$jscomp$loop$prop$model$29.info)}}(c)};c+='<span class="badge badge-primary">Protein Counts</span>: '+
...
(function(c){(function(c){var b=function(){var a=Bootstrap.apply(this,arguments)||this;a.compartments={};return a};$jscomp.inherits(b,Bootstrap);b.prototype.init=function(){var a=this,b=$ts("#compartment-list");apps.gcmodeller.getMetabolicCompartments().then(function(c){return __awaiter(this,void 0,void 0,function h(){var d,e,g,n,p;return $jscomp.generator.createGenerator(h,function(h){if(1==h.nextAddress)return h.yield(c,2);d=h.yieldResult;e={};g=$jscomp.makeIterator(d);for(n=g.next();!n.done;e=
{$jscomp$loop$prop$id$31:e.$jscomp$loop$prop$id$31},n=g.next())e.$jscomp$loop$prop$id$31=n.value,p=e.$jscomp$loop$prop$id$31.replace(/\s+/ig,"-"),a.compartments[e.$jscomp$loop$prop$id$31]=[],b.appendElement($ts("<li>").display('<a href="#" onclick="javascript:void(0);" id="'+p+'">'+e.$jscomp$loop$prop$id$31+"</a>")),$ts("#"+p).onclick=function(b){return function(){a.showMetabolicNetwork(b.$jscomp$loop$prop$id$31)}}(e);h.jumpToEnd()})})})};b.prototype.showMetabolicNetwork=function(a){var b=this;isNullOrEmpty(this.compartments[a])?
apps.gcmodeller.getMetabolicEnzymes(a).then(function(c){return __awaiter(this,void 0,void 0,function h(){return $jscomp.generator.createGenerator(h,function(d){if(1==d.nextAddress)return d.yield(c,2);c=d.yieldResult;b.compartments[a]=JSON.parse(c);b.showNetworkImpl(b.compartments[a]);d.jumpToEnd()})})}):this.showNetworkImpl(this.compartments[a])};b.prototype.showNetworkImpl=function(a){console.log(a)};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"metabolic_viewer"}}});
c.metabolic_viewer=b})(c.viewers||(c.viewers={}))})(pages||(pages={}));
