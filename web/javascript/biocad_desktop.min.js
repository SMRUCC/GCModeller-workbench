...
a=JSON.stringify({odes:JSON.stringify(a),constants:JSON.stringify(e),final_time:g,resolution:f,session_id:h});apps.gcmodeller.sendPost($ts.url("@web_invoke_run_plas"),a).then(function(a){return __awaiter(this,void 0,void 0,function m(){return $jscomp.generator.createGenerator(m,function(c){desktop.promiseAsyncCallback(a,function(a,c){a?(a=$ts.csv(c.info,!0).Objects(),$ts("#plas-table").clear(),$ts.appendTable(a,"#plas-table",null,{class:["table","table-sm"]}),b.session_id=h,b.createPlot(),desktop.showToastMessage("Run system simulation job done!",
...
(function(c){(function(c){var b=function(a,b,c,d,h,l,k){a=void 0===a?document.createElement("canvas"):a;b=void 0===b?a.getContext("2d"):b;c=void 0===c?{x:null,y:null,max:2E4}:c;d=void 0===d?[0,0]:d;h=void 0===h?[]:h;this.uCanvas=a;this.uContext=b;this.f=c;this.size=d;this.dots=h;this.setting=void 0===l?null:l;this.frameRender=void 0===k?null:k};b.getTag=function(a){return document.getElementsByTagName(a)[0]};b.getById=function(a){return document.getElementById(a)};b.prototype.canvasResize=function(){this.uCanvas.width=
...
function(a){a=JSON.parse(a||"[]");var c=Object.keys(a).length,d=$ts("#repository"),f={},h;for(h in a){f.$jscomp$loop$prop$key$28=h;f.$jscomp$loop$prop$metadata$29=a[f.$jscomp$loop$prop$key$28];var l=b.buildDbCard(f.$jscomp$loop$prop$key$28,f.$jscomp$loop$prop$metadata$29);d.appendElement(l);console.log(f.$jscomp$loop$prop$key$28);$ts("#"+f.$jscomp$loop$prop$key$28).onclick=function(a){return function(){apps.gcmodeller.openEnrichmentPage(a.$jscomp$loop$prop$key$28,a.$jscomp$loop$prop$metadata$29.name,
...
function(a,c,d,f){var e=d?"Load Database Success":"Load Database Error",g=f.info,k=null;console.log(g);if(d){var m=$from(Object.keys(g.summary)).Select(function(a){return{name:a,info:g.summary[a]}}).Where(function(a){return 0<a.info.unique_size}).Where(function(a){return 1<a.info.unique_size/a.info.clusters});d=m.Select(function(a){return b.summaryLine(a.name,a.info)}).JoinBy("");desktop.showToastMessage("Success!",e,"success");k=function(){for(var c={},d=$jscomp.makeIterator(m.ToArray()),e=d.next();!e.done;c=
...
title:a.term,onclick:function(){c(a)}}).display(a.term);return $ts("<div>",{class:b}).display(d)}b.makeSuggestions=function(b,d,e,l,k,m,n){l=void 0===l?10:l;k=void 0===k?!1:k;m=void 0===m?null:m;n=void 0===n?null:n;var f=new c.suggestion(b);return function(b){a(f,b,d,e,l,k,n,m)}}})(c.render||(c.render={}))})(c.suggestion_list||(c.suggestion_list={}))})(pages||(pages={}));
...
function(d){if(1==d.nextAddress)return d.yield(c,2);c=d.yieldResult;b.compartments[a]=JSON.parse(c);b.showNetworkImpl(a,b.compartments[a]);d.jumpToEnd()})})}):this.showNetworkImpl(a,this.compartments[a])};b.prototype.showNetworkImpl=function(a,b){var c=[],d=this;b=$jscomp.makeIterator(b);for(var e=b.next();!e.done;e=b.next()){e=$jscomp.makeIterator(e.value.reactions);for(var l=e.next();!l.done;l=e.next()){l=$jscomp.makeIterator(l.value.enzyme);for(var k=l.next();!k.done;k=l.next())c.push(k.value)}}c=
$from(c).Where(function(a){return!Strings.Empty(a,!0)}).GroupBy(function(a){return a.split(".")[0]}).Where(function(a){return"EC"+a.Key in d.category_index}).Select(function(a){return{name:d.category_index["EC"+a.Key],value:a.Count}}).ToArray();console.table(c);(new js_plot.piePlot("Metabolic Composition","Subcellular Location: "+a,"enzyme-class")).plot("Reaction Counts",c)};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"metabolic_viewer"}}});
