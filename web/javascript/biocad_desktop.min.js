...
(function(c){(function(c){var b=function(){var a=Bootstrap.apply(this,arguments)||this;a.port=$ts.location("service");a.pins=[];a.vectors=new Dictionary;return a};$jscomp.inherits(b,Bootstrap);b.prototype.init=function(){var a=$ts.url("@counts");$ts.get("http://localhost:"+this.port+a,function(a){for(var b=$ts("#module_list"),c=$jscomp.makeIterator(Object.keys(a.info)),d=c.next();!d.done;d=c.next())d=d.value,b.appendElement($ts("<option>",{value:d}).display(d+" ["+a.info[d]+" molecules]"))})};b.prototype.module_list_onchange=
...
d=this.vectors.Select(function(a){return{name:a.key,data:a.value}}).ToArray();this.get_vector(a[0],function(a,e){(new js_plot.lineplot("Expression of "+b,"From module "+c,"container")).plot(b,e,d)})};b.prototype.get_vector=function(a,b){a=$ts.url("@vector/?m="+this.cur_modu+"&id="+a);$ts.get("http://localhost:"+this.port+a,function(a){a=a.info;var c=a.vec,d=Array(a.size).fill().map(function(a,b){return[b,c[b]]});b(a.size,d)})};b.prototype.pin_onclick=function(){var a=$ts.select.getOption("#molecules_list"),
b=this;this.pins.push(a);this.get_vector(a,function(c,d){b.vectors.Add(a,d)})};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"vcell_viewer"}}});c.vcell_viewer=b})(c.viewers||(c.viewers={}))})(pages||(pages={}));
