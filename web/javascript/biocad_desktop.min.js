...
0;a<this.onSettledCallbacks_.length;++a)f.asyncExecute(this.onSettledCallbacks_[a]);this.onSettledCallbacks_=null}};var f=new d;e.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};e.prototype.settleSameAsThenable_=function(a,b){var e=this.createResolveAndReject_();try{a.call(b,e.resolve,e.reject)}catch(k){e.reject(k)}};e.prototype.then=function(a,b){function c(a,b){return"function"==typeof a?function(b){try{f(a(b))}catch(t){d(t)}}:
...
var __awaiter=this&&this.__awaiter||function(c,d,b,a){return new (b||(b=Promise))(function(e,f){function g(b){try{n(a.next(b))}catch(l){f(l)}}function h(b){try{n(a["throw"](b))}catch(l){f(l)}}function n(a){a.done?e(a.value):(new b(function(b){b(a.value)})).then(g,h)}n((a=a.apply(c,d||[])).next())})},apps;
...
a.yieldResult;if($ts.csv.isTsvFile(e))f={code:0,info:e};else if(e.startsWith("data:"))f={code:0,info:e};else try{f=JSON.parse(e)}catch(h){f={code:500,info:e}}return a.return(f)})})};c.processHtmlMsg=function(d){"string"==typeof d?(d=d.replace(/[<]/ig,"&lt;"),d=Strings.lineTokens(d).join("<br />")):d=c.RSharp.isRSharpError(d)?c.RSharp.RSharpErrorMessage(d):"Unhandle error!";return d}})(desktop||(desktop={}));
(function(c){function d(a,e,f,d,h){e=void 0===e?"Task Error":e;f=void 0===f?"":f;d=void 0===d?"danger":d;return $ts("<div>",{class:["toast","show","fade","toast-"+d],role:"alert","aria-live":"assertive","aria-atomic":"true","data-mdb-color":d,"data-mdb-autohide":(void 0===h?!0:h).toString(),style:"width: 500px;"}).display('        \n            <div class="toast-header toast-'+d+'">\n                <i class="'+b[d]+'"></i>\n                <strong class="me-auto">'+e+"</strong>\n                <small>"+
...
(function(c){(function(d){d.openfileDialog=function(b,a){a=void 0===a?"any file(*.*)|*.*":a;c.loading();apps.gcmodeller.getFileOpen(a).then(function(a){return __awaiter(this,void 0,void 0,function g(){var e,d;return $jscomp.generator.createGenerator(g,function(h){if(1==h.nextAddress)return h.yield(a,2);e=h.yieldResult;d=$ts(b);d.value=e;c.closeSpinner();h.jumpToEnd()})})})}})(c.winforms||(c.winforms={}))})(desktop||(desktop={}));
...
$jscomp.makeIterator(d(this.appList[a],a)),f=e.next();!f.done;f=e.next())this.terms.push(f.value);this.suggestions=new c.suggestion_list.suggestion(this.terms);this.hookSearchBar()};b.prototype.hookSearchBar=function(){var a=$ts("#applets"),e=this,c=$ts("#form1");c.onchange=function(){if(c.value&&""!=c.value){var d=c.value;a.clear();d=$jscomp.makeIterator(e.suggestions.populateSuggestion(d,6,!1));for(var f=d.next();!f.done;f=d.next())f=b.buildElement(e.appList[f.value.id]),a.appendChild(f)}else b.showAppList(e.appList)}};
...
function(){var b=$ts("#repository_folder"),a=this;desktop.loading("Load configurations...");apps.gcmodeller.getFolderOpen().then(function(c){return __awaiter(this,void 0,void 0,function g(){var e;return $jscomp.generator.createGenerator(g,function(d){if(1==d.nextAddress)return e=b,d.yield(c,2);e.value=d.yieldResult;desktop.closeSpinner();Strings.Empty(b.value,!0)||a.SaveSettings();d.jumpToEnd()})})})};$jscomp.global.Object.defineProperties(d.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"settings"}}});
c.settings=d})(pages||(pages={}));
(function(c){var d={success:"badge-success",error:"badge-danger",pending:"badge-warning",cancel:"badge-default",running:"badge-success"},b=function(a){return Bootstrap.apply(this,arguments)||this};$jscomp.inherits(b,Bootstrap);b.prototype.init=function(){var a=this;apps.gcmodeller.getTaskList().then(function(b){return __awaiter(this,void 0,void 0,function g(){var c;return $jscomp.generator.createGenerator(g,function(e){if(1==e.nextAddress)return e.yield(b,2);c=e.yieldResult;a.showTaskDatalist(c,function(){desktop.showToastMessage("Load "+
c.length+" web task!","Task Manager","info");setInterval(function(){return a.checkList()},6E3)});e.jumpToEnd()})})})};b.prototype.checkList=function(){var a=this;apps.gcmodeller.checkTaskList().then(function(b){return __awaiter(this,void 0,void 0,function g(){var c,e,d,l,m,p;return $jscomp.generator.createGenerator(g,function(g){if(1==g.nextAddress)return g.yield(b,2);c=g.yieldResult;if(e=0<c.length)for(apps.gcmodeller.getTaskList().then(function(b){return __awaiter(this,void 0,void 0,function u(){var c;
...
b.prototype.showTaskDatalist=function(a,b){b=void 0===b?null:b;a=$from(a).Select(function(a){return JSON.parse(a)}).ToArray();this.loadTaskList(a).then(function(a){isNullOrUndefined(b)||b()})};b.prototype.loadTaskList=function(a){return __awaiter(this,void 0,void 0,function f(){var c,d,n,k,l,m,p;return $jscomp.generator.createGenerator(f,function(f){switch(f.nextAddress){case 1:c=$ts("#task_manager").clear(),n=null,k={},l=$jscomp.makeIterator(a),m=l.next();case 2:if(m.done){f.jumpTo(4);break}k.$jscomp$loop$prop$task$27=
m.value;p=k;return f.yield(b.getHostObject(k.$jscomp$loop$prop$task$27),5);case 5:p.$jscomp$loop$prop$task$27=f.yieldResult;n=k.$jscomp$loop$prop$task$27.session_id.replace(/\./ig,"-");d=b.buildTaskHtml(k.$jscomp$loop$prop$task$27,n);c.appendElement(d);localStorage.setItem(k.$jscomp$loop$prop$task$27.session_id,JSON.stringify(k.$jscomp$loop$prop$task$27.arguments));$ts("#"+n).onclick=function(a){return function(){apps.gcmodeller.openPage(a.$jscomp$loop$prop$task$27.session_id,JSON.stringify(a.$jscomp$loop$prop$task$27))}}(k);
k={$jscomp$loop$prop$task$27:k.$jscomp$loop$prop$task$27};m=l.next();f.jumpTo(2);break;case 4:return f.return(0)}})})};b.getHostObject=function(a){return __awaiter(this,void 0,void 0,function f(){var b,c,d,k,l,m,p,q,r,t;return $jscomp.generator.createGenerator(f,function(f){switch(f.nextAddress){case 1:return c=b={},f.yield(a.appName,2);case 2:return c.appName=f.yieldResult,d=b,f.yield(a.arguments,3);case 3:return d.arguments=f.yieldResult,k=b,f.yield(a.error,4);case 4:return k.error=f.yieldResult,
...
file:h,ssid:""};n.ssid=c.analysis_session.prototype.generateSsid.call(this,n);apps.gcmodeller.sendPost($ts.url("@web_invoke_clustering"),JSON.stringify(n)).then(function(a){return __awaiter(this,void 0,void 0,function m(){return $jscomp.generator.createGenerator(m,function(c){desktop.promiseAsyncCallback(a,function(a,c){a?(b.session_id=n.ssid,b.refresh_Rplot_onclick(),a=$ts.csv(c.info,!0).Objects().Take(10),$ts("#patterns-table").clear(),$ts.appendTable(a,"#patterns-table",null,{class:["table","table-sm"]})):
...
a).then(function(a){return __awaiter(this,void 0,void 0,function l(){return $jscomp.generator.createGenerator(l,function(b){desktop.promiseAsyncCallback(a,function(a,b){a?(a=$ts.csv(b.info,!0).Objects().Take(10),h.session_id=f,$ts("#embedding-table").clear(),$ts.appendTable(a,"#embedding-table",null,{class:["table","table-sm"]}),d.plot3DScatter(f),desktop.showToastMessage("Run Data Embedding Analysis Success!",e+" Task Success","success")):desktop.showToastMessage(b.info,e+" Task Error","danger")});
...
a=JSON.stringify({odes:JSON.stringify(a),constants:JSON.stringify(e),final_time:f,resolution:g,session_id:h});apps.gcmodeller.sendPost($ts.url("@web_invoke_run_plas"),a).then(function(a){return __awaiter(this,void 0,void 0,function l(){return $jscomp.generator.createGenerator(l,function(c){desktop.promiseAsyncCallback(a,function(a,c){a?(a=$ts.csv(c.info,!0).Objects(),$ts("#plas-table").clear(),$ts.appendTable(a,"#plas-table",null,{class:["table","table-sm"]}),b.session_id=h,b.createPlot(),desktop.showToastMessage("Run system simulation job done!",
...
void 0,void 0,function h(){var e;return $jscomp.generator.createGenerator(h,function(d){if(1==d.nextAddress)return e=a,d.yield(c,2);e.value=d.yieldResult;b.check_matrix(a.value);d.jumpToEnd()})})})};b.prototype.check_matrix=function(a){};b.prototype.button_open_sampleinfo_click=function(){var a=$ts("#sample-file").CType();apps.gcmodeller.getFileOpen("Excel Table(*.csv)|*.csv").then(function(b){return __awaiter(this,void 0,void 0,function g(){var c;return $jscomp.generator.createGenerator(g,function(e){if(1==
...
for(g=a.next();!g.done;g=a.next()){var h=g.value;this.sampleInfo[h.ID]=h;g=c[d++];"0"!=h.delete&&b.deleteSampleRow(g.tr,g)}return this.editor.table};b.deleteSampleRow=function(a,b){a.cells.item(0);b.dropFlag?(a.style.backgroundColor="white",b.getElementById("remove").innerHTML="\u5220\u9664\u6837\u672c"):(a.style.backgroundColor="gray",b.getElementById("remove").innerHTML="\u6062\u590d\u6837\u672c");b.dropFlag=!b.dropFlag};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,
enumerable:!0,get:function(){return"edit_sampleinfo"}}});c.edit_sampleinfo=b})(c.analysis_project||(c.analysis_project={}))})(pages||(pages={}));
(function(c){(function(c){var b=function(a,b,c,d,h,n,k){a=void 0===a?document.createElement("canvas"):a;b=void 0===b?a.getContext("2d"):b;c=void 0===c?{x:null,y:null,max:2E4}:c;d=void 0===d?[0,0]:d;h=void 0===h?[]:h;this.uCanvas=a;this.uContext=b;this.f=c;this.size=d;this.dots=h;this.setting=void 0===n?null:n;this.frameRender=void 0===k?null:k};b.getTag=function(a){return document.getElementsByTagName(a)[0]};b.getById=function(a){return document.getElementById(a)};b.prototype.canvasResize=function(){this.uCanvas.width=
window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth;this.uCanvas.height=window.innerHeight||document.documentElement.clientHeight||document.body.clientHeight;this.size=[this.uCanvas.width,this.uCanvas.height]};b.prototype.update=function(){var a=this,c=[a.f].concat(a.dots),d,g,h;a.uContext.clearRect(0,0,a.size[0],a.size[1]);var n=$jscomp.makeIterator(a.dots);for(d=n.next();!d.done;d=n.next()){var k=d.value;k.x+=k.xa;k.y+=k.ya;k.xa*=k.x>a.size[0]||0>k.x?-1:1;k.ya*=k.y>
a.size[1]||0>k.y?-1:1;a.uContext.fillRect(k.x-.5,k.y-.5,1,1);for(g=0;g<c.length;g++)if(d=c[g],k!==d&&null!==d.x&&null!==d.y){var l=k.x-d.x;var m=k.y-d.y;var p=l*l+m*m;p<d.max&&(d===a.f&&p>=d.max/2&&(k.x-=.03*l,k.y-=.03*m),h=(d.max-p)/d.max,a.uContext.beginPath(),a.uContext.lineWidth=h/2,a.uContext.strokeStyle="rgba("+a.setting.color+", "+(h+.2)+")",a.uContext.moveTo(k.x,k.y),a.uContext.lineTo(d.x,d.y),a.uContext.stroke())}c.splice(c.indexOf(k),1)}b.defaultCallback(function(){return a.update()})};
...
function(a){a=JSON.parse(a||"[]");var c=Object.keys(a).length,d=$ts("#repository"),g={},h;for(h in a){g.$jscomp$loop$prop$key$31=h;g.$jscomp$loop$prop$metadata$32=a[g.$jscomp$loop$prop$key$31];var n=b.buildDbCard(g.$jscomp$loop$prop$key$31,g.$jscomp$loop$prop$metadata$32);d.appendElement(n);console.log(g.$jscomp$loop$prop$key$31);$ts("#"+g.$jscomp$loop$prop$key$31).onclick=function(a){return function(){apps.gcmodeller.openEnrichmentPage(a.$jscomp$loop$prop$key$31,a.$jscomp$loop$prop$metadata$32.name,
a.$jscomp$loop$prop$metadata$32.note)}}(g);$ts("#"+g.$jscomp$loop$prop$key$31+"-meta").onclick=function(a){return function(){desktop.loading();b.showMetadata(a.$jscomp$loop$prop$key$31,a.$jscomp$loop$prop$metadata$32)}}(g);g={$jscomp$loop$prop$key$31:g.$jscomp$loop$prop$key$31,$jscomp$loop$prop$metadata$32:g.$jscomp$loop$prop$metadata$32}}desktop.closeSpinner();desktop.showToastMessage("Found "+c+" database.","Enrichment Database Repository","info")};b.showMetadata=function(a,c){var d="",e=JSON.stringify({guid:a});
...
function(a,c,d,g){var e=d?"Load Database Success":"Load Database Error",f=g.info,k=null;console.log(f);if(d){var l=$from(Object.keys(f.summary)).Select(function(a){return{name:a,info:f.summary[a]}}).Where(function(a){return 0<a.info.unique_size}).Where(function(a){return 1<a.info.unique_size/a.info.clusters});d=l.Select(function(a){return b.summaryLine(a.name,a.info)}).JoinBy("");desktop.showToastMessage("Success!",e,"success");k=function(){for(var c={},d=$jscomp.makeIterator(l.ToArray()),e=d.next();!e.done;c=
{$jscomp$loop$prop$name$34:c.$jscomp$loop$prop$name$34,$jscomp$loop$prop$model$35:c.$jscomp$loop$prop$model$35},e=d.next())c.$jscomp$loop$prop$model$35=e.value,c.$jscomp$loop$prop$name$34=c.$jscomp$loop$prop$model$35.name,e="#model-"+c.$jscomp$loop$prop$name$34,console.log(e),$ts(e).onclick=function(c){return function(){desktop.loading();console.log("view background model: "+c.$jscomp$loop$prop$name$34+"...");b.viewModel(a,c.$jscomp$loop$prop$name$34,c.$jscomp$loop$prop$model$35.info)}}(c)};c+='<span class="badge badge-primary">Protein Counts</span>: '+
f.counts+"<br />";c+='<span class="badge badge-primary">Models</span>: '+l.Count+"<br />";c+='<span class="badge badge-primary">Backgrounds</span>: <br /><br />\n                        <ul class="list-group list-group-light">\n                            '+d+"\n                        </ul>\n                    "}else desktop.showToastMessage(g.info,e,"danger");$ts("#summary-info").display(c);isNullOrUndefined(k)||k()};b.viewModel=function(a,b,c){$ts.post("@web_invoke_loadModel",{guid:a,xref:b},
...
c[d],a.category_index["EC"+c[d]]=d;console.log(a.enzyme_class);e.jumpToEnd()})})});apps.gcmodeller.getMetabolicCompartments().then(function(c){return __awaiter(this,void 0,void 0,function h(){var d,e,f,m;return $jscomp.generator.createGenerator(h,function(h){if(1==h.nextAddress)return h.yield(c,2);d=h.yieldResult;e=$jscomp.makeIterator(d);for(f=e.next();!f.done;f=e.next())m=f.value,a.compartments[m]=[],b.appendElement($ts("<option>",{value:m}).display(m));h.jumpToEnd()})})})};b.prototype.compartment_list_onchange=
...
d.jumpToEnd()})})}):(this.showNetworkImpl(a,this.compartments[a]),this.showGraph(a,this.compartments[a]))};b.prototype.showNetworkImpl=function(a,b){var c=[],d=this,e=[],n=$ts("#reaction-graph-data").clear();b=$jscomp.makeIterator(b);for(var k=b.next();!k.done;k=b.next()){k=$jscomp.makeIterator(k.value.reactions);for(var l=k.next();!l.done;l=k.next()){l=l.value;for(var m=$jscomp.makeIterator(l.enzyme),p=m.next();!p.done;p=m.next())c.push(p.value);e.push(l)}}c=$from(c).Where(function(a){return!Strings.Empty(a,
...
"&lt;"));a=$ts("<li>").display(a);n.appendElement(a)})};b.prototype.showGraph=function(a,b){var c={},d=[];b=$jscomp.makeIterator(b);for(var e=b.next();!e.done;e=b.next()){e=e.value;c[e.protein_id]={id:e.protein_id,name:e.protein_id,symbolSize:e.reactions.length+1};for(var n=$jscomp.makeIterator(e.reactions),k=n.next();!k.done;k=n.next()){k=k.value;k.entry in c||(c[k.entry]={id:k.entry,name:k.definition,symbolSize:3});d.push({source:e.protein_id,target:k.entry});var l=k.euqation;l=[].concat($jscomp.arrayFromIterable(l.Reactants)).concat(l.Products);
l=$jscomp.makeIterator(l);for(var m=l.next();!m.done;m=l.next())m=m.value,m.ID in c||(c[m.ID]={id:m.ID,name:m.ID,symbolSize:3}),d.push({source:k.entry,target:m.ID})}}(new js_plot.graph_plot("container")).plot("Metabolic_graph@"+a,{nodes:$from(Object.keys(c)).Select(function(a){return c[a]}).ToArray(),links:d,categories:[]})};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"metabolic_viewer"}}});c.metabolic_viewer=b})(c.viewers||(c.viewers=
{}))})(pages||(pages={}));(function(c){(function(c){var b=function(a){return Bootstrap.apply(this,arguments)||this};$jscomp.inherits(b,Bootstrap);b.prototype.init=function(){var a=LoadText("pwm");a=new viewer.Pspm(a,null);this.motifLogo=new viewer.MotifLogo;this.motifLogo.drawLogo("preview_1",a,2)};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"motif_viewer"}}});c.motif_viewer=b})(c.viewers||(c.viewers={}))})(pages||(pages={}));
