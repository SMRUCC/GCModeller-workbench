...
(function(a){a.now=function(){return(new Date).toLocaleTimeString()};a.parseResultFlag=function(a,c){return __awaiter(this,void 0,void 0,function e(){var b,g;return $jscomp.generator.createGenerator(e,function(e){if(1==e.nextAddress)return e.yield(a.result,2);g=(b=e.yieldResult)&&0==c.code;return e.return(g)})})};a.parseMessage=function(a){return __awaiter(this,void 0,void 0,function d(){var b,f;return $jscomp.generator.createGenerator(d,function(d){if(1==d.nextAddress)return d.yield(a.data,2);b=
d.yieldResult;if($ts.csv.isTsvFile(b))f={code:0,info:b};else if(b.startsWith("data:"))f={code:0,info:b};else try{f=JSON.parse(b)}catch(l){f={code:500,info:b}}return d.return(f)})})};a.processHtmlMsg=function(b){"string"==typeof b?(b=b.replace(/[<]/ig,"&lt;"),b=Strings.lineTokens(b).join("<br />")):b=a.RSharp.isRSharpError(b)?a.RSharp.RSharpErrorMessage(b):"Unhandle error!";return b}})(desktop||(desktop={}));
...
(f&&"null"!=f.toLowerCase()?f:"")+'</small>\n                <button type="button" class="btn-close" data-mdb-dismiss="toast" aria-label="Close">\n                </button>\n            </div>\n            <div class="toast-body">'+a.processHtmlMsg(b)+"</div>\n        ")}a.showToastMessage=function(c,e,f,g,l){e=void 0===e?"Task Error":e;f=void 0===f?a.now():f;g=void 0===g?"info":g;l=void 0===l?!0:l;$ts("#busy-indicator").hide();$ts("#toast-message").appendElement(b(c,e,f,g,l))};var c={success:"fas fa-check fa-lg me-2",
...
(function(a){var b=function(b){return a.analysis_session.apply(this,arguments)||this};$jscomp.inherits(b,a.analysis_session);b.prototype.init=function(){};b.prototype.button_open_click=function(){$ts("#busy-indicator").show();apps.gcmodeller.getFileOpen("Excel Matrix(*.csv)|*.csv").then(function(a){return __awaiter(this,void 0,void 0,function e(){var b;return $jscomp.generator.createGenerator(e,function(c){if(1==c.nextAddress)return c.yield(a,2);b=c.yieldResult;Strings.Empty(b)||($ts("#matrix-file").CType().value=
b);$ts("#busy-indicator").hide();c.jumpToEnd()})})})};b.prototype.run_click=function(){$ts("#busy-indicator").show();var b=$ts.value("#matrix-file"),d=$ts.value("#dimensions"),e=$ts.select.getOption("#algorithm"),f=a.analysis_session.prototype.generateSsid.call(this,{file:b,dims:d,algo:e});d=JSON.stringify({file:b,ssid:f,dims:d,algorithm:e});Strings.Empty(b)?desktop.showToastMessage("The matrix data input file can not be nothing!","Data Embedding Analysis",null,"danger"):apps.gcmodeller.sendPost($ts.url("@web_invoke_embedding"),
d).then(function(a){return __awaiter(this,void 0,void 0,function k(){return $jscomp.generator.createGenerator(k,function(a){a.jumpToEnd()})})})};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"dataEmbedding"}}});a.dataEmbedding=b})(pages||(pages={}));
