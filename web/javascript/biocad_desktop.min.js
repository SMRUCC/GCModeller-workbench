...
(function(c){(function(d){d.openfileDialog=function(b,a){a=void 0===a?"any file(*.*)|*.*":a;c.loading();apps.gcmodeller.getFileOpen(a).then(function(a){return __awaiter(this,void 0,void 0,function g(){var e,d;return $jscomp.generator.createGenerator(g,function(k){if(1==k.nextAddress)return k.yield(a,2);e=k.yieldResult;d=$ts(b);d.value=e;c.closeSpinner();k.jumpToEnd()})})})}})(c.winforms||(c.winforms={}))})(desktop||(desktop={}));
...
this.option={title:{text:this.title,subtext:this.subtitle,left:"center"},tooltip:{trigger:"item"},xAxis:{type:"value"},yAxis:{type:"value"},series:b,legend:{orient:"vertical",right:10,top:"center"}};this.show()};c.lineplot=d})(js_plot||(js_plot={}));
...
function(a){a=JSON.parse(a||"[]");var c=Object.keys(a).length,d=$ts("#repository"),g={},k;for(k in a){g.$jscomp$loop$prop$key$36=k;g.$jscomp$loop$prop$metadata$37=a[g.$jscomp$loop$prop$key$36];var n=b.buildDbCard(g.$jscomp$loop$prop$key$36,g.$jscomp$loop$prop$metadata$37);d.appendElement(n);console.log(g.$jscomp$loop$prop$key$36);$ts("#"+g.$jscomp$loop$prop$key$36).onclick=function(a){return function(){apps.gcmodeller.openEnrichmentPage(a.$jscomp$loop$prop$key$36,a.$jscomp$loop$prop$metadata$37.name,
a.$jscomp$loop$prop$metadata$37.note)}}(g);$ts("#"+g.$jscomp$loop$prop$key$36+"-meta").onclick=function(a){return function(){desktop.loading();b.showMetadata(a.$jscomp$loop$prop$key$36,a.$jscomp$loop$prop$metadata$37)}}(g);g={$jscomp$loop$prop$key$36:g.$jscomp$loop$prop$key$36,$jscomp$loop$prop$metadata$37:g.$jscomp$loop$prop$metadata$37}}desktop.closeSpinner();desktop.showToastMessage("Found "+c+" database.","Enrichment Database Repository","info")};b.showMetadata=function(a,c){var d="",e=JSON.stringify({guid:a});
...
{$jscomp$loop$prop$name$39:c.$jscomp$loop$prop$name$39,$jscomp$loop$prop$model$40:c.$jscomp$loop$prop$model$40},e=d.next())c.$jscomp$loop$prop$model$40=e.value,c.$jscomp$loop$prop$name$39=c.$jscomp$loop$prop$model$40.name,e="#model-"+c.$jscomp$loop$prop$name$39,console.log(e),$ts(e).onclick=function(c){return function(){desktop.loading();console.log("view background model: "+c.$jscomp$loop$prop$name$39+"...");b.viewModel(a,c.$jscomp$loop$prop$name$39,c.$jscomp$loop$prop$model$40.info)}}(c)};c+='<span class="badge badge-primary">Protein Counts</span>: '+
...
function(a){var b=a[0],c=this.cur_modu,d=this.vectors.Select(function(a){return{name:a.key,data:a.value}}).ToArray();this.get_vector(a[0],function(a,e){(new js_plot.lineplot("Expression of "+b,"From module "+c,"container")).plot(b,e,d)});a=$ts.url("@reactions/?id="+b);$ts.get("http://localhost:"+this.port+a,function(a){var b=a.info;a=$ts("#reaction_list");Array.isArray(b)||(b=[b]);console.log("get related reaction id set:");console.log(b);b=$jscomp.makeIterator(b);for(var c=b.next();!c.done;c=b.next())c=
c.value,a.appendElement($ts("<option>",{value:c}).display(c))})};b.prototype.reaction_list_onchange=function(a){var b=a[0],c=[];this.get_vector(a[0],function(a,d){(new js_plot.lineplot("Expression of "+b,"From module reactions","reaction-container")).plot(b,d,c)},"Reactions")};b.prototype.get_vector=function(a,b,c){a=$ts.url("@vector/?m="+((void 0===c?null:c)||this.cur_modu)+"&id="+a);$ts.get("http://localhost:"+this.port+a,function(a){a=a.info;var c=a.vec,d=Array(a.size).fill().map(function(a,b){return[b,
c[b]]});b(a.size,d)})};b.prototype.pin_onclick=function(){var a=$ts.select.getOption("#molecules_list"),b=this;this.pins.push(a);this.get_vector(a,function(c,d){b.vectors.Add(a,d)})};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"vcell_viewer"}}});c.vcell_viewer=b})(c.viewers||(c.viewers={}))})(pages||(pages={}));
