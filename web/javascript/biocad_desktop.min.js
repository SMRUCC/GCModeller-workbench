...
(f&&"null"!=f.toLowerCase()?f:"")+'</small>\n                <button type="button" class="btn-close" data-mdb-dismiss="toast" aria-label="Close">\n                </button>\n            </div>\n            <div class="toast-body">'+a.processHtmlMsg(b)+"</div>\n        ")}a.showToastMessage=function(c,e,f,g,k){e=void 0===e?"Task Error":e;f=void 0===f?a.now():f;g=void 0===g?"info":g;k=void 0===k?!0:k;$ts("#busy-indicator").hide();$ts("#toast-message").appendElement(b(c,e,f,g,k))};var c={success:"fas fa-check fa-lg me-2",
...
(function(a){var b=function(b){return a.analysis_session.apply(this,arguments)||this};$jscomp.inherits(b,a.analysis_session);b.prototype.init=function(){};b.prototype.button_open_click=function(){var a=$ts("#matrix-file").CType();$ts("#busy-indicator").show();apps.gcmodeller.getFileOpen("Excel Matrix(*.csv)|*.csv").then(function(b){return __awaiter(this,void 0,void 0,function f(){var c;return $jscomp.generator.createGenerator(f,function(d){if(1==d.nextAddress)return c=a,d.yield(b,2);c.value=d.yieldResult;
$ts("#busy-indicator").hide();d.jumpToEnd()})})})};b.prototype.run_click=function(){$ts("#busy-indicator").show();var b=$ts.value("#matrix-file"),d=$ts.value("#dimensions"),e=$ts.select.getOption("#algorithm"),f=a.analysis_session.prototype.generateSsid.call(this,{file:b,dims:d,algo:e});d=JSON.stringify({file:b,ssid:f,dims:d,algorithm:e});Strings.Empty(b)?desktop.showToastMessage("The matrix data input file can not be nothing!","Data Embedding Analysis",null,"danger"):apps.gcmodeller.sendPost($ts.url("@web_invoke_embedding"),
d).then(function(a){return __awaiter(this,void 0,void 0,function l(){return $jscomp.generator.createGenerator(l,function(a){a.jumpToEnd()})})})};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"dataEmbedding"}}});a.dataEmbedding=b})(pages||(pages={}));
