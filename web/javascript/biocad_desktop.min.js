...
(function(c){(function(c){var b=function(){var a=Bootstrap.apply(this,arguments)||this;a.compartments={};a.enzyme_class={};return a};$jscomp.inherits(b,Bootstrap);b.prototype.init=function(){var a=this,b=$ts("#compartment-list");apps.gcmodeller.getEnzymeClass().then(function(b){return __awaiter(this,void 0,void 0,function h(){var c,d;return $jscomp.generator.createGenerator(h,function(e){if(1==e.nextAddress)return e.yield(b,2);b=e.yieldResult;c=JSON.parse(b);for(d in c)a.enzyme_class[d]=c[d];console.log(a.enzyme_class);
e.jumpToEnd()})})});apps.gcmodeller.getMetabolicCompartments().then(function(c){return __awaiter(this,void 0,void 0,function h(){var d,e,g,n,p;return $jscomp.generator.createGenerator(h,function(h){if(1==h.nextAddress)return h.yield(c,2);d=h.yieldResult;e={};g=$jscomp.makeIterator(d);for(n=g.next();!n.done;e={$jscomp$loop$prop$id$34:e.$jscomp$loop$prop$id$34},n=g.next())e.$jscomp$loop$prop$id$34=n.value,p=e.$jscomp$loop$prop$id$34.replace(/\s+/ig,"-"),a.compartments[e.$jscomp$loop$prop$id$34]=[],
b.appendElement($ts("<li>").display('<a href="#" onclick="javascript:void(0);" id="'+p+'">'+e.$jscomp$loop$prop$id$34+"</a>")),$ts("#"+p).onclick=function(b){return function(){a.showMetabolicNetwork(b.$jscomp$loop$prop$id$34)}}(e);h.jumpToEnd()})})})};b.prototype.showMetabolicNetwork=function(a){var b=this;isNullOrEmpty(this.compartments[a])?apps.gcmodeller.getMetabolicEnzymes(a).then(function(c){return __awaiter(this,void 0,void 0,function h(){return $jscomp.generator.createGenerator(h,function(d){if(1==
d.nextAddress)return d.yield(c,2);c=d.yieldResult;b.compartments[a]=JSON.parse(c);b.showNetworkImpl(b.compartments[a]);d.jumpToEnd()})})}):this.showNetworkImpl(this.compartments[a])};b.prototype.showNetworkImpl=function(a){var b=[];a=$jscomp.makeIterator(a);for(var c=a.next();!c.done;c=a.next()){c=$jscomp.makeIterator(c.value.reactions);for(var d=c.next();!d.done;d=c.next()){d=$jscomp.makeIterator(d.value.enzyme);for(var h=d.next();!h.done;h=d.next())b.push(h.value)}}$from(b).GroupBy(function(a){return a.split(".")[0]}).Select(function(a){})};
$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"metabolic_viewer"}}});c.metabolic_viewer=b})(c.viewers||(c.viewers={}))})(pages||(pages={}));
