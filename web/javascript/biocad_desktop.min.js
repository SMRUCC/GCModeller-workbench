...
(function(c){var d=function(b,a,e){e=void 0===e?"Rplot_js":e;var d=c.echarts_ts.call(this,e)||this;d.title=b;d.subtitle=a;d.div=e;return d};$jscomp.inherits(d,c.echarts_ts);d.prototype.plot=function(b,a,e){this.option={title:{text:this.title,subtext:this.subtitle,left:"center"},tooltip:{trigger:"item"},xAxis:{type:"value",data:a},yAxis:{type:"value"},series:[{data:e,type:"line",areaStyle:{}}],legend:{orient:"vertical",show:!0}};this.show()};c.lineplot=d})(js_plot||(js_plot={}));
...
a=a.info;if(0<a.size){a=$jscomp.makeIterator(a.set);for(var c=a.next();!c.done;c=a.next())c=c.value,b.appendElement($ts("<option>",{value:c}).display(c))}})};b.prototype.molecules_list_onchange=function(a){var b=a[0],c=$ts.select.getOption("#module_list");console.log(a);console.log(c);$ts.get("@vector/?m="+c+"&id="+b,function(a){a=a.info;var d=Array(a.size).fill().map(function(a,b){return b});(new js_plot.lineplot("Expression of "+b,"From module "+c,"container")).plot(b,d,a.vec)})};$jscomp.global.Object.defineProperties(b.prototype,
{appName:{configurable:!0,enumerable:!0,get:function(){return"vcell_viewer"}}});c.vcell_viewer=b})(c.viewers||(c.viewers={}))})(pages||(pages={}));
