...
function(a){a=JSON.stringify({ssid:a});apps.gcmodeller.sendPost($ts.url("@web_invoke_Rplot"),a).then(function(a){desktop.promiseAsyncCallback(a,function(a,b){a?($ts("#Rplot-box").CType().href=b.info,$ts("#Rplot_js").CType().src=b.info,$ts("#busy-indicator").hide()):desktop.showToastMessage(b.info,"Rplot Error","danger")})})};b.prototype.refresh_Rplot_click=function(){$ts("#busy-indicator").show();Strings.Empty(this.session_id)?desktop.showToastMessage("Data session id can not be nothing!","Rplot Error",
"danger"):b.plot3DScatter(this.session_id)};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"dataEmbedding"}}});a.dataEmbedding=b})(pages||(pages={}));
