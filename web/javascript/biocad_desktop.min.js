...
function(a){"string"==typeof a?this.showMetabolicNetwork(a):this.showMetabolicNetwork(a[0])};b.prototype.showMetabolicNetwork=function(a){var b=this;isNullOrEmpty(this.compartments[a])?apps.gcmodeller.getMetabolicEnzymes(a).then(function(c){return __awaiter(this,void 0,void 0,function h(){return $jscomp.generator.createGenerator(h,function(d){if(1==d.nextAddress)return d.yield(c,2);c=d.yieldResult;b.compartments[a]=JSON.parse(c);b.showNetworkImpl(a,b.compartments[a]);d.jumpToEnd()})})}):this.showNetworkImpl(a,
this.compartments[a])};b.prototype.showNetworkImpl=function(a,b){var c=[],d=this,e=[],m=$ts("#reaction-graph-data").clear();b=$jscomp.makeIterator(b);for(var k=b.next();!k.done;k=b.next()){k=$jscomp.makeIterator(k.value.reactions);for(var l=k.next();!l.done;l=k.next()){l=l.value;for(var n=$jscomp.makeIterator(l.enzyme),p=n.next();!p.done;p=n.next())c.push(p.value);e.push(l)}}c=$from(c).Where(function(a){return!Strings.Empty(a,!0)}).GroupBy(function(a){return a.split(".")[0]}).Where(function(a){return"EC"+
a.Key in d.category_index}).Select(function(a){return{name:d.category_index["EC"+a.Key],value:a.Count}}).ToArray();console.table(c);console.log(e);(new js_plot.piePlot("Metabolic Composition","Subcellular Location: "+a,"enzyme-class")).plot("Reaction Counts",c);$from(e).GroupBy(function(a){return a.entry}).ForEach(function(a){a=a.First;var b=a.entry.replace(":","-");a=$ts("<a>",{id:b,href:"#"}).display(a.definition.replace(/[<]/ig,"&lt;"));a=$ts("<li>").display(a);m.appendElement(a)})};$jscomp.global.Object.defineProperties(b.prototype,
{appName:{configurable:!0,enumerable:!0,get:function(){return"metabolic_viewer"}}});c.metabolic_viewer=b})(c.viewers||(c.viewers={}))})(pages||(pages={}));
