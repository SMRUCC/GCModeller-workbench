...
for(var d=$jscomp.makeIterator(a),e=d.next();!e.done;e=d.next())e=e.value,b.appendElement($ts("<option>",{value:e}).display(e));c.reaction_list_onchange(a[0])})};b.prototype.reaction_list_onchange=function(a){var b=a[0],c=[];this.get_vector(a[0],function(a,d){(new js_plot.lineplot("Expression of "+b,"From module reactions","reaction-container")).plot(b,d,c)},"Reactions");a=$ts.url("@graph/?id="+this.reaction_bind+"&rxn="+b);$ts.get("http://localhost:"+this.port+a,function(a){console.log(a)})};b.prototype.get_vector=
function(a,b,c){a=$ts.url("@vector/?m="+((void 0===c?null:c)||this.cur_modu)+"&id="+a);$ts.get("http://localhost:"+this.port+a,function(a){a=a.info;var c=a.vec,d=Array(a.size).fill().map(function(a,b){return[b,c[b]]});b(a.size,d)})};b.prototype.pin_onclick=function(){var a=$ts.select.getOption("#molecules_list"),b=this;this.pins.push(a);this.get_vector(a,function(c,d){b.vectors.Add(a,d)})};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"vcell_viewer"}}});
c.vcell_viewer=b})(c.viewers||(c.viewers={}))})(pages||(pages={}));
