...
(function(c){c.parseSampleInfo=function(c,b,a){a=void 0===a?null:a;$ts.get(sampleInfoUrl+c,function(c){0!=c.code?isNullOrUndefined(a)?desktop.showToastMessage(c.info,"Parse SampleInfo","danger"):a(c.info):(c=$ts.csv.toObjects(c.info).ToArray(!1),TypeScript.logging.table(c),b(c))})};c.saveSampleInfo=function(c,b,a){var e={csv:$ts.csv.toText(c)};b="@api:save?file="+b+"&category=sampleInfo";TypeScript.logging.table(c);TypeScript.logging.log(b,TypeScript.ConsoleColors.DarkRed);$ts.post(b,e,function(b){desktop.closeSpinner();
...
b.prototype.showTaskDatalist=function(a,b){b=void 0===b?null:b;a=$from(a).Select(function(a){return JSON.parse(a)}).ToArray();this.loadTaskList(a).then(function(a){isNullOrUndefined(b)||b()})};b.prototype.loadTaskList=function(a){return __awaiter(this,void 0,void 0,function g(){var c,d,m,k,l,n,p;return $jscomp.generator.createGenerator(g,function(f){switch(f.nextAddress){case 1:c=$ts("#task_manager").clear(),m=null,k={},l=$jscomp.makeIterator(a),n=l.next();case 2:if(n.done){f.jumpTo(4);break}k.$jscomp$loop$prop$task$20=
n.value;p=k;return f.yield(b.getHostObject(k.$jscomp$loop$prop$task$20),5);case 5:p.$jscomp$loop$prop$task$20=f.yieldResult;m=k.$jscomp$loop$prop$task$20.session_id.replace(/\./ig,"-");d=b.buildTaskHtml(k.$jscomp$loop$prop$task$20,m);c.appendElement(d);localStorage.setItem(k.$jscomp$loop$prop$task$20.session_id,JSON.stringify(k.$jscomp$loop$prop$task$20.arguments));$ts("#"+m).onclick=function(a){return function(){apps.gcmodeller.openPage(a.$jscomp$loop$prop$task$20.session_id,JSON.stringify(a.$jscomp$loop$prop$task$20))}}(k);
k={$jscomp$loop$prop$task$20:k.$jscomp$loop$prop$task$20};n=l.next();f.jumpTo(2);break;case 4:return f.return(0)}})})};b.getHostObject=function(a){return __awaiter(this,void 0,void 0,function g(){var b,c,d,k,l,n,p,q,r,t;return $jscomp.generator.createGenerator(g,function(g){switch(g.nextAddress){case 1:return c=b={},g.yield(a.appName,2);case 2:return c.appName=g.yieldResult,d=b,g.yield(a.arguments,3);case 3:return d.arguments=g.yieldResult,k=b,g.yield(a.error,4);case 4:return k.error=g.yieldResult,
...
function(a){a=JSON.parse(a||"[]");var c=Object.keys(a).length,d=$ts("#repository"),f={},h;for(h in a){f.$jscomp$loop$prop$key$24=h;f.$jscomp$loop$prop$metadata$25=a[f.$jscomp$loop$prop$key$24];var m=b.buildDbCard(f.$jscomp$loop$prop$key$24,f.$jscomp$loop$prop$metadata$25);d.appendElement(m);console.log(f.$jscomp$loop$prop$key$24);$ts("#"+f.$jscomp$loop$prop$key$24).onclick=function(a){return function(){apps.gcmodeller.openEnrichmentPage(a.$jscomp$loop$prop$key$24,a.$jscomp$loop$prop$metadata$25.name,
a.$jscomp$loop$prop$metadata$25.note)}}(f);$ts("#"+f.$jscomp$loop$prop$key$24+"-meta").onclick=function(a){return function(){desktop.loading();b.showMetadata(a.$jscomp$loop$prop$key$24,a.$jscomp$loop$prop$metadata$25)}}(f);f={$jscomp$loop$prop$key$24:f.$jscomp$loop$prop$key$24,$jscomp$loop$prop$metadata$25:f.$jscomp$loop$prop$metadata$25}}desktop.closeSpinner();desktop.showToastMessage("Found "+c+" database.","Enrichment Database Repository","info")};b.showMetadata=function(a,c){var d="",e=JSON.stringify({guid:a});
...
{$jscomp$loop$prop$name$27:c.$jscomp$loop$prop$name$27,$jscomp$loop$prop$model$28:c.$jscomp$loop$prop$model$28},e=d.next())c.$jscomp$loop$prop$model$28=e.value,c.$jscomp$loop$prop$name$27=c.$jscomp$loop$prop$model$28.name,e="#model-"+c.$jscomp$loop$prop$name$27,console.log(e),$ts(e).onclick=function(c){return function(){desktop.loading();console.log("view background model: "+c.$jscomp$loop$prop$name$27+"...");b.viewModel(a,c.$jscomp$loop$prop$name$27,c.$jscomp$loop$prop$model$28.info)}}(c)};c+='<span class="badge badge-primary">Protein Counts</span>: '+
