...
(function(c){var d=function(b,a,e){e=void 0===e?"Rplot_js":e;var d=c.echarts_ts.call(this,e)||this;d.title=b;d.subtitle=a;d.div=e;return d};$jscomp.inherits(d,c.echarts_ts);d.prototype.plot=function(b,a){this.option={title:{text:this.title,subtext:this.subtitle,left:"center"},tooltip:{trigger:"item"},xAxis:{type:"value"},yAxis:{type:"value"},series:[{data:a,type:"line",areaStyle:{},smooth:!0,markPoint:{symbol:"none",symbolSize:1}}],legend:{orient:"vertical",show:!0}};this.show()};c.lineplot=d})(js_plot||
(js_plot={}));
