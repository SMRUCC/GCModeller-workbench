...
0)};d.prototype.executeBatch_=function(){for(;this.batch_&&this.batch_.length;){var a=this.batch_;this.batch_=[];for(var b=0;b<a.length;++b){var e=a[b];a[b]=null;try{e()}catch(k){this.asyncThrow_(k)}}}this.batch_=null};d.prototype.asyncThrow_=function(a){this.asyncExecuteFunction(function(){throw a;})};var e=function(a){this.state_=0;this.result_=void 0;this.onSettledCallbacks_=[];var b=this.createResolveAndReject_();try{a(b.resolve,b.reject)}catch(m){b.reject(m)}};e.prototype.createResolveAndReject_=
...
0;a<this.onSettledCallbacks_.length;++a)g.asyncExecute(this.onSettledCallbacks_[a]);this.onSettledCallbacks_=null}};var g=new d;e.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};e.prototype.settleSameAsThenable_=function(a,b){var e=this.createResolveAndReject_();try{a.call(b,e.resolve,e.reject)}catch(k){e.reject(k)}};e.prototype.then=function(a,b){function c(a,b){return"function"==typeof a?function(b){try{d(a(b))}catch(t){g(t)}}:
b}var d,g,f=new e(function(a,b){d=a;g=b});this.callWhenSettled_(c(a,d),c(b,g));return f};e.prototype.catch=function(a){return this.then(void 0,a)};e.prototype.callWhenSettled_=function(a,b){function e(){switch(c.state_){case 1:a(c.result_);break;case 2:b(c.result_);break;default:throw Error("Unexpected state: "+c.state_);}}var c=this;null==this.onSettledCallbacks_?g.asyncExecute(e):this.onSettledCallbacks_.push(e)};e.resolve=b;e.reject=function(a){return new e(function(b,e){e(a)})};e.race=function(a){return new e(function(e,
c){for(var d=$jscomp.makeIterator(a),g=d.next();!g.done;g=d.next())b(g.value).callWhenSettled_(e,c)})};e.all=function(a){var c=$jscomp.makeIterator(a),d=c.next();return d.done?b([]):new e(function(a,e){function g(b){return function(e){f[b]=e;h--;0==h&&a(f)}}var f=[],h=0;do f.push(void 0),h++,b(d.value).callWhenSettled_(g(f.length-1),e),d=c.next();while(!d.done)})};return e},"es6","es3");
...
$jscomp.polyfill("String.prototype.startsWith",function(c){return c?c:function(c,b){var a=$jscomp.checkStringArgs(this,c,"startsWith");c+="";var e=a.length,g=c.length;b=Math.max(0,Math.min(b|0,a.length));for(var d=0;d<g&&b<e;)if(a[b++]!=c[d++])return!1;return d>=g}},"es6","es3");
...
var __awaiter=this&&this.__awaiter||function(c,d,b,a){return new (b||(b=Promise))(function(e,g){function f(b){try{m(a.next(b))}catch(l){g(l)}}function h(b){try{m(a["throw"](b))}catch(l){g(l)}}function m(a){a.done?e(a.value):(new b(function(b){b(a.value)})).then(f,h)}m((a=a.apply(c,d||[])).next())})},apps;
...
(desktop={}));
(function(c){c.now=function(){return(new Date).toLocaleTimeString()};c.parseResultFlag=function(c,b){return __awaiter(this,void 0,void 0,function e(){var d,f;return $jscomp.generator.createGenerator(e,function(e){if(1==e.nextAddress)return e.yield(c.result,2);f=(d=e.yieldResult)&&0==b.code;return e.return(f)})})};c.parseMessage=function(c){return __awaiter(this,void 0,void 0,function a(){var e,d;return $jscomp.generator.createGenerator(a,function(a){if(1==a.nextAddress)return a.yield(c.data,2);e=
a.yieldResult;if($ts.csv.isTsvFile(e))d={code:0,info:e};else if(e.startsWith("data:"))d={code:0,info:e};else try{d=JSON.parse(e)}catch(h){d={code:500,info:e}}return a.return(d)})})};c.processHtmlMsg=function(d){"string"==typeof d?(d=d.replace(/[<]/ig,"&lt;"),d=Strings.lineTokens(d).join("<br />")):d=c.RSharp.isRSharpError(d)?c.RSharp.RSharpErrorMessage(d):"Unhandle error!";return d}})(desktop||(desktop={}));
(function(c){function d(a,e,d,f,h){e=void 0===e?"Task Error":e;d=void 0===d?"":d;f=void 0===f?"danger":f;return $ts("<div>",{class:["toast","show","fade","toast-"+f],role:"alert","aria-live":"assertive","aria-atomic":"true","data-mdb-color":f,"data-mdb-autohide":(void 0===h?!0:h).toString(),style:"width: 500px;"}).display('        \n            <div class="toast-header toast-'+f+'">\n                <i class="'+b[f]+'"></i>\n                <strong class="me-auto">'+e+"</strong>\n                <small>"+
...
(function(c){(function(d){d.openfileDialog=function(b,a){a=void 0===a?"any file(*.*)|*.*":a;c.loading();apps.gcmodeller.getFileOpen(a).then(function(a){return __awaiter(this,void 0,void 0,function f(){var e,d;return $jscomp.generator.createGenerator(f,function(f){if(1==f.nextAddress)return f.yield(a,2);e=f.yieldResult;d=$ts(b);d.value=e;c.closeSpinner();f.jumpToEnd()})})})}})(c.winforms||(c.winforms={}))})(desktop||(desktop={}));
...
(function(c){var d=function(b){this.option={};this.myChart=window.echarts.init(document.getElementById(void 0===b?"Rplot_js":b),null,{renderer:"canvas",useDirtyRect:!1});this.option&&this.myChart.setOption(this.option)};d.prototype.hookChartResizeEvt=function(){window.addEventListener("resize",this.myChart.resize)};d.prototype.show=function(){this.option&&this.myChart.setOption(this.option)};c.echarts_ts=d})(js_plot||(js_plot={}));
...
(function(c){var d=function(b){return c.echarts_ts.call(this,void 0===b?"container":b)||this};$jscomp.inherits(d,c.echarts_ts);d.prototype.plot=function(b){this.myChart.hideLoading();this.option={title:{text:"Les Miserables",subtext:"Default layout",top:"bottom",left:"right"},tooltip:{},legend:[{data:b.categories.map(function(a){return a.name})}],series:[{name:"Les Miserables",type:"graph",layout:"force",data:b.nodes,links:b.links,categories:b.categories,roam:!0,label:{position:"right"},force:{repulsion:100}}]};
console.log("view of the graph data:");console.log(b);this.show()};c.graph_plot=d})(js_plot||(js_plot={}));
...
$jscomp.makeIterator(d(this.appList[a],a)),g=e.next();!g.done;g=e.next())this.terms.push(g.value);this.suggestions=new c.suggestion_list.suggestion(this.terms);this.hookSearchBar()};b.prototype.hookSearchBar=function(){var a=$ts("#applets"),e=this,c=$ts("#form1");c.onchange=function(){if(c.value&&""!=c.value){var d=c.value;a.clear();d=$jscomp.makeIterator(e.suggestions.populateSuggestion(d,6,!1));for(var g=d.next();!g.done;g=d.next())g=b.buildElement(e.appList[g.value.id]),a.appendChild(g)}else b.showAppList(e.appList)}};
...
function(){this.SaveSettings()};d.prototype.open_ncbi_blast_folder_onclick=function(){var b=$ts("#ncbi_blast_folder"),a=this;desktop.loading("Load configurations...");apps.gcmodeller.getFolderOpen().then(function(e){return __awaiter(this,void 0,void 0,function f(){var c;return $jscomp.generator.createGenerator(f,function(d){if(1==d.nextAddress)return c=b,d.yield(e,2);c.value=d.yieldResult;desktop.closeSpinner();Strings.Empty(b.value,!0)||a.SaveSettings();d.jumpToEnd()})})})};d.prototype.open_repository_folder_onclick=
function(){var b=$ts("#repository_folder"),a=this;desktop.loading("Load configurations...");apps.gcmodeller.getFolderOpen().then(function(c){return __awaiter(this,void 0,void 0,function f(){var e;return $jscomp.generator.createGenerator(f,function(d){if(1==d.nextAddress)return e=b,d.yield(c,2);e.value=d.yieldResult;desktop.closeSpinner();Strings.Empty(b.value,!0)||a.SaveSettings();d.jumpToEnd()})})})};$jscomp.global.Object.defineProperties(d.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"settings"}}});
c.settings=d})(pages||(pages={}));
(function(c){var d={success:"badge-success",error:"badge-danger",pending:"badge-warning",cancel:"badge-default",running:"badge-success"},b=function(a){return Bootstrap.apply(this,arguments)||this};$jscomp.inherits(b,Bootstrap);b.prototype.init=function(){var a=this;apps.gcmodeller.getTaskList().then(function(b){return __awaiter(this,void 0,void 0,function f(){var c;return $jscomp.generator.createGenerator(f,function(e){if(1==e.nextAddress)return e.yield(b,2);c=e.yieldResult;a.showTaskDatalist(c,function(){desktop.showToastMessage("Load "+
c.length+" web task!","Task Manager","info");setInterval(function(){return a.checkList()},6E3)});e.jumpToEnd()})})})};b.prototype.checkList=function(){var a=this;apps.gcmodeller.checkTaskList().then(function(b){return __awaiter(this,void 0,void 0,function f(){var c,e,d,l,n,p;return $jscomp.generator.createGenerator(f,function(f){if(1==f.nextAddress)return f.yield(b,2);c=f.yieldResult;if(e=0<c.length)for(apps.gcmodeller.getTaskList().then(function(b){return __awaiter(this,void 0,void 0,function u(){var c;
return $jscomp.generator.createGenerator(u,function(e){if(1==e.nextAddress)return e.yield(b,2);c=e.yieldResult;a.showTaskDatalist(c,function(){console.log("task list has been updated!")});e.jumpToEnd()})})}),d=$jscomp.makeIterator(c),l=d.next();!l.done;l=d.next())n=l.value,p=JSON.parse(n),"success"==p.status?desktop.showToastMessage("Run ["+p.title+"] success!","Task Manager","success"):"error"==p.status&&desktop.showToastMessage("Run ["+p.title+"] failured!","Task Manager","danger");f.jumpToEnd()})})})};
b.prototype.showTaskDatalist=function(a,b){b=void 0===b?null:b;a=$from(a).Select(function(a){return JSON.parse(a)}).ToArray();this.loadTaskList(a).then(function(a){isNullOrUndefined(b)||b()})};b.prototype.loadTaskList=function(a){return __awaiter(this,void 0,void 0,function g(){var c,d,m,k,l,n,p;return $jscomp.generator.createGenerator(g,function(g){switch(g.nextAddress){case 1:c=$ts("#task_manager").clear(),m=null,k={},l=$jscomp.makeIterator(a),n=l.next();case 2:if(n.done){g.jumpTo(4);break}k.$jscomp$loop$prop$task$26=
n.value;p=k;return g.yield(b.getHostObject(k.$jscomp$loop$prop$task$26),5);case 5:p.$jscomp$loop$prop$task$26=g.yieldResult;m=k.$jscomp$loop$prop$task$26.session_id.replace(/\./ig,"-");d=b.buildTaskHtml(k.$jscomp$loop$prop$task$26,m);c.appendElement(d);localStorage.setItem(k.$jscomp$loop$prop$task$26.session_id,JSON.stringify(k.$jscomp$loop$prop$task$26.arguments));$ts("#"+m).onclick=function(a){return function(){apps.gcmodeller.openPage(a.$jscomp$loop$prop$task$26.session_id,JSON.stringify(a.$jscomp$loop$prop$task$26))}}(k);
k={$jscomp$loop$prop$task$26:k.$jscomp$loop$prop$task$26};n=l.next();g.jumpTo(2);break;case 4:return g.return(0)}})})};b.getHostObject=function(a){return __awaiter(this,void 0,void 0,function g(){var b,c,d,k,l,n,p,q,r,t;return $jscomp.generator.createGenerator(g,function(g){switch(g.nextAddress){case 1:return c=b={},g.yield(a.appName,2);case 2:return c.appName=g.yieldResult,d=b,g.yield(a.arguments,3);case 3:return d.arguments=g.yieldResult,k=b,g.yield(a.error,4);case 4:return k.error=g.yieldResult,
l=b,g.yield(a.logtext,5);case 5:return l.logtext=g.yieldResult,n=b,g.yield(a.session_id,6);case 6:return n.session_id=g.yieldResult,p=b,g.yield(a.status,7);case 7:return p.status=g.yieldResult,q=b,g.yield(a.time,8);case 8:return q.time=g.yieldResult,r=b,g.yield(a.title,9);case 9:return r.title=g.yieldResult,t=b,g.yield(a.url,10);case 10:return t.url=g.yieldResult,console.log(b),g.return(b)}})})};b.buildTaskHtml=function(a,b){return $ts("<tr>").display('          \n            <td>\n                <div class="d-flex align-items-center">\n                    <img src="/assets/images/dna-image.jpg" alt=""\n                        style="width: 45px; height: 45px" class="rounded-circle" />\n                    <div class="ms-3">\n                        <p class="fw-bold mb-1">\n                            <a id="'+
...
file:h,ssid:""};m.ssid=c.analysis_session.prototype.generateSsid.call(this,m);apps.gcmodeller.sendPost($ts.url("@web_invoke_clustering"),JSON.stringify(m)).then(function(a){return __awaiter(this,void 0,void 0,function n(){return $jscomp.generator.createGenerator(n,function(c){desktop.promiseAsyncCallback(a,function(a,c){a?(b.session_id=m.ssid,b.refresh_Rplot_onclick(),a=$ts.csv(c.info,!0).Objects().Take(10),$ts("#patterns-table").clear(),$ts.appendTable(a,"#patterns-table",null,{class:["table","table-sm"]})):
desktop.showToastMessage(c.info,"Run CMeans","danger")});c.jumpToEnd()})})})};d.prototype.refresh_Rplot_onclick=function(){var b=$ts.select.getOption("#colorSet");b={ssid:this.session_id,colorSet:b};desktop.loading();apps.gcmodeller.sendPost($ts.url("@web_invoke_Rplot"),JSON.stringify(b)).then(function(a){return __awaiter(this,void 0,void 0,function g(){return $jscomp.generator.createGenerator(g,function(b){desktop.promiseAsyncCallback(a,function(a,b){a?(a=b.info+"?refresh="+md5(desktop.now()),$ts("#Rplot-box").CType().href=
...
(function(c){var d=function(b){return c.analysis_session.apply(this,arguments)||this};$jscomp.inherits(d,c.analysis_session);d.prototype.init=function(){};d.prototype.button_open_click=function(){var b=$ts("#matrix-file").CType(),a=$ts("#busy-indicator");a.show();apps.gcmodeller.getFileOpen("Excel Matrix(*.csv)|*.csv").then(function(c){return __awaiter(this,void 0,void 0,function f(){var e;return $jscomp.generator.createGenerator(f,function(d){if(1==d.nextAddress)return e=b,d.yield(c,2);e.value=d.yieldResult;
...
a).then(function(a){return __awaiter(this,void 0,void 0,function l(){return $jscomp.generator.createGenerator(l,function(b){desktop.promiseAsyncCallback(a,function(a,b){a?(a=$ts.csv(b.info,!0).Objects().Take(10),h.session_id=g,$ts("#embedding-table").clear(),$ts.appendTable(a,"#embedding-table",null,{class:["table","table-sm"]}),d.plot3DScatter(g),desktop.showToastMessage("Run Data Embedding Analysis Success!",e+" Task Success","success")):desktop.showToastMessage(b.info,e+" Task Error","danger")});
...
a=JSON.stringify({odes:JSON.stringify(a),constants:JSON.stringify(e),final_time:g,resolution:f,session_id:h});apps.gcmodeller.sendPost($ts.url("@web_invoke_run_plas"),a).then(function(a){return __awaiter(this,void 0,void 0,function l(){return $jscomp.generator.createGenerator(l,function(c){desktop.promiseAsyncCallback(a,function(a,c){a?(a=$ts.csv(c.info,!0).Objects(),$ts("#plas-table").clear(),$ts.appendTable(a,"#plas-table",null,{class:["table","table-sm"]}),b.session_id=h,b.createPlot(),desktop.showToastMessage("Run system simulation job done!",
"Run PLAS","success")):desktop.showToastMessage(c.info,"Run PLAS","danger");desktop.closeSpinner()});c.jumpToEnd()})})})}};d.prototype.createPlot=function(){var b=JSON.stringify({ssid:this.session_id});apps.gcmodeller.sendPost($ts.url("@web_invoke_Rplot"),b).then(function(a){return __awaiter(this,void 0,void 0,function g(){return $jscomp.generator.createGenerator(g,function(b){desktop.promiseAsyncCallback(a,function(a,b){a?(a=b.info+"?refresh="+md5(desktop.now()),$ts("#Rplot-box").CType().href=a,
...
c;desktop.closeSpinner();e.jumpToEnd()})})})};d.prototype.run_onclick=function(){var b=this;desktop.loading("Do z-score plot...");var a={file:$ts.value("#matrix-file"),ssid:""};a.ssid=c.analysis_session.prototype.generateSsid.call(this,a);apps.gcmodeller.sendPost($ts.url("@web_invoke_zscore"),JSON.stringify(a)).then(function(c){return __awaiter(this,void 0,void 0,function f(){return $jscomp.generator.createGenerator(f,function(d){desktop.promiseAsyncCallback(c,function(c,d){c?(b.session_id=a.ssid,
b.refresh_Rplot_onclick(),c=$ts.csv(d.info,!0).Objects().Take(10),$ts("#zscore-table").clear(),$ts.appendTable(c,"#zscore-table",null,{class:["table","table-sm"]})):desktop.showToastMessage(d.info,"Run Z-score","danger")});d.jumpToEnd()})})})};d.prototype.refresh_Rplot_onclick=function(){var b=$ts.select.getOption("#colorSet");b={ssid:this.session_id,colorSet:b};desktop.loading("Do z-score plot...");apps.gcmodeller.sendPost($ts.url("@web_invoke_Rplot"),JSON.stringify(b)).then(function(a){return __awaiter(this,
...
{query:$ts.value("#query-file"),reference:$ts.value("#reference-file"),evalue:.001,n_threads:2,project:this.project,protocol:$ts.select.getOption("#protocols")};apps.gcmodeller.createTask("Run blast search",$ts.url("@web_invoke_localblast"),JSON.stringify(a)).then(function(a){return __awaiter(this,void 0,void 0,function f(){var b;return $jscomp.generator.createGenerator(f,function(c){if(1==c.nextAddress)return c.yield(a.data,2);b=c.yieldResult;desktop.showTaskAlert();desktop.showToastMessage("Pending a new task: "+
...
void 0,void 0,function h(){var d;return $jscomp.generator.createGenerator(h,function(e){if(1==e.nextAddress)return d=a,e.yield(c,2);d.value=e.yieldResult;b.check_matrix(a.value);e.jumpToEnd()})})})};b.prototype.check_matrix=function(a){};b.prototype.button_open_sampleinfo_click=function(){var a=$ts("#sample-file").CType();apps.gcmodeller.getFileOpen("Excel Table(*.csv)|*.csv").then(function(b){return __awaiter(this,void 0,void 0,function f(){var c;return $jscomp.generator.createGenerator(f,function(d){if(1==
d.nextAddress)return c=a,d.yield(b,2);c.value=d.yieldResult;d.jumpToEnd()})})})};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"create_project"}}});c.create_project=b})(c.analysis_project||(c.analysis_project={}))})(pages||(pages={}));
...
for(var b=0,c=this.editor.TableRows(),d=$jscomp.makeIterator(this.editor.TableData(!1)),h=d.next();!h.done;h=d.next())h=h.value,this.sampleInfo[h.ID].injectionOrder=h.injectionOrder,this.sampleInfo[h.ID].batch=h.batch,this.sampleInfo[h.ID].sample_info=h.sample_info,this.sampleInfo[h.ID].sample_info1=h.sample_info1,this.sampleInfo[h.ID].sample_info2=h.sample_info2,this.sampleInfo[h.ID].sample_name=h.sample_name,c[b++].dropFlag?this.sampleInfo[h.ID].delete="1":this.sampleInfo[h.ID].delete="0";b=[];
for(var m in this.sampleInfo)b.push(this.sampleInfo[m]);omicsAnalysis.saveSampleInfo(b,this.analysisFile,a)};b.prototype.xload_sampleInfo=function(a){for(var c=!1,d=$jscomp.makeIterator(a),f=d.next();!f.done;f=d.next())f=f.value,Strings.Empty(f.delete,!0)?f.delete="0":"undefined"==f.delete&&(f.delete="0"),Strings.Empty(""+f.injectionOrder,!0)&&(f.injectionOrder=0),Strings.Empty(""+f.batch,!0)&&(f.batch=0),"sample_ID"in f?(f.ID=f.sample_ID,c=!0,delete f.sample_ID):Strings.Empty(f.ID,!0)&&""in f&&(f.ID=
...
for(f=a.next();!f.done;f=a.next()){var h=f.value;this.sampleInfo[h.ID]=h;f=c[d++];"0"!=h.delete&&b.deleteSampleRow(f.tr,f)}return this.editor.table};b.deleteSampleRow=function(a,b){a.cells.item(0);b.dropFlag?(a.style.backgroundColor="white",b.getElementById("remove").innerHTML="\u5220\u9664\u6837\u672c"):(a.style.backgroundColor="gray",b.getElementById("remove").innerHTML="\u6062\u590d\u6837\u672c");b.dropFlag=!b.dropFlag};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,
enumerable:!0,get:function(){return"edit_sampleinfo"}}});c.edit_sampleinfo=b})(c.analysis_project||(c.analysis_project={}))})(pages||(pages={}));
(function(c){(function(c){var b=function(a,b,c,d,h,m,k){a=void 0===a?document.createElement("canvas"):a;b=void 0===b?a.getContext("2d"):b;c=void 0===c?{x:null,y:null,max:2E4}:c;d=void 0===d?[0,0]:d;h=void 0===h?[]:h;this.uCanvas=a;this.uContext=b;this.f=c;this.size=d;this.dots=h;this.setting=void 0===m?null:m;this.frameRender=void 0===k?null:k};b.getTag=function(a){return document.getElementsByTagName(a)[0]};b.getById=function(a){return document.getElementById(a)};b.prototype.canvasResize=function(){this.uCanvas.width=
window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth;this.uCanvas.height=window.innerHeight||document.documentElement.clientHeight||document.body.clientHeight;this.size=[this.uCanvas.width,this.uCanvas.height]};b.prototype.update=function(){var a=this,c=[a.f].concat(a.dots),d,f,h;a.uContext.clearRect(0,0,a.size[0],a.size[1]);var m=$jscomp.makeIterator(a.dots);for(d=m.next();!d.done;d=m.next()){var k=d.value;k.x+=k.xa;k.y+=k.ya;k.xa*=k.x>a.size[0]||0>k.x?-1:1;k.ya*=k.y>
a.size[1]||0>k.y?-1:1;a.uContext.fillRect(k.x-.5,k.y-.5,1,1);for(f=0;f<c.length;f++)if(d=c[f],k!==d&&null!==d.x&&null!==d.y){var l=k.x-d.x;var n=k.y-d.y;var p=l*l+n*n;p<d.max&&(d===a.f&&p>=d.max/2&&(k.x-=.03*l,k.y-=.03*n),h=(d.max-p)/d.max,a.uContext.beginPath(),a.uContext.lineWidth=h/2,a.uContext.strokeStyle="rgba("+a.setting.color+", "+(h+.2)+")",a.uContext.moveTo(k.x,k.y),a.uContext.lineTo(d.x,d.y),a.uContext.stroke())}c.splice(c.indexOf(k),1)}b.defaultCallback(function(){return a.update()})};
...
a.enzyme_class;c=$from(Object.keys(d)).Select(function(a){return{name:a,value:d[a]}}).ToArray();(new js_plot.piePlot("Metabolic Annotation","Enzyme Class Counts","summary_enzyme_pie")).plot("protein numbers",c);var h=a.subcellular_locations;a=$from(Object.keys(h)).Select(function(a){return{name:a,value:h[a]}}).ToArray();(new js_plot.piePlot("Subcellular Locations Annotation","Metabolic Locations","summary_location_pie")).plot("protein numbers",a)};b.prototype.loadSummary=function(a){a="@web_invoke_inspect_model?proj="+
encodeURIComponent(a);$ts.get(a,function(a){0!=a.code?desktop.showToastMessage("Load project file error!","Project Reader","danger"):(a=a.info,console.log(a),b.showPiePlot(a))})};b.prototype.enzyme_anno_onclick=function(){var a=this;desktop.loading("Extract protein set, wait for a while...");apps.gcmodeller.getNextUniqueId().then(function(b){return __awaiter(this,void 0,void 0,function f(){return $jscomp.generator.createGenerator(f,function(c){if(1==c.nextAddress)return c.yield(b,2);b=c.yieldResult;
$ts.post("@web_invoke_extract_proteins",{proj:a.path,ssid:b},function(c){console.log(c);0==c.code?a.create_localBlastTask(c,b,"ontology_annotation"):desktop.showToastMessage(c.info,"Extract Data Error","danger");desktop.closeSpinner()});c.jumpToEnd()})})})};b.prototype.subcellular_anno_onclick=function(){var a=this;desktop.loading("Extract protein set, wait for a while...");apps.gcmodeller.getNextUniqueId().then(function(b){return __awaiter(this,void 0,void 0,function f(){return $jscomp.generator.createGenerator(f,
...
(function(c){(function(c){var b=function(a){return Bootstrap.apply(this,arguments)||this};$jscomp.inherits(b,Bootstrap);b.prototype.init=function(){};b.prototype.button_open_gbff_onclick=function(){var a=$ts("#gbff-file").CType(),b=this;apps.gcmodeller.getFileOpen(apps.ncbi_genbank_assembly).then(function(c){return __awaiter(this,void 0,void 0,function h(){var d;return $jscomp.generator.createGenerator(h,function(e){if(1==e.nextAddress)return d=a,e.yield(c,2);d.value=e.yieldResult;Strings.Empty(a.value,
...
void 0,void 0,function f(){return $jscomp.generator.createGenerator(f,function(c){if(1==c.nextAddress)return c.yield(b,2);b=c.yieldResult;Strings.Empty(b,!0)||(desktop.loading("Create project from genbank assembly..."),$ts.post("@web_invoke_imports",{gbff:a.value,savefile:b},function(a){0!=a.code&&desktop.showToastMessage(a.info,"Create Project","danger")}));c.jumpToEnd()})})})};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"create_bioproject"}}});
c.create_bioproject=b})(c.modeller||(c.modeller={}))})(pages||(pages={}));
(function(c){(function(c){var b=function(a){return Bootstrap.apply(this,arguments)||this};$jscomp.inherits(b,Bootstrap);b.prototype.init=function(){this.scanDatabaseList()};b.prototype.scanDatabaseList=function(){var a=this;desktop.loading();apps.gcmodeller.scanDatabase().then(function(b){return __awaiter(this,void 0,void 0,function f(){var c;return $jscomp.generator.createGenerator(f,function(d){if(1==d.nextAddress)return d.yield(b,2);c=d.yieldResult;a.showDatabaseList(c);d.jumpToEnd()})})})};b.prototype.showDatabaseList=
function(a){a=JSON.parse(a||"[]");var c=Object.keys(a).length,d=$ts("#repository"),f={},h;for(h in a){f.$jscomp$loop$prop$key$30=h;f.$jscomp$loop$prop$metadata$31=a[f.$jscomp$loop$prop$key$30];var m=b.buildDbCard(f.$jscomp$loop$prop$key$30,f.$jscomp$loop$prop$metadata$31);d.appendElement(m);console.log(f.$jscomp$loop$prop$key$30);$ts("#"+f.$jscomp$loop$prop$key$30).onclick=function(a){return function(){apps.gcmodeller.openEnrichmentPage(a.$jscomp$loop$prop$key$30,a.$jscomp$loop$prop$metadata$31.name,
a.$jscomp$loop$prop$metadata$31.note)}}(f);$ts("#"+f.$jscomp$loop$prop$key$30+"-meta").onclick=function(a){return function(){desktop.loading();b.showMetadata(a.$jscomp$loop$prop$key$30,a.$jscomp$loop$prop$metadata$31)}}(f);f={$jscomp$loop$prop$key$30:f.$jscomp$loop$prop$key$30,$jscomp$loop$prop$metadata$31:f.$jscomp$loop$prop$metadata$31}}desktop.closeSpinner();desktop.showToastMessage("Found "+c+" database.","Enrichment Database Repository","info")};b.showMetadata=function(a,c){var d="",e=JSON.stringify({guid:a});
d+='<span class="badge badge-primary">Database Name</span>: '+c.name+"("+a+")<br />";d+='<span class="badge badge-primary">Note</span>: <p class="note note-light">'+c.note+"</p><br />";apps.gcmodeller.sendPost($ts.url("@web_invoke_inspector"),e).then(function(c){return __awaiter(this,void 0,void 0,function k(){return $jscomp.generator.createGenerator(k,function(e){desktop.promiseAsyncCallback(c,function(c,e){b.displayDatabaseContentSummary(a,d,c,e)});e.jumpToEnd()})})})};b.displayDatabaseContentSummary=
function(a,c,d,f){var e=d?"Load Database Success":"Load Database Error",g=f.info,k=null;console.log(g);if(d){var l=$from(Object.keys(g.summary)).Select(function(a){return{name:a,info:g.summary[a]}}).Where(function(a){return 0<a.info.unique_size}).Where(function(a){return 1<a.info.unique_size/a.info.clusters});d=l.Select(function(a){return b.summaryLine(a.name,a.info)}).JoinBy("");desktop.showToastMessage("Success!",e,"success");k=function(){for(var c={},d=$jscomp.makeIterator(l.ToArray()),e=d.next();!e.done;c=
{$jscomp$loop$prop$name$33:c.$jscomp$loop$prop$name$33,$jscomp$loop$prop$model$34:c.$jscomp$loop$prop$model$34},e=d.next())c.$jscomp$loop$prop$model$34=e.value,c.$jscomp$loop$prop$name$33=c.$jscomp$loop$prop$model$34.name,e="#model-"+c.$jscomp$loop$prop$name$33,console.log(e),$ts(e).onclick=function(c){return function(){desktop.loading();console.log("view background model: "+c.$jscomp$loop$prop$name$33+"...");b.viewModel(a,c.$jscomp$loop$prop$name$33,c.$jscomp$loop$prop$model$34.info)}}(c)};c+='<span class="badge badge-primary">Protein Counts</span>: '+
g.counts+"<br />";c+='<span class="badge badge-primary">Models</span>: '+l.Count+"<br />";c+='<span class="badge badge-primary">Backgrounds</span>: <br /><br />\n                        <ul class="list-group list-group-light">\n                            '+d+"\n                        </ul>\n                    "}else desktop.showToastMessage(f.info,e,"danger");$ts("#summary-info").display(c);isNullOrUndefined(k)||k()};b.viewModel=function(a,b,c){$ts.post("@web_invoke_loadModel",{guid:a,xref:b},
...
$ts.url("@web_invoke_imports"),JSON.stringify(b)).then(function(a){return __awaiter(this,void 0,void 0,function h(){var b;return $jscomp.generator.createGenerator(h,function(c){if(1==c.nextAddress)return c.yield(a.data,2);b=c.yieldResult;desktop.showTaskAlert();desktop.showToastMessage("Pending a new task: "+b,"Build enzyme blast+ database","info");c.jumpToEnd()})})})};b.prototype.run_rhea_onclick=function(){};b.prototype.button_open_rhea_onclick=function(){desktop.winforms.openfileDialog("#rhea-file",
...
"danger"):apps.gcmodeller.createTask("Imports Enzyme Database",$ts.url("@web_invoke_imports"),JSON.stringify(b)).then(function(a){return __awaiter(this,void 0,void 0,function h(){var b;return $jscomp.generator.createGenerator(h,function(c){if(1==c.nextAddress)return c.yield(a.data,2);b=c.yieldResult;desktop.showTaskAlert();desktop.showToastMessage("Pending a new task: "+b,"Build enzyme blast+ database","info");c.jumpToEnd()})})})};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,
...
title:a.term,onclick:function(){c(a)}}).display(a.term);return $ts("<div>",{class:b}).display(d)}b.makeSuggestions=function(b,d,e,m,k,l,n){m=void 0===m?10:m;k=void 0===k?!1:k;l=void 0===l?null:l;n=void 0===n?null:n;var f=new c.suggestion(b);return function(b){a(f,b,d,e,m,k,n,l)}}})(c.render||(c.render={}))})(c.suggestion_list||(c.suggestion_list={}))})(pages||(pages={}));
(function(c){(function(c){var b=function(a){this.terms=a};b.prototype.hasEquals=function(a,b){(b=void 0===b?!1:b)||(a=a.toLowerCase());for(var c=$jscomp.makeIterator(this.terms),d=c.next();!d.done;d=c.next())if(d=d.value,b){if(d.term.toLowerCase()==a)return!0}else if(d.term==a)return!0;return!1};b.prototype.populateSuggestion=function(a,d,g){d=void 0===d?5:d;g=void 0===g?!1:g;var e=a.toLowerCase(),h=$from(this.terms).Select(function(c){var d=b.getScore(c,a,e,g);return{term:c,score:d}}).OrderBy(function(a){return a.score}),
m=h.Where(function(a){return a.score!=c.NA}).Take(d).Select(function(a){return a.term}).ToArray();return m.length==d?m:b.makeAdditionalSuggestion(h,m,g,a,d)};b.makeAdditionalSuggestion=function(a,b,c,d,h){var e=d.toLowerCase();a=a.Skip(b.length).Select(function(a){a=a.term;var b=c?Levenshtein.ComputeDistance(a.term.toLowerCase(),e):Levenshtein.ComputeDistance(a.term,d);return{term:a,score:b}}).OrderBy(function(a){return a.score}).Take(h-b.length).Select(function(a){return a.term}).ToArray();return[].concat($jscomp.arrayFromIterable(b),
$jscomp.arrayFromIterable(a))};b.getScore=function(a,b,d,f){return f?(a=a.term.toLowerCase(),c.term.indexOf(a,d)):a.dist(b)};c.suggestion=b})(c.suggestion_list||(c.suggestion_list={}))})(pages||(pages={}));(function(c){(function(c){c.NA=1E11;var b=function(a,b){this.id=a;this.term=b};b.prototype.dist=function(a){return b.indexOf(this.term,a)};b.indexOf=function(a,b){return-1==a.indexOf(b)?c.NA:Math.abs(b.length-a.length)};c.term=b})(c.suggestion_list||(c.suggestion_list={}))})(pages||(pages={}));
(function(c){(function(c){var b=function(){var a=Bootstrap.apply(this,arguments)||this;a.intptr=0;return a};$jscomp.inherits(b,Bootstrap);b.prototype.init=function(){var a=this;apps.gcmodeller.getProteinIDs().then(function(b){return __awaiter(this,void 0,void 0,function f(){return $jscomp.generator.createGenerator(f,function(c){if(1==c.nextAddress)return c.yield(b,2);b=c.yieldResult;a.protein_ids=b;a.viewBlastp(a.protein_ids[0]);a.intptr=0;$ts("#number_proteins").display(a.protein_ids.length.toString());
c.jumpToEnd()})})})};b.prototype.previous_onclick=function(){0!=this.intptr&&(this.intptr--,this.viewBlastp(this.current_id))};b.prototype.next_onclick=function(){this.intptr!=this.protein_ids.length-1&&(this.intptr++,this.viewBlastp(this.current_id))};b.prototype.viewBlastp=function(a){var b=function(b){var c=[],d=0==b.length||1==b.length&&"HITS_NOT_FOUND"==b[0].HitName,e={};console.table(b[0].HitName);console.log(d);for(var g=0;g<b.length;g++)if(delete b[g].QueryName,delete b[g].HitName,delete b[g].hit_length,
delete b[g].length_hit,delete b[g].length_hsp,delete b[g].length_query,delete b[g].query_length,b[g].evalue=b[g].evalue.toString(),!Strings.Empty(b[g].description,!0)){var l=b[g].description.split("|")[0];c.push(l);l in e||(e[l]=0);e[l]+=b[g].score}g=d?'<div class="alert alert-warning" role="alert" data-mdb-color="warning" style="width: 400px;">\n                    <i class="fas fa-exclamation-triangle me-3"></i>\n                    '+a+" has no hits!\n                </div>":a+" has "+b.length+
" annotation hits supports";$ts("#blast_output").clear();$ts("#protein_id").clear().display(g);d||$ts.appendTable(b,"#blast_output",null,{class:["table","table-sm"]});b=$from(c).GroupBy(function(a){return a}).Select(function(a){return{name:a.Key,value:a.Count}}).ToArray();console.log("get hits summary:");console.table(b);console.log(e);(new js_plot.piePlot("Annotation Hits Supports","Term Hits","preview_1")).plot("protein hits",b);(new js_plot.barplot("preview_2")).plot($from(Object.keys(e)).Select(function(a){return{name:a,
value:Math.log(e[a])}}))};apps.gcmodeller.getBlastp(a).then(function(a){return __awaiter(this,void 0,void 0,function h(){return $jscomp.generator.createGenerator(h,function(c){if(1==c.nextAddress)return c.yield(a,2);a=c.yieldResult;b(JSON.parse(a));c.jumpToEnd()})})})};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"blastp_viewer"}},current_id:{configurable:!0,enumerable:!0,get:function(){return isNullOrUndefined(this.protein_ids)||
...
(function(c){(function(c){var b=function(){var a=Bootstrap.apply(this,arguments)||this;a.compartments={};a.enzyme_class={};a.category_index={};return a};$jscomp.inherits(b,Bootstrap);b.prototype.init=function(){var a=this,b=$ts("#compartment_list");apps.gcmodeller.getEnzymeClass().then(function(b){return __awaiter(this,void 0,void 0,function h(){var c,d;return $jscomp.generator.createGenerator(h,function(e){if(1==e.nextAddress)return e.yield(b,2);b=e.yieldResult;c=JSON.parse(b);for(d in c)a.enzyme_class[d]=
c[d],a.category_index["EC"+c[d]]=d;console.log(a.enzyme_class);e.jumpToEnd()})})});apps.gcmodeller.getMetabolicCompartments().then(function(c){return __awaiter(this,void 0,void 0,function h(){var d,e,g,n;return $jscomp.generator.createGenerator(h,function(h){if(1==h.nextAddress)return h.yield(c,2);d=h.yieldResult;e=$jscomp.makeIterator(d);for(g=e.next();!g.done;g=e.next())n=g.value,a.compartments[n]=[],b.appendElement($ts("<option>",{value:n}).display(n));h.jumpToEnd()})})})};b.prototype.compartment_list_onchange=
function(a){"string"==typeof a?this.showMetabolicNetwork(a):this.showMetabolicNetwork(a[0])};b.prototype.showMetabolicNetwork=function(a){var b=this;isNullOrEmpty(this.compartments[a])?apps.gcmodeller.getMetabolicEnzymes(a).then(function(c){return __awaiter(this,void 0,void 0,function h(){return $jscomp.generator.createGenerator(h,function(d){if(1==d.nextAddress)return d.yield(c,2);c=d.yieldResult;b.compartments[a]=JSON.parse(c);b.showNetworkImpl(a,b.compartments[a]);b.showGraph(b.compartments[a]);
d.jumpToEnd()})})}):(this.showNetworkImpl(a,this.compartments[a]),this.showGraph(this.compartments[a]))};b.prototype.showNetworkImpl=function(a,b){var c=[],d=this,e=[],m=$ts("#reaction-graph-data").clear();b=$jscomp.makeIterator(b);for(var k=b.next();!k.done;k=b.next()){k=$jscomp.makeIterator(k.value.reactions);for(var l=k.next();!l.done;l=k.next()){l=l.value;for(var n=$jscomp.makeIterator(l.enzyme),p=n.next();!p.done;p=n.next())c.push(p.value);e.push(l)}}c=$from(c).Where(function(a){return!Strings.Empty(a,
!0)}).GroupBy(function(a){return a.split(".")[0]}).Where(function(a){return"EC"+a.Key in d.category_index}).Select(function(a){return{name:d.category_index["EC"+a.Key],value:a.Count}}).ToArray();console.table(c);console.log(e);(new js_plot.piePlot("Metabolic Composition","Subcellular Location: "+a,"enzyme-class")).plot("Reaction Counts",c);$from(e).GroupBy(function(a){return a.entry}).ForEach(function(a){a=a.First;var b=a.entry.replace(":","-");a=$ts("<a>",{id:b,href:"#"}).display(a.definition.replace(/[<]/ig,
"&lt;"));a=$ts("<li>").display(a);m.appendElement(a)})};b.prototype.showGraph=function(a){var b={},c=[];a=$jscomp.makeIterator(a);for(var d=a.next();!d.done;d=a.next()){d=d.value;b[d.protein_id]={id:d.protein_id,name:d.protein_id,symbolSize:d.reactions.length};for(var h=$jscomp.makeIterator(d.reactions),m=h.next();!m.done;m=h.next())m=m.value,m.entry in b||(b[m.entry]={id:m.entry,name:m.definition,symbolSize:1}),c.push({source:d.protein_id,target:m.entry})}(new js_plot.graph_plot("container")).plot({nodes:b,
links:c,categories:[]})};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,enumerable:!0,get:function(){return"metabolic_viewer"}}});c.metabolic_viewer=b})(c.viewers||(c.viewers={}))})(pages||(pages={}));
