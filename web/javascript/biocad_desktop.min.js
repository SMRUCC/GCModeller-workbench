...
e){for(var d=$jscomp.makeIterator(a),g=d.next();!g.done;g=d.next())c(g.value).callWhenSettled_(b,e)})};e.all=function(a){var b=$jscomp.makeIterator(a),d=b.next();return d.done?c([]):new e(function(a,e){function g(b){return function(c){f[b]=c;l--;0==l&&a(f)}}var f=[],l=0;do f.push(void 0),l++,c(d.value).callWhenSettled_(g(f.length-1),e),d=b.next();while(!d.done)})};return e},"es6","es3");
var __awaiter=this&&this.__awaiter||function(a,b,c,d){return new (c||(c=Promise))(function(e,l){function g(a){try{h(d.next(a))}catch(m){l(m)}}function k(a){try{h(d["throw"](a))}catch(m){l(m)}}function h(a){a.done?e(a.value):(new c(function(b){b(a.value)})).then(g,k)}h((d=d.apply(a,b||[])).next())})},apps;
...
(function(a){function b(a,b,g,k,h){b=void 0===b?"Task Error":b;g=void 0===g?"":g;k=void 0===k?"danger":k;return $ts("<div>",{class:["toast","show","fade","toast-"+k],role:"alert","aria-live":"assertive","aria-atomic":"true","data-mdb-color":k,"data-mdb-autohide":(void 0===h?!0:h).toString()}).display('        \n            <div class="toast-header toast-'+k+'">\n                <i class="'+d[k]+'"></i>\n                <strong class="me-auto">'+b+"</strong>\n                <small>"+(g&&"null"!=g.toLowerCase()?
g:"")+'</small>\n                <button type="button" class="btn-close" data-mdb-dismiss="toast" aria-label="Close">\n                </button>\n            </div>\n            <div class="toast-body">'+c(a)+"</div>\n        ")}function c(a){a=a.replace(/[<]/ig,"&lt;");return a=Strings.lineTokens(a).join("<br />")}a.showToastMessage=function(a,c,d,k,h){c=void 0===c?"Task Error":c;d=void 0===d?"":d;k=void 0===k?"info":k;h=void 0===h?!0:h;$ts("#toast-message").appendElement(b(a,c,d,k,h))};var d={success:"fas fa-check fa-lg me-2",
...
a).then(function(a){return __awaiter(this,void 0,void 0,function l(){var b,c,d;return $jscomp.generator.createGenerator(l,function(f){if(1==f.nextAddress)return f.yield(a.result,2);if(3!=f.nextAddress)return b=f.yieldResult,f.yield(a.data,3);c=f.yieldResult;d=b?"Imports Task Success":"Imports Task Error";b?desktop.showToastMessage(c,d,null,"success"):desktop.showToastMessage(c,d,null,"danger");$ts("#busy-indicator").hide();f.jumpToEnd()})})})};$jscomp.global.Object.defineProperties(b.prototype,{appName:{configurable:!0,
enumerable:!0,get:function(){return"enrichment_database"}}});a.enrichment_database=b})(pages||(pages={}));
