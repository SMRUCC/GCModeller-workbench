...
b.hide();d.jumpToEnd()})})})};b.prototype.run_click=function(){$ts("#busy-indicator").show();var b=$ts.value("#matrix-file"),e=$ts.value("#dimensions"),d=$ts.select.getOption("#algorithm"),f=a.analysis_session.prototype.generateSsid.call(this,{file:b,dims:e,algo:d});e=JSON.stringify({file:b,ssid:f,dims:e,algorithm:d});var g=this;Strings.Empty(b)?desktop.showToastMessage("The matrix data input file can not be nothing!","Data Embedding Analysis","danger"):apps.gcmodeller.sendPost($ts.url("@web_invoke_embedding"),
e).then(function(a){return __awaiter(this,void 0,void 0,function h(){return $jscomp.generator.createGenerator(h,function(b){desktop.promiseAsyncCallback(a,function(a,b){a?(a=$ts.csv(b.info,!0).Objects().Take(10),g.session_id=f,$ts.appendTable(a,"#embedding-table",null,{class:["table","table-sm"]}),desktop.showToastMessage("Run Data Embedding Analysis Success!",d+" Task Success","success")):desktop.showToastMessage(b.info,d+" Task Error","danger")});b.jumpToEnd()})})})};$jscomp.global.Object.defineProperties(b.prototype,
{appName:{configurable:!0,enumerable:!0,get:function(){return"dataEmbedding"}}});a.dataEmbedding=b})(pages||(pages={}));
