#Region "Microsoft.VisualBasic::10317014876326ff006706d423ed9985, win32_desktop\src\GCModeller\RibbonItems.Designer.vb"
    ...
    '   Total Lines: 836
    '    Code Lines: 820 (98.09%)
    ' Comment Lines: 10 (1.20%)
    '    - Xml Docs: 0.00%
    ' 
    '   Blank Lines: 6 (0.72%)
    '     File Size: 35.21 KB
    ...
    '     Class RibbonItems
    ' 
    '         Properties: About, AlignCenter, AlignJustify, AlignLeft, AlignRight
    '                     ApplicationMenu, ButtonCreateNewModellerProject, ButtonCreateNewOmicsProject, ButtonEnrichmentDatabase, ButtonNCBITaxonomy
    '                     ButtonStartPage, Centimeters, ChangePicture, ClosePrintPreview, Copy
    '                     Cut, Email, Exit1, Find, Font
    '                     GroupClipboard, GroupClose, GroupDatabase, GroupEditing, GroupFont
    '                     GroupParagraph, GroupPreview, GroupPrint, GroupSettings, GroupShowOrHide
    '                     GroupWorkbenchApps, GroupZoom, HeaderPrint, HeaderSave, Help
    '                     Inches, Indent, InsertObject, InsertPicture, InsertPictureMore
    '                     LineSpacing, LineSpacing1_0, LineSpacing1_15, LineSpacing1_5, LineSpacing2
    '                     LineSpacingAfter, Links, List, MeasurementUnits, New1
    '                     NextPage, NoWrap, ObjectProperties, OfficeOpenXMLDocument, Open
    '                     OpenDocumentText, OpenObject, OtherFormats, Outdent, PageSetup
    '                     Paragraph, Paste, PasteMore, PasteSpecial, Picas
    '                     PlainTextDocument, Points, PreviousPage, Print, PrintMore
    '                     PrintPreview, QuickAccessToolbar, QuickPrint, RecentItems, Redo
    '                     Replace, ResizePicture, Ribbon, RichTextDocument, Ruler
    '                     Save, SaveAs, SaveAsMore, SelectAll, StatusBar
    '                     TabDatabase, TabGroupDatabase, TabHome, TabPrintPreview, TabView
    '                     Undo, ViewAppTasks, ViewOnePage, ViewTwoPages, WordWrap
    '                     WrapToRuler, WrapToWindow, Zoom100Percent, ZoomIn, ZoomOut
    ' 
