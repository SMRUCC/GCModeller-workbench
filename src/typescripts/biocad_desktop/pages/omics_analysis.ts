function parseSampleInfo(analysis_file: string, using: Delegate.Sub, err: Delegate.Sub = null): void {
...
function saveSampleInfo(table: sampleinfo_editor.IsampleInfo[], analysis_file: string, success: Delegate.Action) {
    let csv = {
